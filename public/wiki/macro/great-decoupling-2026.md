...
1. **Soft Landing (15%):** AI productivity offset inflation; Fed cuts rates perfectly. Outcome: S&P 500 stays flat (Time Correction).
2. **Stagflationary Bust (55% - Base Case):** Sticky inflation forces the Fed to hold rates. Private credit bleeds. Outcome: Slow -25% bear market.
3. **Deflationary Crash (30%):** A major credit event (e.g., a Private Credit fund gating withdrawals) triggers a liquidity freeze. Outcome: Rapid -40% crash.
