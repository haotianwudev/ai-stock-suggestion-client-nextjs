...
- **&ldquo;Be a Pig&rdquo;** — his philosophy of concentrating rather than diversifying when conviction is high: &ldquo;if you really see it, put all your eggs in one basket and watch the basket very carefully.&rdquo;
...
- **The 18-Month Horizon** — &ldquo;never invest in the present&rdquo; since the market has already priced in today's news; position for what conventional wisdom will be in two years.

## Portfolio Architecture (Q2 → Q3 2025)

- AUM: $4.07B → $4.06B (stable value, masks internal churn)
...
- **The Macro Head-Fake** — the EEM trade depends on a weakening USD and dovish Fed; sticky inflation forcing &ldquo;higher for longer&rdquo; could strengthen the dollar and hurt the position instead.

## Actionable Lessons

1. **Conviction over diversification** — don't dilute your best-researched ideas to mediocrity for diversification's sake.
2. **Mental flexibility, no ego** — your &ldquo;folds&rdquo; matter as much as your calls; sell winners when a better idea appears.
...
5. **&ldquo;It's the liquidity, stupid&rdquo;** — central bank and Treasury actions move markets more than individual earnings; check what the Fed/Treasury will do before asking if a stock is cheap.
...
- Concentrating capital into a few uncorrelated, high-conviction theses (not one) is how Druckenmiller manages the risk of &ldquo;betting the ranch.&rdquo;
