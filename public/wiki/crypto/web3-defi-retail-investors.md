...
Web3 is a paradigm shift toward a &ldquo;Read-Write-Own&rdquo; internet built on blockchain, smart contracts, and cryptography, aiming to replace Web 2.0's centralized control with user-owned digital sovereignty. Its primary financial application, Decentralized Finance (DeFi), turns retail investors from passive consumers into active participants and co-owners of market infrastructure &mdash; with a correspondingly steeper risk profile.
...
- **Market Risk** — extreme volatility driven by speculative sentiment and large-holder (&ldquo;whale&rdquo;) actions.
- **Technical Risk** — smart contract exploits or &ldquo;rug pulls&rdquo; that cause total fund loss.
