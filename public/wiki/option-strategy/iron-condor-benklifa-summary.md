...
- **Market neutrality** — the condor creates a &ldquo;zone of profit&rdquo;: as long as the underlying stays within a price range, the trade wins, regardless of direction.
...
- **Theta (Θ), &ldquo;the melting ice cube&rdquo;** — the primary profit engine; decays slowly at first, accelerates dramatically in the final 30-45 days. Goal: sell expensive time, buy it back cheap.
- **Delta (Δ), &ldquo;the market's best guess&rdquo;** — price sensitivity and rough probability of finishing in-the-money; core strategy aims for low-delta strikes (≤10).
- **Gamma (Γ), &ldquo;the steepening slide&rdquo;** — the rate of change of Delta; extremely dangerous near expiration, the primary reason to never hold through expiration week.
- **Vega (ν), &ldquo;the price of uncertainty&rdquo;** — sensitivity to implied volatility; a key strategy sells condors when IV is high and profits from &ldquo;volatility crush&rdquo; as it reverts to the mean.

## The Three Pillars of a Winning Strategy

1. **Disciplined entry** — prioritize price (credit) → position (strike distance) → time (to expiration); sell into fear (VIX spikes 10-20%+ maximize premium); aim for ≥$3 credit (12% return on margin) with short strikes at Delta 10 or less; enter with 5-8 weeks to expiration for adjustment runway.
2. **Proactive adjustment** — defensive, not profit-chasing. Roll the untested side for a credit, use that credit to move the tested side further away. Adjustments are easier in down markets (calls are worth more) than up markets (puts are cheap).
3. **Impatient exit** — &ldquo;what separates the winners from the losers is the exit strategy.&rdquo; Take small, consistent profits (3-5% of margin); never hold through expiration week (Gamma risk too high); set a GTC order to close for profit immediately after entry.
...
- **Earnings Vega play** — sell a wide condor just before an earnings announcement to capture inflated IV (&ldquo;fear&rdquo; premium); direction is irrelevant, the profit comes from IV collapsing (&ldquo;volatility crush&rdquo;) once uncertainty resolves, typically closed the next morning for a quick 5-10% gain.
...
- [Profiting with Iron Condor Options: Trade the Math, Not the Myth](/articles/profiting-iron-condor-options-book-summary)
