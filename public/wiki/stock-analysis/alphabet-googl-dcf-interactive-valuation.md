...
Base-case build: PV of 10-year FCFs ($616.74B) + PV of Terminal Value ($925.85B) = Enterprise Value ($1,542.59B) + Net Cash ($84.44B) = Equity Value ($1,627.03B) → Implied Price ($132.37/share, ÷12,291.81M shares outstanding).
...
- Terminal value dominance is the single biggest driver of the ~31% overvaluation conclusion: since PV of Terminal Value ($925.85B) is roughly 60% of enterprise value, the entire investment thesis rests more on assumptions about Alphabet's business a decade from now than on its current $74.88B TTM free cash flow.
...
- [DCF Valuation Analysis of Google](/articles/interactive-alphabet-googl-valuation-analysis)
