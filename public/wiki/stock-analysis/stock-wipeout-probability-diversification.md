...
Individual stock returns don't follow a bell curve. A small number of &ldquo;superstar&rdquo; stocks generate massive gains while most stocks cluster around zero or negative returns — the distribution is heavily right-skewed, driven by a handful of extreme winners rather than a typical/average performer.
...
3. **OTC Markets** — the stock is relegated to unregulated &ldquo;Pink Sheets,&rdquo; liquidity evaporates, and value plummets further.
...
| Initial Market Cap | Remaining Listed After 5 Years | Primary Exit for Non-Survivors |
|---|---|---|
...
- [Stock Wipeout Probability Analysis](/articles/stock-wipeout-probability-analysis)
- [Watch on YouTube](https://www.youtube.com/watch?v=VsjpIv_gKEI)
