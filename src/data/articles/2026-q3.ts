...
export const articles2026Q3: Article[] = [
  ...
  {
    title: "The math and microstructure of VIX: Quantitative Volatility & Trading Mechanics",
    description: `A quantitative walkthrough of the VIX — how it's calculated, the market microstructure behind it, and the trading mechanics that drive its behavior.`,
    slug: "math-microstructure-vix",
    date: "July 25, 2026",
  ...
  {
    title: "SpaceX: The Trillion-Dollar IPO Too Big to Fail or Single Point of Risk?",
    description: `An examination of SpaceX's record-breaking IPO — whether the $1.77 trillion valuation reflects genuine growth or concentrates systemic risk in a single point of failure.`,
    slug: "spacex-trillion-dollar-ipo-too-big-fail",
    date: "July 22, 2026",
  ...
  {
    title: "Systematic SPX Option Selling: Empirical Indicators & Portfolio Survival",
    description: `A practical walkthrough of empirical indicators and risk-management tactics for systematically selling SPX options, focused on what actually keeps a portfolio alive through drawdowns.`,
    slug: "systematic-spx-option-selling",
    date: "July 19, 2026",
