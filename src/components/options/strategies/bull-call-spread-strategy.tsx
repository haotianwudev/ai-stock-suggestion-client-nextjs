...
export const BullCallSpreadStrategyDetail = ({ strategy, onBack }: StrategyDetailProps) => {
  return (
    <div className="mt-6 space-y-6">
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-200 mb-6">
            <h3 className="text-2xl font-bold text-gray-900 mb-2 flex items-center gap-2">
                ...
                Bull Call Spread Strategy Details
            </h3>
        </div>
      {/* Strategy Intuition */}
        <div className="bg-slate-50 p-4 md:p-6 rounded-xl shadow-lg border border-slate-200">
          ...
          <div className="text-sm text-slate-700 space-y-4">
            <div className="border-l-4 border-slate-300 pl-4">
              ...
              <p className="mb-2">The bull call spread is a <strong>capital-efficient directional strategy</strong> that combines buying and selling calls to create defined risk and defined reward. You buy a call at a lower strike and sell a call at a higher strike, reducing your net cost while capping your maximum profit.</p>
              <p>This strategy leverages the <strong>structural efficiency of vertical spreads</strong> - you get bullish exposure at a fraction of the cost of buying calls outright, while maintaining excellent risk management through defined maximum loss.</p>
            </div>
            
            <div className="border-l-4 border-slate-300 pl-4">
              <h4 className="font-semibold text-slate-800 mb-2">Why Bull Call Spreads Work:</h4>
              <ul className="space-y-1 ml-4">
                <li>• <strong>Capital efficiency:</strong> Lower cost than buying calls outright</li>
                <li>• <strong>Defined risk/reward:</strong> Both maximum loss and profit are known upfront</li>
                <li>• <strong>Reduced time decay:</strong> Short call partially offsets long call theta</li>
                <li>• <strong>Volatility neutral:</strong> Less sensitive to IV changes than single legs</li>
                <li>• <strong>Higher probability:</strong> Lower breakeven than long calls alone</li>
              </ul>
            </div>
            ...
            <div className="border-l-4 border-slate-300 pl-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                <div className="bg-green-100 p-3 rounded">
                  ...
                  <p className="text-xs text-green-700">Selling the higher strike call reduces net debit by 40-70%, making bullish bets more affordable</p>
                </div>
            ...
            <div className="border-l-4 border-slate-300 pl-4">
              <h4 className="font-semibold text-slate-800 mb-2">Strategic Motivations for Bull Call Spreads:</h4>
              <div className="space-y-2">
                <div className="bg-green-100 p-2 rounded">
                  <p className="font-medium text-green-800 text-sm">🎯 Moderate Bullishness:</p>
                  <p className="text-xs text-green-700">Perfect for scenarios where you expect steady, moderate price appreciation</p>
                </div>
                <div className="bg-blue-100 p-2 rounded">
                  <p className="font-medium text-blue-800 text-sm">💡 Capital Preservation:</p>
                  <p className="text-xs text-blue-700">Reduce capital at risk while maintaining meaningful upside participation</p>
                </div>
                <div className="bg-purple-100 p-2 rounded">
                  <p className="font-medium text-purple-800 text-sm">⚖️ Risk-Adjusted Returns:</p>
                  <p className="text-xs text-purple-700">Better risk-adjusted returns than long calls in many market conditions</p>
                </div>
            ...
            <div className="border-l-4 border-slate-300 pl-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-2">
                ...
                <div className="bg-teal-100 p-2 rounded">
                  <p className="font-medium text-teal-800 text-sm">🎯 Conservative Bulls</p>
            ...
            <div className="border-l-4 border-slate-300 pl-4">
              <h4 className="font-semibold text-slate-800 mb-2">Greeks Analysis for Bull Call Spreads:</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                <div className="bg-green-100 p-3 rounded">
                  <h5 className="font-medium text-green-800 mb-1">📈 Delta (Net Positive)</h5>
                  <ul className="text-xs text-green-700 space-y-1">
                    <li>• <strong>Long call delta:</strong> +0.30 to +0.70</li>
                    <li>• <strong>Short call delta:</strong> -0.10 to -0.30</li>
                    <li>• <strong>Net delta:</strong> +0.20 to +0.40</li>
                    <li>• <strong>Directional exposure:</strong> Benefits from upward moves</li>
                  </ul>
                </div>
                <div className="bg-orange-100 p-3 rounded">
                  <h5 className="font-medium text-orange-800 mb-1">⚡ Gamma (Mixed)</h5>
                  <ul className="text-xs text-orange-700 space-y-1">
                    <li>• <strong>Long call gamma:</strong> Positive acceleration</li>
                    <li>• <strong>Short call gamma:</strong> Negative acceleration</li>
                ...
                <div className="bg-blue-100 p-3 rounded">
                  ...
                  <ul className="text-xs text-blue-700 space-y-1">
                    <li>• <strong>Long call theta:</strong> Negative (loses value)</li>
                    <li>• <strong>Short call theta:</strong> Positive (gains value)</li>
                    <li>• <strong>Net theta:</strong> Usually slightly negative</li>
                    <li>• <strong>Time decay:</strong> Less impact than single long calls</li>
                  </ul>
                </div>
                <div className="bg-purple-100 p-3 rounded">
                  <h5 className="font-medium text-purple-800 mb-1">📊 Vega (Mixed Impact)</h5>
                  <ul className="text-xs text-purple-700 space-y-1">
                    <li>• <strong>Long call vega:</strong> Positive (benefits from IV rise)</li>
                    <li>• <strong>Short call vega:</strong> Negative (hurt by IV rise)</li>
                    <li>• <strong>Net vega:</strong> Usually slightly positive</li>
                    <li>• <strong>IV sensitivity:</strong> Much less than single long calls</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="bg-green-50 p-4 md:p-6 rounded-xl shadow-lg border border-green-200">
          ...
          <div className="text-sm text-green-700 space-y-4">
            <div className="border-l-4 border-green-300 pl-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-2">
                <div className="bg-blue-100 p-3 rounded">
                  <h5 className="font-medium text-blue-800">🎯 Long Call Strike</h5>
                  <ul className="text-xs text-blue-700 space-y-1 mt-1">
                    ...
                    <li>• <strong>Delta target:</strong> 0.50-0.70 delta preferred</li>
                    <li>• <strong>Cost consideration:</strong> Higher delta = higher cost</li>
                  </ul>
                </div>
                <div className="bg-yellow-100 p-3 rounded">
                  <h5 className="font-medium text-yellow-800">📈 Short Call Strike</h5>
                  <ul className="text-xs text-yellow-700 space-y-1 mt-1">
                    <li>• <strong>Target level:</strong> Your price objective or resistance</li>
                    <li>• <strong>Strike spacing:</strong> 5-15 strikes above long call</li>
                    <li>• <strong>Delta target:</strong> 0.15-0.30 delta typical</li>
                    <li>• <strong>Credit collection:</strong> Reduces net debit significantly</li>
                  </ul>
                </div>
                <div className="bg-green-100 p-3 rounded">
                  <h5 className="font-medium text-green-800">💰 Spread Width Strategy</h5>
            ...
            <div className="border-l-4 border-green-300 pl-4">
              ...
              <ul className="space-y-1 mt-2">
                <li>• <strong>Technical setups:</strong> Enter near support levels or breakout points</li>
                <li>• <strong>Volatility environment:</strong> Moderate IV levels preferred</li>
                <li>• <strong>Market sentiment:</strong> Bullish but not euphoric conditions</li>
                <li>• <strong>Fundamental catalysts:</strong> Positive earnings, guidance, or news flow</li>
                <li>• <strong>Seasonal patterns:</strong> Align with historically strong periods</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="text-sm text-blue-700 space-y-3">
            <div>
              ...
              <ul className="space-y-1 ml-4">
                ...
                <li>• <strong>Technical targets:</strong> Exit at resistance levels or price objectives</li>
            ...
            <div>
              ...
              <ul className="space-y-1 ml-4">
                ...
                <li>• <strong>Technical stops:</strong> Exit if bullish thesis is invalidated</li>
            ...
            <div>
              ...
              <ul className="space-y-1 ml-4">
                ...
                <li>• <strong>Roll up:</strong> Move both strikes higher if stock has moved favorably</li>
        ...
        {/* Bull Call vs Bear Put vs Credit Spreads Comparison */}
        <div className="bg-green-50 p-4 md:p-6 rounded-xl shadow-lg border border-green-200">
          <h3 className="text-xl font-bold text-green-800 mb-4 flex items-center gap-2">
            <span className="text-2xl">⚖️</span>
            Bull Call Spread vs Bear Put Spread vs Vertical Credit Spreads
          </h3>
          <div className="text-sm text-green-700 space-y-4">
              ...
              <table className="w-full text-left border-collapse bg-white rounded-lg">
                <thead>
                  <tr className="bg-green-100 border-b border-green-200">
                    ...
                    <th className="p-3 text-sm font-bold text-emerald-600">Bull Call Spread</th>
                    <th className="p-3 text-sm font-bold text-red-600">Bear Put Spread</th>
                ...
                <tbody className="divide-y divide-green-100">
                  <tr>
                    ...
                    <td className="p-3 font-semibold text-emerald-600">Moderately Bullish</td>
                    <td className="p-3">Moderately Bearish</td>
                    <td className="p-3">Neutral to Directional</td>
                  </tr>
                  <tr>
                    <td className="p-3 font-medium">Cash Flow</td>
                    <td className="p-3 font-semibold text-emerald-600">Pay Debit (Net Cost)</td>
                  ...
                  <tr>
                    ...
                    <td className="p-3 font-semibold text-emerald-600">Price appreciation</td>
                    <td className="p-3">Price depreciation</td>
                  ...
                  <tr>
                    ...
                    <td className="p-3 font-semibold text-emerald-600">Lower (debit paid)</td>
                    <td className="p-3 font-semibold text-emerald-600">Lower (debit paid)</td>
            ...
            <div className="bg-white p-4 rounded-lg border border-green-200">
              <h4 className="font-bold text-green-900 mb-2">🎯 When to Choose Bull Call Spreads</h4>
              <p className="text-green-800">
                Bull call spreads are preferred when you have moderate bullish conviction, want to reduce the cost of 
                directional exposure, or need better risk management than outright call buying. They work best when 
                you expect steady, moderate price appreciation rather than explosive moves, and when you want to 
                participate in upside while limiting downside risk.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="bg-white p-3 rounded border border-red-200">
                <p className="text-red-800 mb-2">
                  <strong>Breakeven Point:</strong> Long Call Strike + Net Debit Paid<br/>
                ...
                <p className="text-xs text-red-600">
                  Example: Buy $100 call, sell $110 call for $3.50 debit. Breakeven = $103.50, Max profit = $6.50, Max loss = $3.50
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-sm text-yellow-700 space-y-3">
            ...
            <div>
              ...
              <ul className="space-y-1 ml-4">
                ...
                <li>• <strong>Risk-adjusted returns:</strong> Often superior to long calls</li>
        ...
        <div className="bg-purple-50 p-4 md:p-6 rounded-xl shadow-lg border border-purple-200">
          <h3 className="text-xl font-bold text-purple-800 mb-4 flex items-center gap-2">
            <span className="text-2xl">🚀</span>
            Advanced Bull Call Spread Strategies
          </h3>
          <div className="text-sm text-purple-700 space-y-3">
            ...
            <div>
              ...
              <ul className="space-y-1 ml-4">
                ...
                <li>• <strong>Conversion to butterflies:</strong> Add short calls above for range-bound markets</li>
        ...
        <div className="bg-gray-100 p-4 rounded-lg border border-gray-300">
          <p className="text-xs text-gray-600">
            <strong>Risk Disclosure:</strong> Bull call spreads involve substantial risk and are suitable only for experienced 
