...
const validSubtopics = ['systematic-strategies', 'machine-learning', 'backtest', 'trading-system', 'asset-allocation', 'books'];
...
export async function generateMetadata({ params }: { params: Promise<{ subtopic: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: fullTitle,
      description,
      url: `https://www.sophie-ai-finance.com/quant/quanttrading/${subtopic}`,
    ...
    alternates: {
      canonical: `https://www.sophie-ai-finance.com/quant/quanttrading/${subtopic}`,
    },
  };
}
