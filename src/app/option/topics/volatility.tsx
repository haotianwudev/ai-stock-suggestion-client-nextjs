import { Activity, TrendingUp, BarChart3, Brain, Eye, Calculator } from "lucide-react";
...
export function VolatilityContent() {
  ...
  const contentSections = (
    <>
      ...
      {/* Market Psychology */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-1.5 md:gap-4">
      ...
      <div className="space-y-3">
        <h3 className="text-lg md:text-xl font-semibold text-cyan-900">Key Concepts to Master</h3>
        <div className="flex flex-wrap gap-2">
          <Badge variant="secondary" className="bg-cyan-100 text-cyan-800">Black-Scholes Failure</Badge>
          <Badge variant="secondary" className="bg-cyan-100 text-cyan-800">Put-Call Parity</Badge>
          <Badge variant="secondary" className="bg-cyan-100 text-cyan-800">Negative Skewness</Badge>
          <Badge variant="secondary" className="bg-cyan-100 text-cyan-800">Excess Kurtosis</Badge>
          <Badge variant="secondary" className="bg-cyan-100 text-cyan-800">Jump Risk</Badge>
          <Badge variant="secondary" className="bg-cyan-100 text-cyan-800">Mean Reversion</Badge>
        </div>
      </div>
      ...
      <Card className="border-purple-200 bg-purple-50/50">
        <CardHeader className="pb-2 md:pb-4">
          <CardTitle className="text-base md:text-lg text-purple-700">
