  ...
  <Card id="executive-summary">
    ...
    <div className="space-y-6 text-gray-700 dark:text-gray-300">
      ...
      <div className="bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-900/40 dark:to-purple-900/40 p-6 rounded-lg border border-indigo-300 dark:border-indigo-400/30">
        <h3 className="text-xl font-semibold text-indigo-800 dark:text-indigo-300 mb-3">🎯 The Core Challenge</h3>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg border border-green-300 dark:border-green-400/30">
          <div className="flex items-center mb-3">
            ...
            <h4 className="text-lg font-semibold text-green-700 dark:text-green-300">Winner: Chroma</h4>
          </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-300 dark:border-blue-400/30">
          <div className="flex items-center mb-3">
            <Zap className="text-blue-600 dark:text-blue-400 mr-2" size={24} />
            <h4 className="text-lg font-semibold text-blue-700 dark:text-blue-300">Performance: FAISS</h4>
          </div>
          <p className="text-gray-700 dark:text-gray-300 text-sm">
        ...
        <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg border border-orange-300 dark:border-orange-400/30">
          <div className="flex items-center mb-3">
            <Code className="text-orange-600 dark:text-orange-400 mr-2" size={24} />
            <h4 className="text-lg font-semibold text-orange-700 dark:text-orange-300">Prototype: Scikit-learn</h4>
          </div>
          <p className="text-gray-700 dark:text-gray-300 text-sm">
...
const Challenge = () => (
  <Card id="challenge">
    ...
    <div className="space-y-8">
      <div>
        <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">🏗️ Confluence&apos;s Complex Structure</h3>
      ...
      <div>
        <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">⚠️ The Contextual Integrity Problem</h3>
        <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-lg border border-red-300 dark:border-red-400/30">
          <div className="space-y-4">
            <div className="flex items-start">
              <XCircle className="text-red-600 dark:text-red-400 mr-3 mt-1 flex-shrink-0" size={20} />
              <div>
                <h4 className="font-semibold text-red-700 dark:text-red-300">Naive Chunking Destroys Context</h4>
            ...
            <div className="flex items-start">
              <XCircle className="text-red-600 dark:text-red-400 mr-3 mt-1 flex-shrink-0" size={20} />
              <div>
                <h4 className="font-semibold text-red-700 dark:text-red-300">Retrieval Ambiguity</h4>
            ...
            <div className="flex items-start">
              <XCircle className="text-red-600 dark:text-red-400 mr-3 mt-1 flex-shrink-0" size={20} />
              <div>
                <h4 className="font-semibold text-red-700 dark:text-red-300">Lost Knowledge Graphs</h4>
...
const Solutions = () => (
  <Card id="solutions">
    ...
    <div className="space-y-12">
      <div className="bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/20 p-8 rounded-xl border border-green-300 dark:border-green-400/30">
        <div className="flex items-center mb-6">
          <div className="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center mr-4">
            <Database className="text-white" size={24} />
          </div>
          <div>
            <h3 className="text-2xl font-bold text-green-700 dark:text-green-300">Chroma</h3>
            <p className="text-green-600 dark:text-green-200">AI-Native Vector Database</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="flex items-center text-lg font-semibold text-green-600 dark:text-green-400 mb-3">
          ...
          <div>
            <h4 className="flex items-center text-lg font-semibold text-red-600 dark:text-red-400 mb-3">
      ...
      <div className="bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/20 p-8 rounded-xl border border-blue-300 dark:border-blue-400/30">
        <div className="flex items-center mb-6">
          <div className="w-12 h-12 bg-blue-500 rounded-lg flex items-center justify-center mr-4">
            <Zap className="text-white" size={24} />
          </div>
          <div>
            <h3 className="text-2xl font-bold text-blue-700 dark:text-blue-300">FAISS</h3>
            <p className="text-blue-600 dark:text-blue-200">High-Performance Vector Library</p>
          </div>
        </div>
        <p className="text-gray-700 dark:text-gray-300 mb-6">
      ...
      <div className="bg-gradient-to-r from-orange-100 to-yellow-100 dark:from-orange-900/30 dark:to-yellow-900/20 p-8 rounded-xl border border-orange-300 dark:border-orange-400/30">
        <div className="flex items-center mb-6">
          <div className="w-12 h-12 bg-orange-500 rounded-lg flex items-center justify-center mr-4">
            <Code className="text-white" size={24} />
          </div>
          <div>
            <h3 className="text-2xl font-bold text-orange-700 dark:text-orange-300">Scikit-learn</h3>
            <p className="text-orange-600 dark:text-orange-200">ML Toolkit Component</p>
          </div>
        </div>
        <p className="text-gray-700 dark:text-gray-300 mb-6">
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-gray-300 dark:border-white/20">
              ...
              <th className="text-center p-4 text-green-700 dark:text-green-300 font-semibold">Chroma</th>
              <th className="text-center p-4 text-blue-700 dark:text-blue-300 font-semibold">FAISS</th>
              <th className="text-center p-4 text-orange-700 dark:text-orange-300 font-semibold">Scikit-learn</th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr key={index} className="border-b border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
                ...
                <td className="p-4 text-center">
                  <div className="flex flex-col items-center">
                    <span className="text-green-700 dark:text-green-300 font-medium mb-1">{row.chroma}</span>
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <div key={i} className={`w-3 h-3 rounded-full mr-1 ${i < row.chromaScore ? 'bg-green-400' : 'bg-gray-300 dark:bg-gray-600'}`} />
                      ))}
                    </div>
                  </div>
                </td>
                <td className="p-4 text-center">
                  <div className="flex flex-col items-center">
                    <span className="text-blue-700 dark:text-blue-300 font-medium mb-1">{row.faiss}</span>
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <div key={i} className={`w-3 h-3 rounded-full mr-1 ${i < row.faissScore ? 'bg-blue-400' : 'bg-gray-300 dark:bg-gray-600'}`} />
                      ))}
                    </div>
                  </div>
                </td>
                <td className="p-4 text-center">
                  <div className="flex flex-col items-center">
                    <span className="text-orange-700 dark:text-orange-300 font-medium mb-1">{row.sklearn}</span>
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <div key={i} className={`w-3 h-3 rounded-full mr-1 ${i < row.sklearnScore ? 'bg-orange-400' : 'bg-gray-300 dark:bg-gray-600'}`} />
                      ))}
                    </div>
                  </div>
                </td>
...
const Recommendation = () => (
  <Card id="recommendation">
    ...
    <div className="space-y-8">
      <div className="text-center p-8 bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/40 dark:to-emerald-900/40 rounded-xl border border-green-300 dark:border-green-400/40">
        <Award className="mx-auto text-green-600 dark:text-green-400 mb-4" size={48} />
        <h3 className="text-3xl font-bold text-green-700 dark:text-green-300 mb-4">Chroma is the Clear Winner</h3>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-lg border border-green-300 dark:border-green-400/30">
          <Shield className="text-green-600 dark:text-green-400 mb-3" size={32} />
        ...
        <div className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-lg border border-blue-300 dark:border-blue-400/30">
