...
import { Activity, BookOpen, Calculator, TrendingUp, Layers, AlertTriangle, Lightbulb, Zap, Globe } from 'lucide-react';
...
const HighlightCard = ({ title, content, icon: Icon, color }: { title: string, content: string, icon: React.ComponentType<{ size?: number, color?: string }>, color: string }) => (
      ...
      <div className="space-y-16">
        ...
        <section className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200">
          ...
          <div className="text-lg">
            <ul className="space-y-4">
              ...
              <Bullet colorClass="bg-blue-500">
                <strong>Beyond the &ldquo;Fear Gauge&rdquo;:</strong> While popular media calls it a sentiment indicator, it is purely a mathematical construct representing forward-looking statistical variance, serving as the foundation for a massive ecosystem of futures and ETPs.
              </Bullet>
            </ul>
          </div>
        </section>
            ...
            <ul className="space-y-6">
              <li className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                ...
                <p className="text-slate-600 mb-3">
                  Assuming an asset price <InlineMath math="S_t" /> follows a continuous diffusion process:
                </p>
                <MathBlock math="\frac{dS_t}{S_t} = \mu_t dt + \sigma_t dW_t" />
              </li>
              <li className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                <div className="flex items-center gap-3 mb-2">
                ...
                <MathBlock math="\frac{dS_t}{S_t} - d(\ln S_t) = \frac{1}{2} \sigma_t^2 dt" />
              </li>
              <li className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                <div className="flex items-center gap-3 mb-2">
                ...
                <MathBlock math="V = \int_{0}^{T} \sigma_t^2 dt = 2 \int_{0}^{T} \frac{dS_t}{S_t} - 2 \ln\left(\frac{S_T}{S_0}\right)" />
              </li>
            </ul>
            <HighlightCard 
          ...
          <div className="text-lg text-slate-700 leading-relaxed space-y-6 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                <h4 className="font-bold text-slate-900 mb-2">1. Forward Price (F) & ATM Strike (<InlineMath math="K_0" />)</h4>
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                <h4 className="font-bold text-slate-900 mb-2">3. Option Weighting (<InlineMath math="\Delta K_i / K_i^2" />)</h4>
                <p className="text-sm text-slate-600">
            ...
            <p>
              The VIX calculates &ldquo;near-term&rdquo; (23+ days) and &ldquo;next-term&rdquo; (less than 37 days) variance points. It minute-by-minute interpolates between these to maintain a strictly constant 30-day target:
            </p>
            <MathBlock math="VIX = 100 \times \sqrt{ \left[ T_1 \sigma_1^2 + T_2 \sigma_2^2 \right] \times \frac{N_{365}}{N_{30}} }" />
          </div>
        </section>
        ...
        <section className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-slate-700">
            <div>
              <h3 className="text-2xl font-bold text-slate-900 mb-4">The &ldquo;Rule of 16&rdquo;</h3>
              <ul className="space-y-4">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <Bullet colorClass="bg-red-500">
                  <strong>Market Structure:</strong> The VIX futures curve spends roughly 75-80% of its lifespan in &ldquo;contango&rdquo;—meaning longer-dated futures are priced higher than near-term ones.
                </Bullet>
                <Bullet colorClass="bg-red-500">
        ...
        <section className="bg-slate-900 rounded-3xl p-8 md:p-12 shadow-xl border border-slate-800 text-slate-300">
          ...
          <p className="text-lg leading-relaxed mb-8 text-slate-400">
            Market makers hedge VIX Delta using VIX futures, not shares. However, standard Black-Scholes Delta hedging is insufficient. They must manage the &ldquo;Greek Trinity&rdquo; of volatility derivatives:
          </p>
          ...
          <div className="space-y-8 text-lg text-slate-700">
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-50 border border-red-100 rounded-2xl p-8 mt-8">
              ...
              <ul className="list-disc pl-6 space-y-3 text-red-800">
                ...
                <li>
                  <strong>Liquidity Collapse:</strong> Market makers withdrew, causing put mid-quotes <InlineMath math="Q(K_i)" /> to swell massively. A 3,500 strike put jumped from $0.70 to $50.25.
                </li>
                <li>
                  <strong>Weighting Magnification:</strong> The <InlineMath math="1/K^2" /> weighting heavily multiplied these inflated mid-quotes, catapulting the index mechanically.
                </li>
              </ul>
