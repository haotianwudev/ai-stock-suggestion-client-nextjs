...
import { ArrowLeft, TrendingUp, Shield, Brain, Scale, DollarSign, Clock, Award, Briefcase, Users, Zap, AlertTriangle, CheckCircle2, XCircle, ChevronRight, BookOpen, Target, Percent, Activity, AlertOctagon, Lock, Globe, Music } from 'lucide-react';
import { articles } from '@/data/articles';
import { StructuredData, BreadcrumbStructuredData } from '@/components/seo/structured-data';

export default function MasteringVRPArticle() {
  const currentArticle = articles.find(article => article.slug === 'mastering-volatility-risk-premium-spx-options-selling');
  const [activeSection, setActiveSection] = useState('hero');

  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'vrp', 'instruments', 'mechanics', 'risks', 'implementation', 'etfs', 'recommendations'];
      const currentSection = sections.find(section => {
        const element = document.getElementById(section);
        if (element) {
          const rect = element.getBoundingClientRect();
          return rect.top >= -200 && rect.top <= window.innerHeight / 3;
        }
        return false;
      });
      if (currentSection) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
        ...
        {/* Hero Section */}
        <section id="hero" className="pt-16 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center rounded-full px-4 py-1 text-sm font-medium text-indigo-700 bg-indigo-50 mb-8 border border-indigo-100">
              <BookOpen className="w-4 h-4 mr-2" /> Institutional Research Summary
            </div>
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-tight">
              <span className="block text-slate-900">Mastering the</span>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600">Volatility Risk Premium</span>
            </h1>
            <p className="mt-6 text-xl md:text-2xl text-slate-600 leading-relaxed max-w-3xl mx-auto">
            ...
            <div className="mt-12 flex flex-col sm:flex-row justify-center gap-5">
              <a href="#vrp" className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-bold rounded-full text-white bg-indigo-600 hover:bg-indigo-700 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                Start the Deep Dive
                <ChevronRight className="ml-2 w-5 h-5" />
              </a>
              <a href="#recommendations" className="inline-flex items-center justify-center px-8 py-4 border-2 border-slate-200 text-lg font-bold rounded-full text-slate-700 bg-white hover:border-indigo-200 hover:text-indigo-600 hover:bg-indigo-50 transition-all duration-300">
                Jump to Strategies
              </a>
            </div>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200">
            ...
            <div className="absolute top-4 left-4 z-10">
              <span className="inline-block bg-purple-600 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-lg">
                Deep Research
              </span>
            </div>
            <div className="absolute bottom-4 right-4 z-10">
              <span className="inline-block bg-orange-500 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-lg">
                Options Trading
              </span>
            </div>
            <img 
              src="https://i.imgur.com/Iz7lSu4.jpeg" 
              alt="Mastering the Volatility Risk Premium Infographic" 
        ...
        {/* Part 1: The VRP */}
        <section id="vrp" className="py-24 bg-white">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-semibold text-white mb-2">The "Tail" Risk</div>
                    <p className="text-slate-400 leading-relaxed">
        ...
        {/* Part 2: Instruments */}
        <section id="instruments" className="py-24 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <SectionHeader
                  ...
                  <thead className="bg-slate-100">
                    <tr>
                      ...
                      <th className="px-6 py-5 text-center text-sm font-bold text-purple-900 bg-purple-50/50 uppercase tracking-wider">
                        XSP <span className="block text-xs font-normal normal-case opacity-70">Retail "Mini-SPX"</span>
                      </th>
        ...
        {/* Mechanics Section */}
        <section id="mechanics" className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <SectionHeader
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-emerald-50 rounded-3xl p-8 border border-emerald-100">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="ml-4 text-2xl font-bold text-emerald-900">The "Tax Alpha" Math</h3>
                </div>
        ...
        {/* Risks Section */}
        <section id="risks" className="py-24 bg-slate-900 text-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-extrabold text-white">Structural Risks & "Blowups"</h2>
            ...
            <div className="mt-12 bg-slate-800/50 rounded-2xl p-8 border border-rose-900/30">
              <h3 className="text-2xl font-bold text-white mb-4">Historical Case Study: "Volmageddon" (Feb 2018)</h3>
        ...
        <section id="etfs" className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <SectionHeader
        ...
        <section id="recommendations" className="py-24 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <SectionHeader
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-8 rounded-xl my-8 text-center max-w-7xl mx-auto">
        ...
        <footer className="bg-slate-950 py-16 text-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-slate-400 mb-6 max-w-2xl mx-auto">
              Synthesized from institutional research on variance risk premia, Cboe index methodology, and U.S. tax code Section 1256.
            </p>
            <div className="text-slate-600 text-sm space-y-2">
              <p>Educational purposes only. Not financial, tax, or legal advice.</p>
              <p>Option writing involves substantial risk of loss, potentially greater than the initial investment (if uncovered).</p>
