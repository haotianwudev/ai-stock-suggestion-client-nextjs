...
const InfoCard = ({ title, children, accentColor = "blue", subtitle }: InfoCardProps) => {
  const colorMap = {
    ...
    indigo: "border-indigo-500 bg-indigo-50/50 hover:bg-indigo-50",
    emerald: "border-emerald-500 bg-emerald-50/50 hover:bg-emerald-50",
    rose: "border-rose-500 bg-rose-50/50 hover:bg-rose-50",
    ...
    slate: "border-slate-500 bg-slate-50/50 hover:bg-slate-50",
  };
...
const ComparisonRow = ({ metric, retail, institutional }: ComparisonRowProps) => (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-5 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors px-6">
    ...
    <div className="text-rose-700 md:border-l md:border-gray-200 md:pl-6 bg-rose-50/50 p-2 rounded-lg md:bg-transparent md:p-0">{retail}</div>
    <div className="text-emerald-700 md:border-l md:border-gray-200 md:pl-6 bg-emerald-50/50 p-2 rounded-lg md:bg-transparent md:p-0">{institutional}</div>
  </div>
);
        ...
        {/* Section 1: Theory */}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <InfoCard title="Philosophy of Asymmetry" accentColor="indigo" subtitle="">
                ...
                <div className="bg-indigo-50 p-4 rounded-xl mt-4 border border-indigo-100">
                  ...
                  <p className="text-sm text-indigo-800">Think of a Call Option as <strong>leasing</strong> a house with the option to buy it. You pay a non-refundable deposit (Premium). If the housing market crashes, you walk away losing only the deposit. If the market doubles, you buy at the old price and keep the profit.</p>
                </div>
              </InfoCard>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-lg text-blue-900">Delta (Δ)</h3>
                </div>
                <p className="text-sm text-blue-800 mb-3"><strong>Speed.</strong> How much the option price moves for every $1 move in the stock.</p>
              ...
              <div className="bg-purple-50 p-6 rounded-2xl border border-purple-100">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-lg text-purple-900">Gamma (Γ)</h3>
                </div>
              ...
              <div className="bg-amber-50 p-6 rounded-2xl border border-amber-100">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-lg text-amber-900">Theta (Θ)</h3>
                </div>
                <p className="text-sm text-amber-800 mb-3"><strong>Time Decay.</strong> The daily "rent" you pay to hold the position.</p>
                <div className="text-xs text-amber-600 bg-white p-2 rounded">
              ...
              <div className="bg-rose-50 p-6 rounded-2xl border border-rose-100">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-lg text-rose-900">Vega (ν)</h3>
                </div>
                <p className="text-sm text-rose-800 mb-3"><strong>Volatility.</strong> Sensitivity to changes in Implied Volatility (IV).</p>
                <div className="text-xs text-rose-600 bg-white p-2 rounded">
          ...
          <section>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-8">
              <div className="bg-gray-50 px-8 py-5 border-b border-gray-100 grid grid-cols-1 md:grid-cols-3 gap-6 font-bold text-gray-500 uppercase text-xs tracking-widest">
                <div>Metric</div>
                <div className="text-rose-600">Retail Investors (Gamblers)</div>
                <div className="text-emerald-600">Institutions (Hedgers)</div>
              </div>
              <div>
                <ComparisonRow 
          ...
          <section>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {/* Archetype 1 */}
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-indigo-300 transition-colors group">
                  ...
                  <p className="text-xs font-bold text-indigo-600 uppercase tracking-wide mb-3">Stock Replacement</p>
                ...
                {/* Archetype 2 */}
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-amber-300 transition-colors group">
                ...
                {/* Archetype 3 */}
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-rose-300 transition-colors group">
                  <div className="w-12 h-12 bg-rose-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-rose-600 transition-colors">
                    <Zap className="w-6 h-6 text-rose-600 group-hover:text-white" />
                  </div>
                  <h4 className="text-lg font-bold text-gray-900">The Sniper</h4>
                  <p className="text-xs font-bold text-rose-600 uppercase tracking-wide mb-3">Convexity Play</p>
            ...
            <div className="mb-12 bg-indigo-50/50 rounded-3xl p-8 border border-indigo-100">
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="px-3 py-1 bg-indigo-600 text-white rounded-lg text-sm font-bold shadow-sm">Strategy A</span>
                    <h3 className="text-2xl font-bold text-indigo-900">The Stock Replacement (LEAPS)</h3>
                  </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-indigo-100 w-full md:w-80 flex-shrink-0">
                  <h4 className="font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2">The Setup</h4>
                  <div className="space-y-4 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-500">Delta</span>
                      <span className="font-mono font-bold text-indigo-600">0.80 - 0.90</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Expiration</span>
                      <span className="font-mono font-bold text-indigo-600">12+ Months</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Liquidity</span>
                      <span className="font-mono font-bold text-indigo-600">High Open Interest</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-amber-900">The Swing Trade (ATM)</h3>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-white p-3 rounded-lg border border-amber-100 flex items-center gap-3">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-amber-100 w-full md:w-80 flex-shrink-0">
                  <h4 className="font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2">The Setup</h4>
                  <div className="space-y-4 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-500">Delta</span>
            ...
            <div className="bg-slate-900 text-white rounded-3xl p-8 shadow-2xl">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-slate-800 p-5 rounded-xl border border-slate-700">
                  <div className="text-emerald-400 font-bold mb-2">Deep ITM (In The Money)</div>
                ...
                <div className="bg-slate-800 p-5 rounded-xl border border-slate-700">
                  <div className="text-rose-400 font-bold mb-2">OTM (Out of The Money)</div>
          ...
          <section>
            ...
            <div className="mb-12 bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="bg-cyan-900 text-white p-6 flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold">Rule #1: Position Sizing</h3>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white p-6 rounded-2xl border-t-4 border-rose-500 shadow-sm flex flex-col">
              ...
              <div className="bg-white p-6 rounded-2xl border-t-4 border-emerald-500 shadow-sm flex flex-col">
                <div className="flex items-center gap-2 mb-4">
              ...
              <div className="bg-white p-6 rounded-2xl border-t-4 border-amber-500 shadow-sm flex flex-col">
                <div className="flex items-center gap-2 mb-4">
            ...
            <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200">
              <h3 className="text-xl font-bold text-slate-800 mb-6">Advanced Management Nuances</h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-bold text-indigo-700 flex items-center gap-2 mb-2">
                    <Layers className="w-4 h-4"/> When to Roll Up?
                  </h4>
                  <p className="text-sm text-slate-600 mb-4">If your Deep ITM Call (LEAPS) has huge gains, you can "Roll Up." Sell the current strike, buy a higher strike. This locks in realized cash profit while maintaining bullish exposure.</p>
                </div>
                <div>
                  <h4 className="font-bold text-rose-700 flex items-center gap-2 mb-2">
                    <XCircle className="w-4 h-4"/> When NOT to Roll Out?
                  </h4>
                  <p className="text-sm text-slate-600 mb-4"><strong>"Rolling a Loser"</strong>: If a trade is down -50%, do NOT sell it to buy a later date. You are just realizing a loss and throwing good money after bad. Accept the loss, clear the mental cache, and find a new setup.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <InfoCard title="IV Crush" accentColor="rose" subtitle="The Earnings Trap">
                ...
                <div className="mt-4 p-3 bg-white/60 rounded border border-rose-200 text-xs font-medium text-rose-800">
              ...
              <InfoCard title="Skew Disadvantage" accentColor="emerald" subtitle="Market Structure">
                ...
                <div className="mt-4 p-3 bg-white/60 rounded border border-emerald-200 text-xs font-medium text-emerald-800">
              ...
              <InfoCard title="The Theta Cliff" accentColor="amber" subtitle="Silent Killer">
                ...
                <div className="mt-4 p-3 bg-white/60 rounded border border-amber-200 text-xs font-medium text-amber-800">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-8 rounded-3xl shadow-lg border-t-8 border-indigo-500">
                <div className="flex items-center gap-3 mb-6">
                  <TrendingUp className="w-8 h-8 text-indigo-600" />
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">Long Call Profile</h3>
                    <p className="text-sm font-bold text-indigo-600 uppercase tracking-wide">The Optimist's Bet</p>
                  </div>
                </div>
                <div className="space-y-5">
                  <div className="flex items-start gap-3">
                    <div className="bg-indigo-50 p-2 rounded text-indigo-600 mt-1">
                      <Activity className="w-4 h-4"/>
                    </div>
                    <div>
                      <span className="font-bold text-gray-800 block">Vega Headwind</span>
                      <span className="text-sm text-gray-600">As markets rise, fear subsides. Implied Volatility (IV) usually drops. You profit from Delta (Direction), but lose on Vega (Vol Crush).<br/><em className="text-xs text-indigo-600">"Taking the stairs up."</em></span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-indigo-50 p-2 rounded text-indigo-600 mt-1">
              ...
              <div className="bg-white p-8 rounded-3xl shadow-lg border-t-8 border-rose-500">
                <div className="flex items-center gap-3 mb-6">
                  <TrendingDown className="w-8 h-8 text-rose-600" />
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">Long Put Profile</h3>
                    <p className="text-sm font-bold text-rose-600 uppercase tracking-wide">The Pessimist's Bet</p>
                  </div>
                </div>
                <div className="space-y-5">
                  <div className="flex items-start gap-3">
                    <div className="bg-rose-50 p-2 rounded text-rose-600 mt-1">
                      <Activity className="w-4 h-4"/>
                    </div>
                    <div>
                      <span className="font-bold text-gray-800 block">Vega Tailwind</span>
                      <span className="text-sm text-gray-600">As markets crash, fear explodes. IV spikes. You profit from Delta (Direction) AND Vega (Vol Expansion). This leads to explosive "Gamma Squeezes."<br/><em className="text-xs text-rose-600">"Taking the elevator down."</em></span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-rose-50 p-2 rounded text-rose-600 mt-1">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="p-5 text-sm font-bold text-gray-500 uppercase tracking-wider">Feature</th>
                    <th className="p-5 text-sm font-bold text-indigo-600 uppercase tracking-wider bg-indigo-50/50">Long Call (Bull)</th>
                    <th className="p-5 text-sm font-bold text-rose-600 uppercase tracking-wider bg-rose-50/50">Long Put (Bear)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100 text-sm">
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="p-5 font-bold text-gray-700">Market Personality</td>
                    <td className="p-5 text-gray-600 bg-indigo-50/10">Slow grind up, lower volatility over time.</td>
                    <td className="p-5 text-gray-600 bg-rose-50/10">Fast, violent moves down. Panic driven.</td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="p-5 font-bold text-gray-700">Volatility (Vega) Impact</td>
                    <td className="p-5 text-gray-600 bg-indigo-50/10">
                      <span className="inline-flex items-center gap-1 text-rose-600 font-bold">
                        <TrendingDown className="w-3 h-3"/> Negative
                      </span><br/>
                      Vol usually drops as price rises.
                    </td>
                    <td className="p-5 text-gray-600 bg-rose-50/10">
                  ...
                  <tr className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-5 text-gray-600 bg-indigo-50/10">
                      <span className="text-emerald-600 font-bold">Cheaper.</span><br/>
                      Market assumes slow growth.
                    </td>
                    <td className="p-5 text-gray-600 bg-rose-50/10">
                      <span className="text-rose-600 font-bold">Expensive.</span><br/>
                  ...
                  <tr className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-5 text-gray-600 bg-indigo-50/10">
                      <span className="text-indigo-600 font-bold">Unlimited.</span><br/>
          ...
          <section>
            ...
            <div className="space-y-12">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2 border-b border-gray-200 pb-2">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
                    <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-indigo-50 text-indigo-700">
                    ...
                    <div className="p-6 text-gray-600 space-y-3 leading-relaxed text-sm">
                      ...
                      <p className="mt-2 text-indigo-800 font-medium">Why Buy Calls Here?</p>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
                    <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-blue-50 text-blue-700">
                      <div className="flex items-center gap-3">
                    ...
                    <div className="p-6 text-gray-600 space-y-3 leading-relaxed text-sm">
                      ...
                      <p className="mt-2 text-blue-800 font-medium">The Signal:</p>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
                    <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-rose-50 text-rose-700">
                      <div className="flex items-center gap-3">
                    ...
                    <div className="p-6 text-gray-600 space-y-3 leading-relaxed text-sm">
                      ...
                      <p className="mt-2 text-rose-800 font-medium">The Setup:</p>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
                    <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-emerald-50 text-emerald-700">
                      <div className="flex items-center gap-3">
                    ...
                    <div className="p-6 text-gray-600 space-y-3 leading-relaxed text-sm">
                      ...
                      <p className="mt-2 text-xs bg-emerald-100 text-emerald-800 p-2 rounded">
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
                    <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-slate-50 text-slate-700">
                      <div className="flex items-center gap-3">
                    ...
                    <div className="p-6 text-gray-600 space-y-3 leading-relaxed text-sm">
                      ...
                      <p className="mt-2 text-xs bg-slate-100 text-slate-800 p-2 rounded">
