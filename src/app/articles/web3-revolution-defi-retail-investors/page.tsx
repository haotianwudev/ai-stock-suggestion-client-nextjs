    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-800">
        ...
        <section className="mb-20">
          <div className="p-8 md:p-10 bg-[#A8672E]/10 dark:bg-[#D08F52]/10 border border-indigo-200 rounded-xl shadow-lg">
            <h3 className="text-3xl font-bold text-[#A8672E] dark:text-[#D08F52] mb-4 flex items-center font-serif">
              <span className="mr-3 p-2 bg-indigo-200 rounded-md">
                <Globe className="w-6 h-6 text-[#A8672E] dark:text-[#D08F52]" />
              </span>
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <div className="mx-auto w-12 h-12 flex items-center justify-center rounded-full bg-teal-100 mb-4">
              <Zap className="w-6 h-6 text-[#A8672E] dark:text-[#D08F52]" />
            </div>
            <h2 className="text-4xl font-extrabold text-gray-800 tracking-tight mb-2 font-serif">
              Section 1: The Four Pillars of Web3
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {web3Pillars.map((pillar, index) => (
              <div key={index} className="p-6 bg-white dark:bg-[#0A0D14] border border-gray-100 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <div className="mx-auto w-12 h-12 flex items-center justify-center rounded-full bg-orange-100 mb-4">
              <DollarSign className="w-6 h-6 text-[#BC4128] dark:text-[#E2694A]" />
            </div>
            <h2 className="text-4xl font-extrabold text-gray-800 tracking-tight mb-2 font-serif">
          ...
          <div className="space-y-6">
            {defiPrimitives.map((primitive, index) => (
              <div key={index} className="p-6 bg-white dark:bg-[#0A0D14] border border-gray-100 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col md:flex-row items-start md:items-center p-5 border-l-4 border-[#BC4128] dark:border-[#E2694A]">
          ...
          <div className="mt-10 text-center">
            <p className="text-lg font-semibold text-gray-700 p-4 bg-gray-100 rounded-lg shadow-inner">
              <span className="text-[#A8672E] dark:text-[#D08F52] font-bold">Impact:</span> DeFi offers enhanced financial inclusion, operates 24/7/365, and functions as a <strong>&ldquo;glass box&rdquo;</strong> (transparent) compared to TradFi&apos;s &ldquo;black box&rdquo; (opaque).
            </p>
          </div>
        </section>
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <div className="mx-auto w-12 h-12 flex items-center justify-center rounded-full bg-indigo-100 mb-4">
              <HandCoins className="w-6 h-6 text-[#A8672E] dark:text-[#D08F52]" />
            </div>
            <h2 className="text-4xl font-extrabold text-gray-800 tracking-tight mb-2 font-serif">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {investorImpact.map((item, index) => (
              <div key={index} className="p-8 bg-white dark:bg-[#0A0D14] border border-gray-100 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-t-8 border-[#A8672E] dark:border-[#D08F52]">
                <div className="flex items-center mb-4">
                  <div className="p-3 bg-[#A8672E] dark:bg-[#D08F52] rounded-full mr-4 shadow-md">
          ...
          <div className="mt-10">
            ...
            <ul className="space-y-3 pl-4">
              <li className="flex items-start">
                <span className="text-[#BC4128] dark:text-[#E2694A] mr-3 mt-1">•</span>
                <div>
