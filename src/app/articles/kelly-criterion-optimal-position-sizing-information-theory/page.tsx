...
import { BookOpen, Lightbulb, LineChart, PieChart, AlertTriangle, Building2, Users, CheckCircle2, XCircle, Sigma, Zap } from 'lucide-react';
      ...
      <div className="space-y-16">
        ...
        <section className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-slate-700">
            ...
            <div className="my-8">
              <h4 className="text-sm font-bold text-emerald-700 uppercase tracking-wider mb-3">The Discrete Binary Kelly Formula</h4>
              <MathBlock math="f^* = \frac{bp - q}{b}" />
              <p className="mt-4 text-emerald-900 leading-relaxed bg-emerald-50/50 p-4 rounded-xl border-l-4 border-emerald-500">
        ...
        <section className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-slate-700">
            ...
            <div className="my-8">
              <h4 className="text-sm font-bold text-sky-700 uppercase tracking-wider mb-3">Continuous Kelly (Merton Fraction)</h4>
              <MathBlock math="f^* = \frac{\mu - r}{\sigma^2}" />
              <p className="mt-4 text-sky-900 leading-relaxed bg-sky-50/50 p-4 rounded-xl border-l-4 border-sky-500">
                Where <strong>&mu;</strong> is the expected return, <strong>r</strong> is the risk-free rate, and <strong>&sigma;&sup2;</strong> is the variance. Allocation is directly proportional to the risk premium and inversely proportional to systemic risk.
              </p>
            </div>
        ...
        <section className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-slate-700">
            ...
            <ul className="list-disc pl-6 space-y-4 marker:text-slate-400">
              ...
              <li><strong>Extreme Concentration:</strong> Kelly eschews passive diversification. It might tell you to put 40% of your net worth into a single options spread&mdash;violating prudent index investing principles.</li>
