...
import { ArrowLeft, TrendingUp, TrendingDown, AlertTriangle, DollarSign, Shield, Zap, Globe, Activity, BarChart3, PieChart, ArrowRight, BookOpen, Anchor, Maximize2, Music } from 'lucide-react';
...
export default function MacroEconomicOutlook2026() {
  ...
  const currentArticle = articles.find(article => article.slug === 'navigating-2026-shift-comprehensive-macro-economic-outlook');
  ...
  return (
    <>
      ...
      <BreadcrumbStructuredData 
        ...
        articleSlug={currentArticle.slug || 'navigating-2026-shift-comprehensive-macro-economic-outlook'} 
      />

      <div className="min-h-screen bg-slate-50 font-sans selection:bg-indigo-100 selection:text-indigo-900">
        {/* Decorative Background Elements */}
        <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
          <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-purple-200/40 rounded-full blur-3xl opacity-50 mix-blend-multiply animate-pulse"></div>
          <div className="absolute top-[20%] left-[-10%] w-[600px] h-[600px] bg-blue-200/40 rounded-full blur-3xl opacity-50 mix-blend-multiply"></div>
          <div className="absolute bottom-[-10%] right-[20%] w-[400px] h-[400px] bg-emerald-200/40 rounded-full blur-3xl opacity-50 mix-blend-multiply"></div>
        </div>
        ...
        <div className="bg-white relative overflow-hidden border-b border-slate-100">
          <div className="max-w-5xl mx-auto px-6 pt-24 pb-20 relative z-10">
            <div className="mb-6">
              <Badge color="purple"><Zap size={14}/> Deep Research</Badge>
              {currentArticle?.podcastUrl && (
                <span className="ml-2">
                  <Badge color="emerald"><Music size={14}/> Podcast</Badge>
                </span>
              )}
            </div>
            <h1 className="text-5xl md:text-7xl font-black text-slate-900 leading-[1.1] mb-8 tracking-tight">
              Navigating the <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">2026 Shift</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-600 leading-relaxed max-w-3xl font-light">
              As we exit the post-pandemic recovery phase, 2026 presents a unique paradox: <span className="font-semibold text-slate-800">Slowing growth meets sticky inflation.</span> Prepare your portfolio for the Great Normalization.
            </p>
          </div>
        </div>

        {/* Hero Infographic - Below Title with Full-Screen Capability */}
        <section className="max-w-5xl mx-auto px-6 pt-12 pb-8 relative z-10">
          <div 
            className="rounded-2xl overflow-hidden shadow-2xl border border-slate-200 cursor-pointer group relative"
            onClick={() => setIsImageViewerOpen(true)}
          >
            <img 
              src="https://i.imgur.com/uoz3V2q.jpeg" 
              alt="2026 Macro Economic Outlook Infographic" 
        ...
        <main className="max-w-5xl mx-auto px-6 py-16 relative z-10">
          ...
          <section id="macro" className="mb-24">
            <SectionHeader 
          ...
          <section id="strategy" className="mb-24">
            ...
            <div className="mt-12 bg-indigo-900 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-full opacity-10">
                <div className="w-full h-full bg-[radial-gradient(#ffffff_2px,transparent_2px)] [background-size:30px_30px]"></div>
              </div>
              <div className="relative z-10 max-w-2xl mx-auto">
                <BookOpen className="w-12 h-12 text-indigo-300 mx-auto mb-6" />
                <h3 className="text-3xl font-bold text-white mb-4">Ready for Downside Protection?</h3>
                <p className="text-indigo-200 text-lg mb-8">Don't wait for the headlines. The best time to hedge against stagflation is before it becomes consensus.</p>
                <button className="bg-white text-indigo-900 px-8 py-3 rounded-xl font-bold hover:bg-indigo-50 transition-colors">
                  Get the Defensive Checklist
                </button>
              </div>
            </div>
          </section>
        ...
        <footer className="bg-white border-t border-slate-200 py-12 relative z-10">
          <div className="max-w-6xl mx-auto px-6 text-center">
            <div className="flex justify-center items-center gap-2 mb-6">
              ...
              <span className="text-lg font-bold text-slate-800">MacroView<span className="text-indigo-600">2026</span></span>
            </div>
            <p className="text-slate-400 text-sm max-w-xl mx-auto mb-8">
              This research is for educational purposes only. Financial markets are volatile and 2026 predictions are based on current data trajectories. Consult a certified financial advisor before making investment decisions.
            </p>
