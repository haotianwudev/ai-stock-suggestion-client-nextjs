...
import { Calculator, TrendingUp, ShieldAlert, Code, Database, ArrowRight, PieChart, Activity, DollarSign, Layers, CheckCircle, XCircle, BookOpen, Scale, GitBranch, Table, Filter, Maximize2, Minimize2, Sliders, BarChart2, Music } from 'lucide-react';
...
export default function DirectIndexingTaxLossHarvestingTutorial() {
  ...
  is_long_term: boolean;   // > 365 days held
      ...
      <div className="text-slate-500 text-sm mt-8 border-t border-slate-200 pt-8">
