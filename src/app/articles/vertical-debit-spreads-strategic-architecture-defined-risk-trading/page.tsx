        ...
        <main className="max-w-6xl mx-auto px-6 py-16 space-y-32">
          ...
          <section className="space-y-12">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-6">Why Professionals Trade Spreads</h2>
          ...
          <section className="bg-white dark:bg-[#14171B] rounded-3xl shadow-xl dark:shadow-none border border-slate-100 dark:border-white/10 overflow-hidden relative">
            ...
            <div className="p-8 md:p-12 relative z-10">
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                {/* Bull Call Spread */}
                <div className="bg-teal-50 dark:bg-teal-900/20 rounded-2xl p-8 border border-teal-100 dark:border-teal-900/30 relative group transition-all hover:shadow-lg hover:border-teal-200">
                  <div className="flex justify-between items-start mb-6">
                    <h3 className="text-2xl font-bold text-teal-900 dark:text-teal-400 flex items-center gap-2">
                      <TrendingUp size={24} />
                      Bull Call Spread
                    </h3>
                  ...
                  <div className="space-y-6">
                    <div className="bg-white dark:bg-[#14171B] p-4 rounded-xl border border-teal-100 dark:border-teal-900/30 shadow-sm relative overflow-hidden">
                      ...
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-xs font-mono text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30 px-2 text-emerald-600 dark:text-emerald-400 dark:text-emerald-400 py-1 rounded">Delta ~0.70</span>
                      </div>
                    ...
                    <div className="bg-white/60 dark:bg-black/40 p-4 rounded-xl border border-teal-100 dark:border-teal-900/30 border-dashed relative overflow-hidden">
                      ...
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-xs font-mono text-rose-500 bg-rose-50 dark:bg-rose-900/30 px-2 text-rose-500 dark:text-rose-400 py-1 rounded">Delta ~0.30</span>
                      </div>
                    ...
                    <div className="pt-4 border-t border-teal-200 mt-4">
                      <div className="flex justify-between text-sm font-bold text-teal-900 dark:text-teal-400">
                        <span>Net Effect:</span>
                        <span>Pay a Debit</span>
                      </div>
                      <p className="text-xs text-teal-700 dark:text-teal-300 mt-1">You want the stock to go UP, but you don't care if it goes past your short strike.</p>
                    </div>
                  </div>
                </div>

                {/* Bear Put Spread */}
                <div className="bg-rose-50 dark:bg-rose-900/20 rounded-2xl p-8 border border-rose-100 dark:border-rose-900/30 relative group transition-all hover:shadow-lg hover:border-rose-200">
                  <div className="flex justify-between items-start mb-6">
                    <h3 className="text-2xl font-bold text-rose-900 dark:text-rose-400 flex items-center gap-2">
                      <TrendingDown size={24} />
                      Bear Put Spread
                    </h3>
                    <div className="bg-rose-200 text-rose-800 dark:text-rose-400 dark:bg-rose-900/50 dark:text-rose-300 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">
                      Bearish Strategy
                    </div>
                  </div>
                  <div className="space-y-6">
                    ...
                    <div className="bg-white/60 dark:bg-black/40 p-4 rounded-xl border border-rose-100 dark:border-rose-900/30 border-dashed relative overflow-hidden">
                      <div className="absolute left-0 top-0 bottom-0 w-1 bg-rose-400"></div>
                      <div className="flex justify-between items-center mb-1">
                    ...
                    <div className="pt-4 border-t border-rose-200 mt-4">
                      <div className="flex justify-between text-sm font-bold text-rose-900 dark:text-rose-400">
                        <span>Net Effect:</span>
                        <span>Pay a Debit</span>
                      </div>
                      <p className="text-xs text-rose-700 dark:text-rose-400 dark:text-rose-300 mt-1">You want the stock to go DOWN, but your profit stops at the short strike.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="scroll-mt-24" id="mathematics">
            <div className="mb-10 text-center md:text-left">
              <h2 className="text-4xl font-extrabold text-slate-900 dark:text-white mb-3 flex items-center gap-3 justify-center md:justify-start">
                <Scale className="text-indigo-600 dark:text-indigo-400" size={36} />
            ...
            <div className="bg-white dark:bg-[#14171B] rounded-3xl border border-slate-200 dark:border-white/10 shadow-xl dark:shadow-none overflow-hidden min-h-[500px]">
              ...
              {mathTab === 'financials' && (
                <div className="animate-fadeIn p-8">
                  <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 pb-6 border-b border-slate-100 dark:border-slate-800 dark:border-slate-800 gap-4">
                    <div>
                      <h3 className="text-2xl font-bold text-slate-800 dark:text-white">Cost Basis Analysis</h3>
                      <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 mt-1">Hypothetical: Stock XYZ @ $100</p>
                    </div>
                    <div className="bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 px-4 py-2 rounded-lg text-sm font-semibold border border-indigo-100 dark:border-indigo-900/30 self-start">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse min-w-[600px]">
                      <thead>
                        <tr className="bg-slate-50 text-slate-500 dark:text-slate-400 dark:text-slate-500 text-sm uppercase tracking-wider">
                          <th className="p-4 font-semibold border-b border-slate-200 dark:border-slate-800 rounded-tl-xl w-1/4">Metric</th>
                          <th className="p-4 font-semibold border-b border-slate-200 dark:border-slate-800 text-rose-600 dark:text-rose-400 dark:text-rose-400 w-1/4">Naked Long Call ($100)</th>
                          <th className="p-4 font-semibold border-b border-slate-200 dark:border-slate-800 text-emerald-600 dark:text-emerald-400 dark:text-emerald-400 bg-emerald-50/50 dark:bg-emerald-900/20 w-1/4">Bull Call Spread ($100/$105)</th>
                      ...
                      <tbody className="text-slate-700 dark:text-slate-300">
                        <tr className="border-b border-slate-100 dark:border-slate-800 dark:border-slate-800 hover:bg-slate-50/50 dark:hover:bg-slate-900/40 transition-colors">
                          ...
                          <td className="p-4 align-top text-lg font-mono text-rose-700 dark:text-rose-400 dark:text-rose-300">$5.00</td>
                          <td className="p-4 align-top bg-emerald-50/30 dark:bg-emerald-900/20">
                            <div className="text-lg font-mono text-emerald-700 dark:text-emerald-400 font-bold">$3.00</div>
                            <div className="text-xs text-emerald-600 dark:text-emerald-400 mt-1">($5.00 Buy - $2.00 Sell)</div>
                          </td>
                          <td className="p-4 align-top text-sm text-slate-600 dark:text-slate-400">
                            <span className="font-semibold text-emerald-600 dark:text-emerald-400">40% Capital Reduction.</span> You finance the trade by selling the "unlikely" upside.
                          </td>
                        </tr>
                        <tr className="border-b border-slate-100 dark:border-slate-800 dark:border-slate-800 hover:bg-slate-50/50 dark:hover:bg-slate-900/40 transition-colors">
                          <td className="p-4 align-top">
                          ...
                          <td className="p-4 align-top bg-emerald-50/30 dark:bg-emerald-900/20 font-bold text-emerald-700 dark:text-emerald-400 font-mono">$103.00</td>
                          <td className="p-4 align-top text-sm text-slate-600 dark:text-slate-400">
                            <span className="font-semibold text-emerald-600 dark:text-emerald-400">2% Edge.</span> The spread makes money starting at $103. The naked call is still losing money until $105.
                          </td>
                        </tr>
                        <tr className="border-b border-slate-100 dark:border-slate-800 dark:border-slate-800 hover:bg-slate-50/50 dark:hover:bg-slate-900/40 transition-colors">
                          <td className="p-4 align-top">
                          ...
                          <td className="p-4 align-top text-emerald-600 dark:text-emerald-400 font-bold">Unlimited</td>
                          <td className="p-4 align-top bg-emerald-50/30 dark:bg-emerald-900/20 text-slate-600 dark:text-slate-400 font-mono">
                            $200
                        ...
                        <tr className="hover:bg-slate-50/50 transition-colors">
                          ...
                          <td className="p-4 align-top text-rose-600 dark:text-rose-400 font-medium">High Impact (-$$)</td>
                          <td className="p-4 align-top bg-emerald-50/30 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 font-medium">Reduced Impact (-$)</td>
                          <td className="p-4 align-top text-sm text-slate-600 dark:text-slate-400">
              ...
              {mathTab === 'outcomes' && (
                <div className="animate-fadeIn p-8 bg-slate-50/50 dark:bg-slate-900/10 h-full">
                  <div className="text-center mb-10">
                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Scenario Outcome Matrix</h3>
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white dark:bg-[#14171B] p-6 rounded-2xl shadow-sm dark:shadow-none border-2 border-indigo-100 dark:border-indigo-900/30 transform hover:scale-105 transition-transform duration-300 relative overflow-hidden">
                      ...
                      <div className="space-y-4">
                        <div className="bg-rose-50 dark:bg-rose-900/20 p-3 rounded-lg border border-rose-100 dark:border-rose-900/30">
                          <div className="text-xs text-rose-800 dark:text-rose-400 font-semibold mb-1">Naked Call ($100 Strike)</div>
                          <div className="flex justify-between items-end">
                            <span className="text-sm text-slate-600 dark:text-slate-400">Value: $4.00</span>
                            <span className="font-mono font-bold text-rose-600 dark:text-rose-400">-$100 Loss</span>
                          </div>
                        ...
                        <div className="bg-emerald-50 dark:bg-emerald-900/20 p-3 rounded-lg border border-emerald-100 dark:border-emerald-900/30">
                          <div className="text-xs text-emerald-800 dark:text-emerald-400 font-semibold mb-1">Debit Spread ($100/$105)</div>
                          <div className="flex justify-between items-end">
                            <span className="text-sm text-slate-600 dark:text-slate-400">Value: $4.00</span>
                            <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400">+$100 Profit</span>
                          </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-slate-50 dark:bg-[#14171B] p-3 rounded-lg border border-slate-200 dark:border-white/10">
                          ...
                          <div className="flex justify-between items-end">
                            ...
                            <span className="font-mono font-bold text-rose-600 dark:text-rose-400">-$500 Loss</span>
                          </div>
                        </div>
                        <div className="bg-slate-50 dark:bg-[#14171B] p-3 rounded-lg border border-slate-200 dark:border-white/10">
                          ...
                          <div className="flex justify-between items-end">
                            <span className="text-sm text-slate-600 dark:text-slate-400">Value: $0</span>
                            <span className="font-mono font-bold text-rose-600 dark:text-rose-400">-$300 Loss</span>
                          </div>
                        </div>
                      </div>
                      <div className="mt-4 pt-4 border-t border-slate-100 text-sm text-slate-600 dark:text-slate-400 text-center">
                    ...
                    <div className="bg-white dark:bg-[#14171B] p-6 rounded-2xl shadow-sm dark:shadow-none border border-slate-200 dark:border-white/10 hover:border-amber-300 dark:hover:border-amber-900/50 transition-colors">
                      ...
                      <div className="space-y-4">
                        <div className="bg-emerald-50 dark:bg-emerald-900/20 p-3 rounded-lg border border-emerald-100 dark:border-emerald-900/30">
                          <div className="text-xs text-emerald-800 dark:text-emerald-400 font-semibold mb-1">Naked Call</div>
                          <div className="flex justify-between items-end">
                            <span className="text-sm text-slate-600 dark:text-slate-400">Value: $15.00</span>
                            <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400">+$1,000 Profit</span>
                          </div>
                        ...
                        <div className="bg-slate-50 dark:bg-[#14171B] p-3 rounded-lg border border-slate-200 dark:border-white/10">
                          ...
                          <div className="flex justify-between items-end">
                            ...
                            <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400">+$200 Profit</span>
                          </div>
              ...
              {mathTab === 'greeks' && (
                <div className="animate-fadeIn p-8">
                  <div className="grid md:grid-cols-2 gap-8 h-full">
                    <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl p-6 border border-indigo-100 dark:border-indigo-900/30 dark:border-indigo-900/30">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="bg-white dark:bg-[#14171B] p-2 rounded-lg shadow-sm dark:shadow-none text-indigo-600 dark:text-indigo-400 dark:text-indigo-400">
                          <Clock size={24} />
                        </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 bg-white dark:bg-[#14171B] h-8 rounded border border-rose-200 dark:border-rose-900/30 overflow-hidden relative">
                            ...
                            <div className="absolute top-0 right-2 h-full flex items-center text-xs text-rose-700 dark:text-rose-400 dark:text-rose-300 font-bold">High Decay</div>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 bg-white dark:bg-[#14171B] h-8 rounded border border-emerald-200 dark:border-emerald-900/30 overflow-hidden relative">
                            ...
                            <div className="absolute top-0 right-2 h-full flex items-center text-xs text-emerald-700 dark:text-emerald-400 font-bold">Offsets Decay</div>
                          </div>
                        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-50 dark:bg-slate-900/20 p-4 rounded-xl border border-slate-200 dark:border-slate-800 opacity-60">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-xs bg-slate-200 text-slate-600 dark:bg-slate-800 dark:text-slate-400 px-2 py-1 rounded-full">SELL SPREADS</span>
                  </div>
                ...
                <div className="w-full space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 bg-white h-12 rounded-lg border border-emerald-200 shadow-sm flex items-center px-4 relative overflow-hidden">
                      ...
                      <span className="ml-auto text-xs text-emerald-600 dark:text-emerald-400 font-medium">Intrinsic Value</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 bg-white h-12 rounded-lg border border-rose-200 shadow-sm flex items-center px-4 relative overflow-hidden">
                      ...
                      <span className="ml-auto text-xs text-rose-600 dark:text-rose-400 font-medium">Extrinsic Only</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">The Pre-Flight Checklist</h2>
              ...
              <div className="p-8 min-h-[250px] flex items-center">
                {checklistStep === 0 && (
                  <div className="animate-fadeIn w-full">
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">1. Is the Option Liquid?</h3>
                    ...
                    <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-lg flex items-center justify-between">
                      <div className="text-center">
                        ...
                        <div className="font-mono font-bold text-emerald-600 dark:text-emerald-400">$1.00 / $1.05</div>
                      </div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="font-mono font-bold text-rose-600 dark:text-rose-400">$1.00 / $1.50</div>
                      </div>
                    </div>
                    <div className="mt-4 text-sm text-indigo-600 dark:text-indigo-400 font-semibold flex items-center gap-2">
                ...
                {checklistStep === 1 && (
                  <div className="animate-fadeIn w-full">
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">2. Is IV Rank Low?</h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-4">
                    ...
                    <div className="flex justify-between text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-500 mb-4">
                      <span>0%</span>
                      <span className="text-emerald-600 dark:text-emerald-400">Target Zone (0-30%)</span>
                      <span>100%</span>
                    </div>
                    <div className="mt-4 text-sm text-indigo-600 dark:text-indigo-400 font-semibold flex items-center gap-2">
                ...
                {checklistStep === 2 && (
                  <div className="animate-fadeIn w-full">
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">3. Does the Trend Agree?</h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-900/30 rounded-lg">
                        <span className="block text-xs font-bold text-emerald-800 dark:text-emerald-400 mb-1">Bull Call</span>
                        <span className="text-sm text-slate-700 dark:text-slate-300">Stock &gt; 50 SMA. Higher Highs.</span>
                      </div>
                      <div className="p-3 bg-rose-50 dark:bg-rose-900/20 border border-rose-100 dark:border-rose-900/30 rounded-lg">
                        <span className="block text-xs font-bold text-rose-800 dark:text-rose-400 mb-1">Bear Put</span>
                ...
                {checklistStep === 3 && (
                  <div className="animate-fadeIn w-full">
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">4. Are Earnings Approaching?</h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-4">
                      Binary events are dangerous for debit spreads due to "IV Crush."
                    </p>
                    <div className="flex items-center gap-4 bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg border border-orange-100 dark:border-orange-900/30">
          ...
          <section className="space-y-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white">Critical Dangers</h2>
            </div>
            <div className="bg-orange-50 dark:bg-orange-900/20 rounded-2xl p-8 border border-orange-200 dark:border-orange-900/30">
              <h3 className="text-xl font-bold text-orange-900 dark:text-orange-400 mb-4">Pin Risk: The Expiration Nightmare</h3>
              ...
              <div className="bg-white dark:bg-[#14171B] p-4 rounded-lg border border-orange-200 dark:border-orange-900/30 text-orange-700 dark:text-orange-400 font-semibold text-center">
...
const Card = ({ icon, title, children, color }: { icon: React.ReactNode; title: string; children: React.ReactNode; color: string }) => {
  const colorClasses = {
    emerald: 'bg-emerald-50 border-emerald-100 hover:border-emerald-300 hover:shadow-emerald-100 dark:bg-emerald-900/20 dark:border-emerald-900/30 dark:hover:border-emerald-700 dark:hover:shadow-none',
    blue: 'bg-blue-50 border-blue-100 hover:border-blue-300 hover:shadow-blue-100 dark:bg-blue-900/20 dark:border-blue-900/30 dark:hover:border-blue-700 dark:hover:shadow-none',
...
const MathTab = ({ active, onClick, icon, label }: { active: boolean; onClick: () => void; icon: React.ReactNode; label: string }) => (
  <button
    ...
    className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 ${
      active
        ? 'bg-white dark:bg-[#14171B] text-indigo-700 dark:text-indigo-400 shadow-sm ring-1 ring-slate-200 dark:ring-white/10'
