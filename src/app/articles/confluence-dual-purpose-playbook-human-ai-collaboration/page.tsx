    ...
    >
      <div className="space-y-16">
        <section id="principles">
          <h2 className="text-3xl font-bold text-center mb-2 text-blue-900 dark:text-blue-300">The 5 Core Principles</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 text-center">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg transform hover:scale-105 transition-transform border dark:border-gray-700">
              ...
              <h3 className="text-xl font-bold mt-4 mb-2 text-gray-900 dark:text-white">Architect</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Build a clear, logical, and scalable information architecture.</p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg transform hover:scale-105 transition-transform border dark:border-gray-700">
              <div className="text-5xl text-blue-500">⚛️</div>
              <h3 className="text-xl font-bold mt-4 mb-2 text-gray-900 dark:text-white">Atomize</h3>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg transform hover:scale-105 transition-transform border dark:border-gray-700">
              <div className="text-5xl text-blue-500">✍️</div>
              <h3 className="text-xl font-bold mt-4 mb-2 text-gray-900 dark:text-white">Structure</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Use semantic formatting like headings, lists, and tables.</p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg transform hover:scale-105 transition-transform border dark:border-gray-700">
              <div className="text-5xl text-blue-500">⚙️</div>
              <h3 className="text-xl font-bold mt-4 mb-2 text-gray-900 dark:text-white">Automate</h3>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg transform hover:scale-105 transition-transform border dark:border-gray-700">
              ...
              <h3 className="text-xl font-bold mt-4 mb-2 text-gray-900 dark:text-white">Govern</h3>
        ...
        <section id="architecture">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border dark:border-gray-700">
              <h2 className="text-3xl font-bold mb-4 text-blue-900 dark:text-blue-300">Architecting for Clarity</h2>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1 border-2 border-green-400 p-4 rounded-lg bg-green-50 dark:bg-green-900/20">
                  <h4 className="font-bold text-green-800 dark:text-green-300">✓ Good: Shallow & Logical</h4>
                  <p className="text-sm text-green-700 dark:text-green-400">Max 3-4 levels deep, predictable structure, easy navigation.</p>
                </div>
                <div className="flex-1 border-2 border-red-400 p-4 rounded-lg bg-red-50 dark:bg-red-900/20">
                  <h4 className="font-bold text-red-800 dark:text-red-300">✗ Bad: Deep & Chaotic</h4>
                  <p className="text-sm text-red-700 dark:text-red-400">5+ levels deep, inconsistent organization, hard to find anything.</p>
                </div>
              </div>
            </div>
              ...
              <div className="w-full">
                ...
                <div className="flex justify-around items-end h-48">
                  <div className="text-center">
                    <p className="font-semibold text-green-600 dark:text-green-400">Ideal</p>
                  ...
                  <div className="text-center">
                    <p className="font-semibold text-red-600 dark:text-red-400">Problematic</p>
        ...
        <section id="atomicity" className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border dark:border-gray-700">
          <h2 className="text-3xl font-bold text-center mb-4 text-blue-900 dark:text-blue-300">The Power of Atomicity</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div>
              <h3 className="font-semibold text-xl text-center text-red-700 dark:text-red-400 mb-4">✗ Before: Monolithic Page</h3>
              <div className="border-2 border-red-300 rounded-lg p-4 bg-red-50 dark:bg-red-900/20">
              ...
              <div className="border-2 border-dashed border-red-400 p-4 rounded-lg bg-red-50 dark:bg-red-900/20">
                ...
                <p className="text-xs text-center text-red-600 dark:text-red-400 mt-2">Context is mixed and unclear.</p>
              </div>
            </div>
            <div>
              <h3 className="font-semibold text-xl text-center text-green-700 dark:text-green-400 mb-4">✓ After: Atomic Pages</h3>
              ...
              <div className="border-2 border-dashed border-green-400 p-4 rounded-lg bg-green-50 dark:bg-green-900/20">
                ...
                <p className="text-xs text-center text-green-600 dark:text-green-400 mt-2">Context is focused and reliable.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="atomic-deep-dive" className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border dark:border-gray-700">
          <h2 className="text-3xl font-bold text-center mb-4 text-blue-900 dark:text-blue-300">The Atomic Principle: A Deeper Dive</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold text-red-700 dark:text-red-400 mb-4">❌ Vague &ldquo;Before&rdquo; Example</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-green-700 dark:text-green-400 mb-4">✅ Detailed &ldquo;After&rdquo; Example</h3>
              <div className="bg-green-50 dark:bg-green-900/20 border-2 border-green-200 dark:border-green-800 rounded-lg p-6">
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded border-l-4 border-green-500 mb-3">
                ...
                <div className="space-y-2 text-sm">
                  <div className="bg-white dark:bg-gray-900 p-2 rounded border-l-2 border-green-400 text-gray-700 dark:text-gray-300">
                ...
                <div className="bg-green-100 dark:bg-green-900/30 p-3 rounded mt-4">
                  ...
                  <p className="text-green-700 dark:text-green-400 text-sm">When the LLM is asked about security hardening, it can retrieve the CHECKLIST page. The page&apos;s title and content are 100% relevant, providing a clean, unambiguous source for a precise answer.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="semantic-formatting" className="bg-slate-50 dark:bg-gray-800/50 p-8 rounded-xl shadow-lg border dark:border-gray-700">
          <h2 className="text-3xl font-bold text-center mb-4 text-blue-900 dark:text-blue-300">Semantic Formatting in Practice</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold text-red-700 dark:text-red-400 mb-4">❌ Poorly Formatted &ldquo;Before&rdquo;</h3>
              <div className="bg-white dark:bg-gray-900 border-2 border-red-200 dark:border-red-800 rounded-lg p-6">
                ...
                <div className="bg-red-100 dark:bg-red-900/30 p-3 rounded mt-4">
                  <p className="font-semibold text-red-800 dark:text-red-300">Problem:</p>
                  <p className="text-red-700 dark:text-red-400 text-xs">The heading gives no context. Steps are buried in a paragraph. Key values are not highlighted. The AI struggles to extract a clear, sequential process from this &ldquo;wall of text.&rdquo;</p>
                </div>
              </div>
            </div>

            <div>
              <h3 className="text-xl font-bold text-green-700 dark:text-green-400 mb-4">✅ Well-Formatted &ldquo;After&rdquo;</h3>
              <div className="bg-white dark:bg-gray-900 border-2 border-green-200 dark:border-green-800 rounded-lg p-6">
                <h2 className="text-lg font-bold text-gray-800 dark:text-gray-200 mb-3">Project Setup Instructions</h2>

                <div className="bg-blue-100 dark:bg-blue-900/30 border-l-4 border-blue-500 p-3 mb-4">
                ...
                <h3 className="text-md font-bold text-gray-700 dark:text-gray-300 mb-2">1. Initial Setup</h3>
                ...
                <h3 className="text-md font-bold text-gray-700 dark:text-gray-300 mb-2">2. Environment Configuration</h3>
                <ul className="text-sm text-gray-600 dark:text-gray-400 mb-4 ml-4">
                ...
                <h3 className="text-md font-bold text-gray-700 dark:text-gray-300 mb-2">3. Running Tests</h3>
                ...
                <div className="bg-green-100 dark:bg-green-900/30 p-3 rounded mt-4">
                  <p className="font-semibold text-green-800 dark:text-green-300">Benefit:</p>
                  <p className="text-green-700 dark:text-green-400 text-xs">Hierarchical headings create a document outline. Numbered lists provide explicit sequences. Bolding and code styles make critical entities stand out for both humans and AI.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="native-macros" className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border dark:border-gray-700">
          <h2 className="text-3xl font-bold text-center mb-4 text-blue-900 dark:text-blue-300">Mastering Native Macros for a &ldquo;No-Code&rdquo; Database</h2>
          ...
          <div className="max-w-4xl mx-auto">
            <h3 className="text-xl font-bold text-blue-800 dark:text-blue-300 mb-4">Example: Tracking All Projects</h3>
        ...
        <section id="roadmap">
          <h2 className="text-3xl font-bold text-center mb-12 text-blue-900 dark:text-blue-300">Your 3-Phase Implementation Roadmap</h2>
          <div className="relative">
            <div className="absolute left-1/2 -translate-x-1/2 h-full w-1 bg-blue-600 rounded hidden md:block"></div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
              <div className="md:text-right">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border-l-4 border-blue-500 md:border-l-0 md:border-r-4">
                  <h3 className="text-2xl font-bold text-blue-900 dark:text-blue-300">Phase 1: Foundation</h3>
                  <p className="font-semibold text-blue-700 dark:text-blue-400">(Days 1-30)</p>
              ...
              <div>
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border-l-4 border-blue-500">
                  <h3 className="text-2xl font-bold text-blue-900 dark:text-blue-300">Phase 2: Optimization</h3>
                  <p className="font-semibold text-blue-700 dark:text-blue-400">(Days 30-90)</p>
              ...
              <div className="md:text-right">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border-l-4 border-blue-500 md:border-l-0 md:border-r-4">
                  <h3 className="text-2xl font-bold text-blue-900 dark:text-blue-300">Phase 3: Governance</h3>
                  <p className="font-semibold text-blue-700 dark:text-blue-400">(Ongoing)</p>
