  ...
  <div>
    ...
    <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <InfoCard icon={<Shield />} title="Calculated Risk">
        <p>Often mislabeled as &ldquo;very risky,&rdquo; this strategy is actually a conservative tool when managed properly. The real danger isn&apos;t the option, it&apos;s the risk-insensitive trader.</p>
      </InfoCard>
    </div>
  ...
  <div className="space-y-8">
    ...
    <InfoCard icon={<TrendingUp />} title="Strategy Objective">
      ...
      <ul className="list-disc pl-6 mt-2 space-y-2">
        ...
        <li><strong>Buy Stock at a Discount:</strong> Sell a put with a strike price at which you&apos;re happy to own a stock. If the stock price drops below the strike, you&apos;re &ldquo;assigned&rdquo; and buy the shares at your predetermined price, effectively at a discount (strike price - premium received).</li>
      </ul>
      <p className="mt-4 italic text-gray-500 dark:text-gray-400">The premium cash is yours to keep upfront, regardless of the outcome.</p>
    </InfoCard>

    <InfoCard icon={<ChevronsRight />} title="Key Decisions">
      <p><strong className="text-gray-900 dark:text-white">Success depends on making intelligent choices:</strong></p>
...
const RiskPage = () => (
  <div className="space-y-8">
    ...
    <InfoCard icon={<Wrench />} title="Repair Strategies: When a Trade Goes Wrong" className="border-yellow-500/50">
      <p><strong className="text-gray-900 dark:text-white">When a stock moves against you, you have several choices. Don&apos;t just hold and hope.</strong></p>
      <ul className="list-disc pl-6 mt-2 space-y-2">
    ...
    <InfoCard icon={<DollarSign />} title="Trading Expenses" className="border-yellow-500/50">
      <p>Because this strategy involves frequent trading, <strong className="text-gray-900 dark:text-white">commissions matter</strong>. High costs can significantly erode your profits.</p>
      <div className="bg-gray-200 dark:bg-gray-700/50 p-4 rounded-lg mt-4">
        <p className="font-semibold text-gray-900 dark:text-white mb-2">Example: The Impact of Costs</p>
      ...
      <p className="font-semibold text-gray-900 dark:text-white mt-4">Possible Solutions:</p>
      <ul className="list-disc pl-6 mt-2 space-y-2">
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400 mt-3">TIP: Some brokers, like Interactive Brokers, may not charge assignment fees. Do your homework.</p>
    ...
    <InfoCard icon={<Landmark />} title="Margin Requirements" className="border-[#A8672E] dark:border-[#D08F52]/50">
      ...
      <ul className="list-decimal pl-6 my-4 space-y-1 bg-gray-200 dark:bg-gray-900/50 p-4 rounded-lg">
        ...
        <li><strong className="text-gray-900 dark:text-white">Plus the premium collected</strong></li>
        <li><strong className="text-gray-900 dark:text-white">Minus the amount the put is out-of-the-money</strong></li>
      </ul>
      <div className="bg-gray-200 dark:bg-gray-700/50 p-4 rounded-lg mt-4">
...
const GettingStartedPage = () => (
  <div className="space-y-8">
    ...
    <InfoCard icon={<TrendingUp />} title="Step 2: The Thought Process">
      <p className="text-gray-500 dark:text-gray-400 mb-4">The book provides examples of different mindsets for the same scenario to illustrate how to think through a trade.</p>
      <div className="text-center mb-6 p-3 bg-gray-200 dark:bg-gray-700/60 rounded-lg border border-gray-300 dark:border-gray-600">
        <p className="font-semibold text-gray-900 dark:text-white">Example Scenario:</p>
        <p className="text-gray-700 dark:text-gray-300">Stock UVW is trading @ $41. The August $40 put can be sold for $1.00.</p>
      </div>
    ...
    <InfoCard icon={<Lightbulb />} title="Trader-Specific Tips" className="border-yellow-500/50">
      <p className="font-semibold text-gray-900 dark:text-white">Traders have different objectives than long-term investors. Keep these points in mind:</p>
      <ul className="list-disc pl-6 mt-4 space-y-3">
        <li><strong className="text-yellow-700 dark:text-yellow-300">Avoid Very Low-Priced Options:</strong> Don&apos;t sell puts for just $0.05 or $0.10. The tiny potential reward doesn&apos;t justify the capital risk you are taking on.</li>
        <li><strong className="text-yellow-700 dark:text-yellow-300">Be Wary of Weeklys:</strong> Very short-term options (like weeklys) offer small premiums. A minor decline in the stock price can cause a large percentage loss on your position. They require more active management.</li>
        <li><strong className="text-yellow-700 dark:text-yellow-300">Choose Expiration Wisely:</strong> Most traders focus on options expiring in the front two months to benefit from faster time decay. Longer-dated options are generally for investors seeking more premium.</li>
      </ul>
    </InfoCard>
    ...
    <InfoCard icon={<ChevronsRight />} title="Step 3: At Expiration Day">
      ...
      <div className="mt-6 border-t border-gray-200 dark:border-gray-700 pt-6">
        <h4 className="font-semibold text-xl text-yellow-700 dark:text-yellow-300 mb-2">If Puts are In-the-Money (ITM)</h4>
        ...
        <div className="mt-4 p-4 bg-yellow-100 dark:bg-yellow-900/40 rounded-lg border-l-4 border-yellow-400">
          <p><strong className="text-yellow-700 dark:text-yellow-300">TIP:</strong> Never roll a position just to be active. Only roll if the new trade is attractive on its own and its profit potential is satisfactory. If not, it&apos;s better to cover or take the assignment.</p>
        </div>
      </div>
    </InfoCard>
  </div>
...
export default function WritingNakedPutsGuide() {
  ...
  const menuItems = [
    ...
    { id: 'strategy', label: 'The Strategy', icon: <TrendingUp className="w-4 h-4" /> },
    { id: 'risk', label: 'Risk & Management', icon: <Shield className="w-4 h-4" /> },
    { id: 'gettingStarted', label: 'Getting Started', icon: <PlayCircle className="w-4 h-4" /> },
  ];

  return (
    <ArticleFrame
      slug="writing-naked-puts-complete-interactive-guide"
      additionalDisclaimer="All investment strategies, including writing naked puts, involve risk of loss."
    >
      ...
      <PageContent page={page} navigateTo={setPage} />
    </ArticleFrame>
  );
}
