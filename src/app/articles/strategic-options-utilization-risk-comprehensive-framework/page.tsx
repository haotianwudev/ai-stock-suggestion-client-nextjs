...
export default function StrategicOptionsUtilizationRisk() {
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-24 text-gray-800">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              <div className="md:w-1/3">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-red-100">
                  <h4 className="font-bold text-red-700 mb-2 text-lg">Case Study: &ldquo;Steamroller&rdquo;</h4>
