...
import { TrendingDown, Activity, AlertTriangle, ShieldAlert, BarChart3, BookOpen, Globe, DollarSign, Percent, Info } from 'lucide-react';
    ...
    >
      <div className="space-y-12">
        ...
        <SectionCard icon={TrendingDown} title="2. Statistical Return Modeling and Alpha Decay" color="blue">
          ...
          <MathBlock math="R_{\text{BABA\_adj}, t} = \alpha + \beta \times R_{\text{KWEB}, t} + \epsilon_t" />
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse mt-4">
              ...
              <tbody className="text-slate-600 divide-y divide-slate-100">
                <tr>
                  <td className="p-4 font-semibold">Beta (<InlineMath math="\beta" />)</td>
                  <td className="p-4">0.8281</td>
                  <td className="p-4">p = 0.0098</td>
                </tr>
                <tr>
                  <td className="p-4 font-semibold">Alpha (<InlineMath math="\alpha" />)</td>
                  <td className="p-4 text-red-500 font-bold">-0.0073 (-73 bps)</td>
                  <td className="p-4">p = 0.1710</td>
                </tr>
                <tr>
                  <td className="p-4 font-semibold">R-squared (<InlineMath math="R^2" />)</td>
