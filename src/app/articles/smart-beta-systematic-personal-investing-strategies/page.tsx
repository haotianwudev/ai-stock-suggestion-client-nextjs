  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4 text-gray-800">
        ...
        <section id="deconstructing" className="mb-16 mt-12">
              ...
              <div>
                ...
                <div className="mt-4 p-4 bg-blue-50 border-l-4 border-blue-400 rounded">
                  <p className="text-blue-800 text-sm">
                    <strong>Key Insight:</strong> The central premise of smart beta is to &ldquo;break the link with price.&rdquo; Instead of allowing a security&apos;s market price to dictate its weight in a portfolio, smart beta strategies utilize alternative metrics such as company fundamentals, risk characteristics, or equal weighting.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-4 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded">
                  <p className="text-yellow-800 text-sm">
                    <strong>Marketing Caveat:</strong> The term &ldquo;smart beta&rdquo; can be misleading, as it shifts the burden of the active decision from a fund manager to the end investor, who must now select which factor bet to make.
                  </p>
                </div>
              </div>
        ...
        <section id="systematic" className="mb-16">
          <div className="bg-white p-8 rounded-lg shadow-md">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-2 border-indigo-500 pb-2">
              ...
              <div>
                ...
                <div className="mt-4 p-4 bg-red-50 border-l-4 border-red-400 rounded">
                  <p className="text-red-800 text-sm">
                    <strong>Factor Clash Warning:</strong> A &lsquo;cheap&rsquo; value stock with poor quality metrics exemplifies how factors can conflict, requiring sophisticated optimization techniques.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <p className="text-sm text-green-700">Market-cap core with factor &lsquo;tilts&rsquo; for targeted exposure</p>
                  </div>
                  <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
              ...
              <div>
                ...
                <div className="p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded">
                  <p className="text-yellow-800 text-sm mb-2">
                    <strong>Greatest Risk:</strong> Behavioral error&mdash;chasing performance and selling after underperformance.
                  </p>
                  <p className="text-yellow-700 text-sm">
                    Research shows a significant &lsquo;investor returns gap&rsquo; caused by poor timing. Discipline and a long-term perspective (5-10+ years) are critical for success.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="performance-risks" className="mb-16">
          <div className="bg-white p-8 rounded-lg shadow-md">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-2 border-indigo-500 pb-2">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="mt-4 p-4 bg-red-50 border-l-4 border-red-400 rounded">
                  <p className="text-red-800 text-sm">
                    <strong>Reality Check:</strong> The gap between backtest and live performance highlights the risk that launching products can contribute to factor premium decay through &lsquo;factor crowding&rsquo; and increased implementation costs.
                  </p>
                </div>
              </div>
        ...
        <section id="regimes" className="mb-16">
          <div className="bg-white p-8 rounded-lg shadow-md">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-2 border-indigo-500 pb-2">
