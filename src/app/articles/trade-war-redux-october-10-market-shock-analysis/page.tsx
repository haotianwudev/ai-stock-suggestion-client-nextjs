...
import { TrendingDown, TrendingUp, Shield, BarChart, BookOpen, Anchor, Zap, Scale, ChevronsRight, Target, BrainCircuit, Sprout, AlertTriangle } from 'lucide-react';
...
export default function TradeWarReduxAnalysis() {
  return (
    <ArticleFrame
      ...
      additionalDisclaimer="Geopolitical events can have unpredictable impacts on financial markets. Past performance does not guarantee future results."
    >
        ...
        <section className="mb-16">
          ...
          <div className="text-center p-8 bg-gray-100/70 rounded-xl border border-gray-200 max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              launching antitrust probes against firms like Qualcomm&mdash;are surgical strikes designed to create targeted pain
