...
const StatCard = ({ icon, title, value, description, source }: {
  ...
  <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm transform hover:scale-105 transition-transform duration-300">
    ...
    <h3 className="text-2xl font-bold text-center text-green-600 dark:text-green-400">{value}</h3>
  ...
  return (
    ...
    >
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">The Shocking Numbers</h2>
      ...
      <section className="mb-16 p-8 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700">
        <h2 className="text-3xl font-bold text-center mb-4 text-gray-900 dark:text-white">The Skewed Reality of Returns</h2>
        ...
        <div className="flex justify-between mt-2 text-sm text-gray-600 dark:text-gray-400 px-4">
          ...
          <span className="text-green-600 dark:text-green-400 font-bold">Few Big Winners</span>
        </div>
      </section>

      {/* Anatomy of a Wipeout Section */}
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">Anatomy of a Wipeout: The Path to Zero</h2>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">Profile of Peril: Key Risk Factors</h2>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">IPO Survival Rates: Size Matters</h2>
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <td className="p-4 text-red-600 dark:text-red-400 font-bold">55%</td>
              ...
              <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <td className="p-4 text-orange-600 dark:text-orange-400 font-bold">61%</td>
              ...
              <tr>
                ...
                <td className="p-4 text-green-600 dark:text-green-400 font-bold">67%</td>
                <td className="p-4 text-gray-700 dark:text-gray-300">Takeover Transaction</td>
              </tr>
            </tbody>
          </table>
      ...
      <section className="bg-gradient-to-br from-blue-50 to-teal-50 dark:from-blue-900/20 dark:to-teal-900/20 p-8 md:p-12 rounded-2xl border border-gray-200 dark:border-gray-700">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">The Only Free Lunch: Diversification</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center">
          <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-xl border border-red-200 dark:border-red-800">
            <h3 className="text-xl font-bold mb-4 flex items-center justify-center gap-2 text-gray-900 dark:text-white"><AlertTriangle className="w-6 h-6 text-red-500"/>Individual Stock</h3>
            ...
            <p className="font-bold text-2xl mt-4 text-red-600 dark:text-red-400">High probability of 100% loss.</p>
          </div>
          <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-xl border border-green-200 dark:border-green-800">
            <h3 className="text-xl font-bold mb-4 flex items-center justify-center gap-2 text-gray-900 dark:text-white"><CheckCircle className="w-6 h-6 text-green-500"/>Diversified Index Fund (ETF)</h3>
            ...
            <p className="font-bold text-2xl mt-4 text-green-600 dark:text-green-400">Virtually zero probability of 100% loss.</p>
          </div>
        </div>
      </section>
    </ArticleFrame>
