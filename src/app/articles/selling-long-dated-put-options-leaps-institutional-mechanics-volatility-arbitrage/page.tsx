...
import { ArrowLeft, TrendingDown, TrendingUp, DollarSign, Activity, AlertTriangle, ShieldAlert, BookOpen, Target, Clock, Briefcase, ChevronDown, ChevronUp, Scale, Music } from 'lucide-react';
...
export default function LeapStrategyDoc() {
  const [openSection, setOpenSection] = useState('greek-profile');
  const currentArticle = articles.find(article => article.slug === 'selling-long-dated-put-options-leaps-institutional-mechanics-volatility-arbitrage');
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-50 font-sans text-slate-600 selection:bg-indigo-100 selection:text-indigo-900 pb-20">
        ...
        {/* Hero Section */}
        <div className="bg-white border-b border-slate-200 pt-16 pb-12 md:pt-24 md:pb-16 px-4 md:px-8">
          <div className="max-w-5xl mx-auto text-center space-y-6">
            <Badge color="slate">Institutional Derivatives Research</Badge>
            <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 tracking-tight leading-tight">
              Selling <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-violet-600">Long-Dated Put Options</span>
            </h1>
        ...
        <section className="max-w-5xl mx-auto px-6 pt-12 pb-8">
          <div className="rounded-2xl overflow-hidden shadow-2xl border border-slate-200">
            <img 
              src="https://i.imgur.com/nBdrqD7.jpeg" 
              alt="LEAP Put Options Strategy Infographic" 
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 -mt-8">
              ...
              <Card className="p-6 md:p-10">
                <div className="flex flex-col md:flex-row gap-8 items-start">
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-slate-800 mb-4">The "Why": Defining the Strategy</h3>
                    <p className="mb-4 text-lg leading-relaxed">
                      Selling a LEAP put (1+ year to expiration) is fundamentally different from selling a 30-day put. While short-term options are "Theta" (time) plays, LEAP puts are dominated by <strong>Delta</strong> (long-term price direction) and <strong>Vega</strong> (volatility levels).
                    </p>
                    ...
                    <ul className="space-y-4">
                      <li className="flex gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-sm text-slate-600">"Buffett-Style" Synthetic Limit Order. Goal is assignment at a discount.</span>
                        </div>
                      </li>
                      <li className="flex gap-3">
                        <div className="mt-1">
                        ...
                        <div>
                          ...
                          <span className="text-sm text-slate-600">"Short Vega" Play. Goal is mean reversion of high Implied Volatility (IV).</span>
                        </div>
                      </li>
                    </ul>
                  </div>
                    ...
                    <table className="w-full text-left text-sm md:text-base">
                      ...
                      <tbody className="divide-y divide-slate-100">
                        ...
                        <tr>
                          ...
                          <td className="p-4 text-slate-600">LEAPs are terrible for "daily income." You are not paid to wait; you are paid for risk.</td>
                        </tr>
                        <tr>
                          ...
                          <td className="p-4 text-slate-600">LEAPs are stable. Short-term puts have "Gamma Risk" (rapid losses during crash).</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
          ...
          <section className="mb-20">
            ...
            <div className="grid gap-6">
              ...
              <Card className="p-6 md:p-8 bg-slate-50 border-none">
                ...
                <p className="mb-4">
                  Who buys deep ITM LEAP puts? Often, it is <strong>Dividend Arbitrageurs</strong>. They perform a "Conversion" or "Box Spread" strategy.
                </p>
            ...
            <div className="space-y-8">
              ...
              <Card className="overflow-hidden">
                ...
                <div className="p-4 bg-slate-50 text-sm text-slate-600 italic border-t border-slate-200">
                  *Analysis: A round-trip trade (sell to open, buy to close) on VST would cost <strong>26% of your profit</strong> just in spreads. This makes "rolling" impossible.
                </div>
              </Card>
                ...
                <div className="grid gap-4">
                  <div className="flex flex-col md:flex-row items-center justify-between p-4 bg-emerald-50 rounded-xl border border-emerald-100 transition-transform hover:scale-[1.01]">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <span className="font-bold text-emerald-900 block">The "Win" Scenario</span>
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between p-4 bg-rose-50 rounded-xl border border-rose-100 transition-transform hover:scale-[1.01]">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <span className="font-bold text-rose-900 block">The "Trap" Scenario</span>
              ...
              <Card className="p-6 bg-slate-50 border-dashed border-2 border-slate-300">
                <h3 className="text-lg font-bold text-slate-700 mb-4">Trap 3: Capital Inefficiency ("Dead Money")</h3>
          ...
          <section className="mb-24">
            ...
            <div className="grid lg:grid-cols-3 gap-6 mb-8">
              ...
              <Card className="p-6 border-t-4 border-t-amber-500 hover:-translate-y-1 transition-transform duration-300">
                ...
                <ul className="text-sm text-slate-600 space-y-2 list-disc list-inside">
                  ...
                  <li><strong>Risk:</strong> The "Time Bomb" (IV expansion).</li>
            ...
            <Card className="p-8 bg-slate-900 text-slate-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">The "No-Exit" Rule</h3>
          ...
          <div className="bg-amber-50 border-l-4 border-amber-400 p-6 rounded-lg my-8">
            <div className="flex items-start gap-3">
              <AlertTriangle className="w-6 h-6 text-amber-600 flex-shrink-0 mt-1" />
              <div>
                <h4 className="font-bold text-amber-900 mb-2">Educational Disclaimer</h4>
                <p className="text-sm text-amber-800 leading-relaxed">
                  This article is for educational and informational purposes only. Options trading involves substantial risk and is not suitable for all investors. 
                  The strategies discussed require significant capital, risk tolerance, and understanding of derivatives. Past performance does not guarantee future results. 
                  Always consult with a qualified financial advisor before implementing any options strategy. The author and publisher are not responsible for any losses 
                  incurred from the use of this information.
                </p>
              </div>
            </div>
          </div>
