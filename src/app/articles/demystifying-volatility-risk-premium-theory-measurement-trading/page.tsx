    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="p-8 rounded-3xl bg-white border border-slate-100 shadow-xl shadow-slate-200/40">
          ...
          <h3 className="text-2xl font-bold text-slate-900 mb-3">High Sharpe Ratio</h3>
          <p className="text-slate-600 leading-relaxed">
        ...
        <div className="p-8 rounded-3xl bg-white border border-slate-100 shadow-xl shadow-slate-200/40">
          ...
          <h3 className="text-2xl font-bold text-slate-900 mb-3">Skew & Correlation Risk</h3>
          <p className="text-slate-600 leading-relaxed">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-8">
        ...
        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-sm">
          ...
          <div className="bg-slate-100 p-6 rounded-2xl border border-slate-200 font-mono text-lg text-center md:text-left flex flex-col md:flex-row items-center justify-around">
          ...
          <div className="mt-6">
            <h4 className="font-bold text-slate-900 mb-2">Detailed Realized Volatility (RV) Calculation</h4>
            <p className="text-sm text-slate-600">RV<sub>t, t+N</sub> is the annualized standard deviation of daily log returns (r<sub>i</sub>) of the underlying index over the next N trading days.</p>
            <div className="bg-slate-900 px-6 py-4 rounded-lg text-white text-center overflow-x-auto mt-2">
              <div className="inline-block text-base md:text-lg">
                RV = √[<span className="text-emerald-400">(252/N)</span> × Σ<sub className="text-xs">i=1</sub><sup className="text-xs">N</sup> (ln(S<sub className="text-xs">i</sub>/S<sub className="text-xs">i-1</sub>))<sup className="text-xs">2</sup>] × 100
              </div>
            </div>
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
          <h3 className="text-2xl font-bold text-slate-900 mb-6">2. The Academic Variance Risk Premium (VRPₚ)</h3>
          <p className="text-slate-600 mb-6">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-white rounded-3xl p-8 md:p-12 border border-slate-100 shadow-sm mb-16">
        <h3 className="text-3xl font-bold text-slate-900 mb-4 flex items-center">
          <DollarSign className="w-7 h-7 mr-3 text-emerald-600" /> Deep Dive: Systematic Put-Writing
        </h3>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-bold text-slate-900 mb-2">Key Exposure (Greeks)</h4>
            <ul className="text-slate-600 space-y-1 text-sm">
              <li className="flex items-center">
                <Activity className="w-4 h-4 mr-2 text-indigo-500" /> <strong>Short Vega:</strong> Profits when volatility falls (the definition of VRP).
              </li>
              <li className="flex items-center">
                <Activity className="w-4 h-4 mr-2 text-indigo-500" /> <strong>Short Gamma:</strong> The position becomes <em>more</em> negative delta as the market falls, forcing you to sell low (the source of negative skew).
              </li>
              <li className="flex items-center">
                <Activity className="w-4 h-4 mr-2 text-indigo-500" /> <strong>Long Theta:</strong> Time decay (theta) works in your favor as you collect daily premium.
              </li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-slate-900 mb-2">Performance & Risk Profile</h4>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-rose-100">
            ...
            <div className="h-48 flex items-end justify-center gap-2">
              ...
              <div className="w-1/5 h-1/4 bg-blue-400 rounded-t-lg" style={{height: '43%'}} title="Feb 2: 17.31"></div>
              <div className="w-1/5 h-1/4 bg-rose-600 rounded-t-lg" style={{height: '93%'}} title="Feb 5: 37.32 (Spike)"></div>
              <div className="w-1/5 h-1/4 bg-blue-500 rounded-t-lg" style={{height: '75%'}} title="Feb 6: 29.98"></div>
              <div className="w-1/5 h-1/4 bg-blue-400 rounded-t-lg" style={{height: '73%'}} title="Feb 9: 29.06"></div>
            </div>
      ...
      <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
        ...
        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600 text-sm">The definitive paper establishing standard methods for measuring VRP using synthetic variance swaps. Found <strong>VRP is strongly negative</strong> (investors pay to hedge variance) and surprisingly <strong>predicts future equity returns</strong>.</p>
          </div>
        </div>
        ...
        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600 text-sm"><strong>Key Finding:</strong> Linked VRP to macroeconomic uncertainty. Showed that a <strong>high VRP spread</strong> is one of the best short-term predictors of <strong>higher aggregate stock market returns</strong> (compensation for the heightened risk).</p>
          </div>
        </div>
      </div>

      <div className="mt-24 bg-slate-900 rounded-3xl p-10 text-slate-300">
        <h3 className="text-white text-2xl font-bold mb-6">Are VRPs Always Positive?</h3>
        <p className="mb-4">The short answer is <strong>No, but overwhelmingly Yes</strong> over long periods.</p>
        <ul className="space-y-4">
          <li className="flex items-start">
            <AlertTriangle className="w-5 h-5 mr-3 text-rose-400 shrink-0 mt-1" />
          ...
          <li className="flex items-start">
            <Brain className="w-5 h-5 mr-3 text-emerald-400 shrink-0 mt-1" />
