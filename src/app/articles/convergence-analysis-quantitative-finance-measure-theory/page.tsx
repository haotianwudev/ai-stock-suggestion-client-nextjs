...
const MathBlock = ({ children }: { children: React.ReactNode }) => (
  <div className="my-6 p-4 bg-slate-50 dark:bg-[#14171B] border border-slate-200 dark:border-white/10 rounded-lg font-mono text-sm md:text-base text-slate-700 dark:text-slate-300 overflow-x-auto shadow-inner flex justify-center">
    {children}
  </div>
);
...
const ConceptCard = ({ title, content, badge }: {
  ...
  <div className="bg-white dark:bg-[#14171B] p-6 rounded-xl shadow-md dark:shadow-none border border-slate-100 dark:border-white/10 hover:shadow-lg dark:hover:shadow-none transition-all duration-300">
    <div className="flex justify-between items-start mb-4">
      <h3 className="text-xl font-bold text-slate-800 dark:text-white font-serif">{title}</h3>
      {badge && <span className="px-2 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-xs font-bold uppercase rounded">{badge}</span>}
    </div>
    ...
    <ArticleFrame slug="convergence-analysis-quantitative-finance-measure-theory">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-serif font-bold mb-6 text-slate-800 dark:text-white">The Analytic Bedrock</h2>
              ...
              <div className="bg-gradient-to-br from-slate-100 dark:from-[#14171B] to-white dark:to-black/40 p-8 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex gap-3 text-slate-700 dark:text-slate-300">
                    ...
                    <span><strong>Stability:</strong> Numerical schemes rely on <span className="font-mono text-sm bg-slate-100 dark:bg-slate-800 px-1 rounded">L²</span> convergence.</span>
                  </li>
                  <li className="flex gap-3 text-slate-700 dark:text-slate-300">
          ...
          <section>
            ...
            <div className="mb-12 bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-xl border border-indigo-100 dark:border-indigo-900/30">
              ...
              <div className="bg-white dark:bg-black/40 p-4 rounded-lg border border-indigo-200 dark:border-indigo-900/30">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white dark:bg-[#14171B] p-6 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-3">L¹ Space: Integrable Functions</h4>
              ...
              <div className="bg-white dark:bg-[#14171B] p-6 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-3">L² Space: Square-Integrable Functions</h4>
            ...
            <Callout title="Financial Intuition: Orthogonality" type="finance">
              ...
              <div className="mt-3 p-3 bg-white dark:bg-[#14171B] rounded border border-indigo-200 dark:border-indigo-900/30">
                <p className="text-sm font-mono text-slate-600 dark:text-slate-400">E[V(t+1) | S(t)] ≈ Σᵢ βᵢ φᵢ(S(t))</p>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">where φᵢ are orthogonal basis functions</p>
              </div>
            </Callout>

            <div className="mt-8 bg-slate-50 dark:bg-[#14171B] p-6 rounded-xl border border-slate-200 dark:border-white/10">
              <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-3">The Riesz Representation Theorem</h4>
              <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-black/40 p-4 rounded border border-slate-200 dark:border-white/10">
                  <h5 className="font-bold text-slate-700 dark:text-white mb-2">Conditional Expectation</h5>
                  <p className="text-sm text-slate-600 dark:text-slate-400">The best L² predictor is the orthogonal projection onto the conditioning σ-algebra.</p>
                </div>
                <div className="bg-white dark:bg-black/40 p-4 rounded border border-slate-200 dark:border-white/10">
                  <h5 className="font-bold text-slate-700 dark:text-white mb-2">Radon-Nikodym Derivative</h5>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Change of measure (risk-neutral pricing) is represented as a density in L¹.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-white dark:bg-[#14171B] rounded-2xl shadow-sm dark:shadow-none border border-slate-200 dark:border-white/10 overflow-hidden mb-12">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-50 dark:bg-slate-900/40 border-b border-slate-200 dark:border-white/10 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-white/10">
                    <tr>
                      <td className="p-4 font-bold text-purple-700 dark:text-purple-400">Uniform (L∞)</td>
                      <td className="p-4 font-mono text-slate-600 dark:text-slate-400">sup |fₙ - f| &rarr; 0</td>
                      <td className="p-4 text-sm text-slate-600 dark:text-slate-400">Strongest. Preserves continuity. Crucial for stability of exercise boundaries in American options.</td>
                    ...
                    <tr>
                      <td className="p-4 font-bold text-slate-700 dark:text-slate-300">Pointwise</td>
                      <td className="p-4 font-mono text-slate-600 dark:text-slate-400">fₙ(x) &rarr; f(x) for all x</td>
                      <td className="p-4 text-sm text-slate-600 dark:text-slate-400">Weak. Does NOT guarantee integrals converge. Fails in presence of &quot;spikes&quot;.</td>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-xl border border-orange-100 dark:border-orange-900/30">
                ...
                <p className="text-sm text-orange-900 dark:text-orange-300 mb-4">
          ...
          <section>
            ...
            <div className="mb-12 bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-xl border border-emerald-100 dark:border-emerald-900/30">
              ...
              <div className="bg-white dark:bg-black/40 p-4 rounded-lg border border-emerald-200 dark:border-emerald-900/30">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">Continuous SDE &rarr; Discrete approximation with time step Δt</p>
              </div>
            </div>

            <div className="grid md:grid-cols-2 gap-12 mb-8">
              <div>
                <h3 className="text-xl font-serif font-bold text-slate-800 dark:text-white mb-4">Strong Convergence (Pathwise)</h3>
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-slate-800 dark:text-white mb-4">Weak Convergence (Distributional)</h3>
              ...
              <div className="space-y-6">
                <div className="flex flex-col md:flex-row gap-4 items-start">
                  <div className="bg-white dark:bg-[#14171B] p-4 rounded-lg shadow-sm dark:shadow-none flex-1 border border-emerald-100 dark:border-emerald-900/30">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-2 border-t pt-2 border-slate-100 dark:border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white dark:bg-[#14171B] p-6 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-3">The Itô-Taylor Expansion</h4>
                ...
                <div className="bg-slate-50 dark:bg-slate-900/40 p-3 rounded border border-slate-200 dark:border-white/10">
                  <p className="font-mono text-xs text-slate-600 dark:text-slate-400">
              ...
              <div className="bg-white dark:bg-[#14171B] p-6 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-3">Computational Trade-offs</h4>
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">
                  Higher-order schemes require more computation per step but allow larger time steps for the same accuracy.
                </p>
                <div className="space-y-2 text-xs">
                  <div className="flex justify-between p-2 bg-slate-50 dark:bg-slate-900/40 rounded">
          ...
          <section>
            ...
            <div className="mb-12 bg-cyan-50 dark:bg-cyan-900/20 p-6 rounded-xl border border-cyan-100 dark:border-cyan-900/30">
              ...
              <div className="bg-white dark:bg-black/40 p-4 rounded-lg border border-cyan-200 dark:border-cyan-900/30">
            ...
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1">
                  ...
                  <Callout title="The Fix" type="info">
                    ...
                    <div className="mt-3 bg-white dark:bg-[#14171B] p-3 rounded border border-blue-200 dark:border-blue-900/30">
                      <p className="font-mono text-sm text-slate-600 dark:text-slate-400">
                        c̃(k) = e^(αk) C(k) ∈ L¹
                      </p>
                ...
                <div className="flex-1">
                  ...
                  <Callout title="The Fix" type="warning">
                    ...
                    <div className="mt-3 bg-white dark:bg-[#14171B] p-3 rounded border border-orange-200 dark:border-orange-900/30">
                      <p className="text-sm text-slate-600 dark:text-slate-400">
              ...
              <div className="bg-white dark:bg-[#14171B] p-6 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-4">The COS Method: Cosine Expansion</h4>
                <p className="text-slate-600 dark:text-slate-400 mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-cyan-50 dark:bg-cyan-900/20 p-4 rounded border border-cyan-100 dark:border-cyan-900/30">
                    <h5 className="font-bold text-cyan-800 dark:text-cyan-400 mb-2 text-sm">Advantages</h5>
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900/40 p-4 rounded border border-slate-200 dark:border-white/10">
                    <h5 className="font-bold text-slate-700 dark:text-white mb-2 text-sm">Convergence Rate</h5>
                    <p className="font-mono text-xs text-slate-600 dark:text-slate-400 mb-2">
                      Error ~ O(e^(-cN))
                    </p>
                    <p className="text-xs text-slate-500 dark:text-slate-400">
              ...
              <div className="bg-gradient-to-r from-cyan-50 dark:from-cyan-900/20 to-blue-50 dark:to-blue-900/20 p-6 rounded-xl border border-cyan-100 dark:border-cyan-900/30">
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-4">Practical Implementation: The Lewis Formula</h4>
                <p className="text-slate-600 dark:text-slate-400 mb-4">
                ...
                <div className="bg-white dark:bg-black/40 p-4 rounded border border-slate-200 dark:border-white/10">
                  <p className="font-mono text-sm text-slate-600 dark:text-slate-400 mb-3">
          ...
          <section>
            ...
            <div className="mb-12 bg-rose-50 dark:bg-rose-900/20 p-6 rounded-xl border border-rose-100 dark:border-rose-900/30">
              ...
              <div className="bg-white dark:bg-black/40 p-4 rounded-lg border border-rose-200 dark:border-rose-900/30">
            ...
            <div className="bg-slate-50 dark:bg-[#14171B] p-6 rounded-xl border border-slate-200 dark:border-white/10 mb-8">
              <h4 className="font-bold text-slate-800 dark:text-white mb-3">Lasso (L¹) vs Ridge (L²) in Factor Models</h4>
              <p className="text-slate-600 dark:text-slate-400 mb-4">When selecting factors to explain returns:</p>
              <div className="flex flex-col sm:flex-row gap-4 mb-4">
                <div className="flex-1 bg-white dark:bg-black/40 p-4 border border-slate-200 dark:border-white/10 rounded">
                  <div className="font-mono text-xs text-slate-400 dark:text-slate-500 mb-1">Ridge Regression</div>
                  <div className="font-bold text-slate-700 dark:text-white mb-2">L² Norm Penalty</div>
                  <div className="bg-slate-50 dark:bg-slate-900/40 p-2 rounded mb-2">
                    <p className="font-mono text-xs text-slate-600 dark:text-slate-400">
                      min ||y - Xβ||² + λ||β||²
                    </p>
                  </div>
              ...
              <div className="bg-white dark:bg-black/40 p-4 rounded border border-slate-200 dark:border-white/10">
                <h5 className="font-bold text-slate-700 dark:text-white mb-2 text-sm">Why L¹ Induces Sparsity</h5>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white dark:bg-[#14171B] p-6 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-3">Robust Optimization</h4>
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">
              ...
              <div className="bg-white dark:bg-[#14171B] p-6 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-3">Convex Duality</h4>
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">
              ...
              <table className="w-full text-left bg-white dark:bg-[#14171B]">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-white/10 text-sm md:text-base">
                  ...
                  <tr className="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                    ...
                    <td className="p-4 text-slate-600 dark:text-slate-400">Coherent Tail Risk Measure</td>
                  </tr>
                </tbody>
              </table>
            </div>
