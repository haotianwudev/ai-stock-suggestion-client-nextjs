...
import { TrendingUp, Shield, Calculator, Target, AlertTriangle, CheckCircle, XCircle, HelpCircle, Calendar, Activity, Zap } from 'lucide-react';
...
export default function VerticalCreditSpreadsGuide() {
  return (
    <ArticleFrame
      ...
      additionalDisclaimer="Options trading involves substantial risk and is not suitable for all investors. Past performance does not guarantee future results."
    >
      <div className="max-w-4xl mx-auto px-4 text-gray-900 space-y-8">
        ...
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="mb-6">
            <p className="text-gray-700 leading-relaxed">
              The &lsquo;Greeks&rsquo; are variables that measure an option position&apos;s sensitivity to different market factors. For a credit spread seller, they are your dashboard indicators, telling you how your position is behaving and what risks you face.
            </p>
          </div>
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="bg-yellow-100 border border-yellow-300 rounded p-4">
                  ...
                  <p className="text-yellow-800 text-sm">The &lsquo;sweet spot&rsquo; - good balance of premium and probability.</p>
                </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="bg-blue-100 border border-blue-300 rounded p-4">
                <p className="text-blue-900 text-sm">
                  <strong>Primary Rule:</strong> Always roll for a net credit. This pays you to extend the trade duration. You can roll &lsquo;out&rsquo; to a later date, or &lsquo;out and down/up&rsquo; to different strikes.
                </p>
              </div>
            </div>
