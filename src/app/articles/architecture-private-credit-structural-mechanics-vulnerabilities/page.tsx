...
export default function PrivateCreditArchitecture() {
  return (
    ...
    >
      <div className="max-w-5xl mx-auto space-y-24 py-16 px-6 md:px-12 bg-transparent text-slate-900 dark:text-white dark:text-slate-300">
        <div className="-mb-8">
            ...
            <div className="space-y-8">
              <TutorialCard accentColor="bg-[#1D8A70] dark:bg-[#3CBF9C]">
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-8 mb-2">
                  <div className="bg-slate-50 dark:bg-slate-900/40 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-inner">
                    <h4 className="font-bold text-slate-800 dark:text-white text-xl mb-3 border-b pb-2">Traditional Banks</h4>
                ...
                <div className="bg-white dark:bg-[#14171B] p-8 rounded-2xl shadow-xl dark:shadow-none border border-slate-100 dark:border-white/10">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border-l-4 border-amber-500 bg-slate-50 dark:bg-slate-900/20 p-3 rounded-r-lg">
                      <strong className="text-slate-800 dark:text-white block text-sm">Mezzanine / Subordinated</strong>
                      <p className="text-slate-600 dark:text-slate-400 text-xs">Unsecured, higher risk. Sits below senior debt but above equity. Often includes equity warrants. Yields ~12-18%.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <TutorialCard accentColor="bg-[#1D8A70] dark:bg-[#3CBF9C]">
                ...
                <ul className="grid md:grid-cols-3 gap-4 mb-8">
                  <li className="bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 p-5 rounded-xl shadow-sm hover:shadow-md transition">
                    <strong className="text-slate-800 dark:text-white block mb-2">Certainty of Execution</strong>
                    <span className="text-sm text-slate-600 dark:text-slate-400">Eliminates "flex risk". The price agreed upon in a private boardroom is final, unlike syndicated loans which fluctuate with public market appetite.</span>
                  </li>
                  <li className="bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 p-5 rounded-xl shadow-sm hover:shadow-md transition">
                    <strong className="text-slate-800 dark:text-white block mb-2">Bespoke Customization</strong>
                    <span className="text-sm text-slate-600 dark:text-slate-400">Complex, highly customized payment structures (like delayed draw term loans) that traditional banks cannot operationalize.</span>
                  </li>
                  <li className="bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 p-5 rounded-xl shadow-sm hover:shadow-md transition">
                    <strong className="text-slate-800 dark:text-white block mb-2">Speed & Absolute Privacy</strong>
                    <span className="text-sm text-slate-600 dark:text-slate-400">Bypasses public rating agencies (S&P, Moody's) and arduous roadshows, keeping corporate financial data entirely hidden from competitors.</span>
                  </li>
                </ul>
                <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-900/30 p-5 rounded-xl">
                  <h5 className="font-bold text-amber-900 dark:text-amber-400 mb-2">The Rise of "Cov-Lite"</h5>
            ...
            <TutorialCard accentColor="bg-purple-500">
              ...
              <div className="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                <table className="w-full text-left text-sm text-slate-600 dark:text-slate-400">
                  <thead className="bg-slate-100 text-slate-800 dark:text-white uppercase text-xs font-bold">
                    <tr>
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-[#14171B] p-8 rounded-2xl shadow-xl dark:shadow-none border border-slate-800 border-t-4 border-[#A8672E] dark:border-[#D08F52] flex flex-col h-full">
                  ...
                  <div className="mt-auto bg-slate-50 dark:bg-slate-900/20 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
                    <strong className="text-slate-800 dark:text-white block text-sm mb-2">High-Profile Partnerships:</strong>
                ...
                <div className="bg-gradient-to-br from-indigo-900 to-blue-900 dark:from-[#14171B] dark:to-indigo-900/10 p-8 rounded-2xl shadow-xl border border-indigo-800 md:col-span-2 text-white relative overflow-hidden">
          ...
          <section>
            <SectionHeading 
              ...
              colorClass="bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 dark:text-amber-400"
            />
            <div className="space-y-8">
              <TutorialCard accentColor="bg-amber-500">
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-8">
                  <div className="border border-slate-200 dark:border-white/10 rounded-xl p-5 hover:shadow-md transition bg-white dark:bg-[#14171B]">
                    <h4 className="font-bold text-slate-800 dark:text-white mb-2 text-lg">Public BDCs</h4>
                  ...
                  <div className="border-2 border-amber-300 dark:border-amber-900/30 rounded-xl p-5 hover:shadow-md transition bg-amber-50/50 dark:bg-[#14171B] relative">
                    <div className="absolute -top-3 right-4 bg-amber-500 text-white text-xs font-bold px-2 py-1 rounded">Dominant Vehicle</div>
                    <h4 className="font-bold text-slate-800 dark:text-white mb-2 text-lg">Non-Traded (Perpetual) BDCs</h4>
                    <p className="text-sm text-slate-600 dark:text-slate-400">
                  ...
                  <div className="border border-slate-200 dark:border-white/10 rounded-xl p-5 hover:shadow-md transition bg-white dark:bg-[#14171B]">
                    <h4 className="font-bold text-slate-800 dark:text-white mb-2 text-lg">Interval Funds</h4>
                    <p className="text-sm text-slate-600 dark:text-slate-400">
                ...
                <div className="bg-white dark:bg-[#14171B] p-8 rounded-2xl shadow-xl dark:shadow-none border border-slate-100 dark:border-white/10">
                  ...
                  <ul className="space-y-4">
                    <li className="flex gap-3 text-sm text-slate-600 dark:text-slate-400">
                      <span className="font-black text-amber-500 dark:text-amber-400 text-lg">1</span>
                      <div>
                        <strong className="text-slate-800 dark:text-white block">Upfront Loads & Distribution Fees:</strong> 
                    ...
                    <li className="flex gap-3 text-sm text-slate-600 dark:text-slate-400">
                      <span className="font-black text-amber-500 dark:text-amber-400 text-lg">2</span>
                      <div>
                        <strong className="text-slate-800 dark:text-white block">Management Fees (1.25% - 1.5%):</strong> 
                        Charged annually on <em>gross assets</em> (including the leverage the fund uses), not just the investor's equity.
                      </div>
                    </li>
                    <li className="flex gap-3 text-sm text-slate-600 dark:text-slate-400">
                      <span className="font-black text-amber-500 dark:text-amber-400 text-lg">3</span>
                      <div>
                        <strong className="text-slate-800 dark:text-white block">Incentive Fees (12.5% - 15%):</strong> 
          ...
          <section>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-red-900 dark:bg-black/40 text-white p-8 rounded-2xl shadow-xl dark:shadow-none relative overflow-hidden dark:border dark:border-red-900/50">
