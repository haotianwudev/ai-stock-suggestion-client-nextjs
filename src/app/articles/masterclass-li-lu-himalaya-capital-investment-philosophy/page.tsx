...
// --- Data Models ---
const portfolioData = [
  { ticker: 'GOOGL', name: 'Alphabet Inc - Class A', shares: '2,543,300', weight: '22.31%', value: '$796,052,900', activity: 'No Change', color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-[#A8672E] dark:text-[#D08F52]' },
  { ticker: 'GOOG', name: 'Alphabet Inc - Class C', shares: '2,451,300', weight: '21.55%', value: '$769,217,940', activity: 'No Change', color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-[#A8672E] dark:text-[#D08F52]' },
  { ticker: 'BAC', name: 'Bank of America Corp', shares: '10,431,387', weight: '16.08%', value: '$573,726,285', activity: 'No Change', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-[#BC4128] dark:text-[#E2694A]' },
  { ticker: 'PDD', name: 'Pinduoduo Inc - ADR', shares: '4,608,000', weight: '14.64%', value: '$522,501,120', activity: 'No Change', color: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-[#BC4128] dark:text-[#E2694A]' },
  { ticker: 'BRK.B', name: 'Berkshire Hathaway Inc Cl-B', shares: '897,749', weight: '12.64%', value: '$451,253,535', activity: 'No Change', color: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-[#A8672E] dark:text-[#D08F52]' },
  ...
  { ticker: 'CROX', name: 'Crocs Inc', shares: '628,159', weight: '1.51%', value: '$53,720,158', activity: 'New Buy', color: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-[#1D8A70] dark:text-[#3CBF9C]' },
...
const philosophyPillars = [
  {
    ...
    icon: <Briefcase className="w-8 h-8 text-[#A8672E] dark:text-[#D08F52]" />
  },
  {
    title: "Mr. Market",
    ...
    icon: <TrendingUp className="w-8 h-8 text-[#BC4128] dark:text-[#E2694A]" />
  },
  {
    ...
    icon: <ShieldAlert className="w-8 h-8 text-[#1D8A70] dark:text-[#3CBF9C]" />
  },
  {
  ...
  return (
    <ArticleFrame slug="masterclass-li-lu-himalaya-capital-investment-philosophy">
      <div className="bg-transparent font-sans dark:text-slate-300">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="mb-12">
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-indigo-100 dark:bg-indigo-900/20 text-[#A8672E] dark:text-[#D08F52] dark:text-[#A8672E] dark:text-[#D08F52] rounded-2xl shadow-inner dark:shadow-none">
                  <BookOpen className="w-8 h-8" />
                </div>
                <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white font-serif">The Crucible of Character</h2>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 mt-12">
              ...
              <div className="bg-slate-50 dark:bg-[#14171B] rounded-3xl p-8 border border-slate-100 dark:border-white/10 shadow-lg dark:shadow-none relative overflow-hidden h-fit">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 relative z-10 font-serif">The Columbia Marathon</h3>
                ...
                <ul className="space-y-4 relative z-10">
                  ...
                  <li className="flex items-center gap-3 bg-white dark:bg-black/40 p-4 rounded-xl shadow-sm dark:shadow-none border border-slate-100 dark:border-white/10">
                    <div className="w-2 h-2 rounded-full bg-[#BC4128] dark:bg-[#E2694A]"></div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-12">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white font-serif">Epistemology of Capital Allocation</h2>
              </div>
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              {philosophyPillars.map((pillar, idx) => (
                <div key={idx} className="bg-white dark:bg-black/40 rounded-3xl p-8 shadow-md dark:shadow-none hover:shadow-xl dark:hover:shadow-none hover:-translate-y-1 transition-all duration-300 border border-slate-100 dark:border-white/10 flex flex-col h-full">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3 font-serif">{pillar.title}</h3>
            ...
            <div className="mt-16 grid md:grid-cols-2 gap-8">
              <div className="bg-white dark:bg-black/40 rounded-3xl p-8 border border-slate-200 dark:border-white/10 shadow-lg dark:shadow-none">
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4 border-b pb-4 border-slate-100 dark:border-slate-800 font-serif">The Investigative Imperative</h3>
              ...
              <div className="bg-white dark:bg-black/40 rounded-3xl p-8 border border-slate-200 dark:border-white/10 shadow-lg dark:shadow-none">
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4 border-b pb-4 border-slate-100 dark:border-slate-800 font-serif">Value Investing as a Moral Calling</h3>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <div className="mt-16 bg-gradient-to-r from-indigo-900 to-slate-800 rounded-3xl p-10 text-white shadow-2xl relative overflow-hidden">
              <div className="absolute right-0 top-0 w-64 h-64 bg-white dark:bg-[#0A0D14]/5 rounded-full blur-3xl"></div>
              <div className="relative z-10 flex flex-col lg:flex-row gap-10 items-center">
                <div className="flex-1">
                  <h3 className="text-3xl font-bold mb-6 flex items-center gap-3 font-serif">
                ...
                <div className="hidden lg:flex flex-col items-center justify-center p-8 bg-white dark:bg-[#0A0D14]/10 rounded-2xl border border-white/20 min-w-[280px] shadow-inner backdrop-blur-sm">
                  ...
                  <div className="w-full h-px bg-white dark:bg-[#0A0D14]/20 my-6"></div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-12">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white font-serif">Q4 2025 Form 13F Architecture</h2>
              </div>
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {portfolioData.map((item, idx) => (
                      <tr key={idx} className="hover:bg-slate-50 dark:bg-[#14171B] dark:hover:bg-slate-900/40 transition-colors">
                        ...
                        <td className="py-4 px-6 text-center">
                          <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold ${item.activity === 'New Buy' ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-[#1D8A70] dark:text-[#3CBF9C]' : 'bg-slate-100 text-slate-600 dark:text-slate-400 dark:bg-slate-800 dark:text-slate-400'}`}>
                            {item.activity}
                          </span>
                        </td>
                      </tr>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="bg-[#A8672E]/10 dark:bg-[#D08F52]/10/50 dark:bg-blue-900/20 rounded-3xl p-8 border border-blue-100 dark:border-blue-900/30">
                <h4 className="text-xl font-bold text-blue-900 dark:text-[#A8672E] dark:text-[#D08F52] mb-4">Tech & Finance Monopolies</h4>
              ...
              <div className="bg-[#BC4128]/10 dark:bg-[#E2694A]/10/50 dark:bg-orange-900/20 rounded-3xl p-8 border border-orange-100 dark:border-orange-900/30">
                <h4 className="text-xl font-bold text-orange-900 dark:text-[#BC4128] dark:text-[#E2694A] mb-4">The PDD Thesis (14.64%)</h4>
        ...
        <section className="py-24 px-6 bg-[#BC4128]/10 dark:bg-[#E2694A]/10 dark:bg-[#14171B] border-t border-rose-100 dark:border-slate-800">
          <div className="max-w-5xl mx-auto">
            <div className="mb-12">
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-rose-100 dark:bg-rose-900/20 text-[#BC4128] dark:text-[#E2694A] dark:text-[#BC4128] dark:text-[#E2694A] rounded-2xl shadow-inner dark:shadow-none">
                  <AlertTriangle className="w-8 h-8" />
                </div>
                <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white font-serif">The Architecture of Replicability</h2>
              </div>
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="bg-white dark:bg-black/40 p-8 rounded-3xl shadow-sm dark:shadow-none border border-rose-100 dark:border-rose-900/30">
                <div className="w-12 h-12 bg-rose-100 dark:bg-rose-900/20 rounded-2xl flex items-center justify-center mb-6 text-[#BC4128] dark:text-[#E2694A] dark:text-[#BC4128] dark:text-[#E2694A] font-bold text-xl">1</div>
              ...
              <div className="bg-white dark:bg-black/40 p-8 rounded-3xl shadow-sm dark:shadow-none border border-rose-100 dark:border-rose-900/30">
                <div className="w-12 h-12 bg-rose-100 dark:bg-rose-900/20 rounded-2xl flex items-center justify-center mb-6 text-[#BC4128] dark:text-[#E2694A] dark:text-[#BC4128] dark:text-[#E2694A] font-bold text-xl">2</div>
              ...
              <div className="bg-white dark:bg-black/40 p-8 rounded-3xl shadow-sm dark:shadow-none border border-rose-100 dark:border-rose-900/30">
                <div className="w-12 h-12 bg-rose-100 dark:bg-rose-900/20 rounded-2xl flex items-center justify-center mb-6 text-[#BC4128] dark:text-[#E2694A] dark:text-[#BC4128] dark:text-[#E2694A] font-bold text-xl">3</div>
