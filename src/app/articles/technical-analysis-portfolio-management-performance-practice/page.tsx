        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="space-y-4 text-gray-700 bg-gray-50 p-6 rounded-lg">
              ...
              <p>Use doesn&apos;t vary much by market cap, but <strong className="font-semibold text-blue-600">5.9% of All-Cap funds</strong> rate it &ldquo;very important.&rdquo;</p>
