...
const TutorialCard = ({ title, icon: Icon, children, colorAccent, bgColor = 'bg-white dark:bg-[#14171B]' }: {
  title: string;
  icon?: React.ComponentType<{ className?: string }>;
  ...
  <div className={`${bgColor} rounded-2xl p-7 shadow-sm border border-slate-100 dark:border-white/10 relative overflow-hidden hover:shadow-md transition-shadow`}>
    ...
    <div className="text-slate-600 dark:text-slate-300 space-y-4 leading-relaxed text-sm md:text-base">{children}</div>
  </div>
);

const CodeSnippet = ({ language, code }: { language: string; code: string }) => (
  <div className="bg-slate-900 dark:bg-[#0A0D11] rounded-xl overflow-hidden mt-4 border border-slate-800 dark:border-white/5 shadow-inner">
...
const ComparisonTable = ({ headers, rows }: { headers: string[]; rows: string[][] }) => (
  <div className="overflow-x-auto rounded-xl border border-slate-200 dark:border-white/10 shadow-sm mt-8 bg-white dark:bg-[#14171B]">
    <table className="w-full text-left border-collapse">
      <thead>
        <tr className="bg-slate-50 dark:bg-black/30 text-slate-700 dark:text-slate-300">
          {headers.map((h, i) => (
            <th key={i} className="py-4 px-6 font-bold border-b border-slate-200 dark:border-white/10 text-sm uppercase tracking-wider">{h}</th>
          ))}
        </tr>
      </thead>
...
export default function EvolutionAutonomousExecution() {
    ...
    <ArticleFrame slug={SLUG}>
      ...
      <main className="max-w-4xl mx-auto px-6 pb-20 pt-12 space-y-24">
        ...
        <section className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 bg-white dark:bg-[#14171B] p-10 rounded-3xl shadow-sm border border-slate-200 dark:border-white/10">
          <p className="lead text-2xl text-slate-800 dark:text-slate-100 font-semibold mb-6">The trajectory of artificial intelligence has fundamentally shifted.</p>
          <p>
            We are moving from systems that merely generate probabilistic text to autonomous entities capable of executing complex, multi-step operations within highly deterministic external environments. This paradigm shift is entirely predicated on the evolution of <strong className="dark:text-white">tool calling architectures</strong>. The mechanism by which a large language model interacts with external systems — databases, APIs, computational engines, and file systems — defines its operational ceiling and utility.
          </p>
        </section>
        ...
        <section className="relative scroll-mt-24">
          ...
          <div className="mt-8 bg-[#BC4128]/10 dark:bg-[#E2694A]/10 dark:bg-orange-900/10 border border-orange-200 dark:border-[#BC4128] dark:border-[#E2694A]/20 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-orange-800 dark:text-orange-200/80">
              <div>
                <strong className="block mb-2 text-orange-950 dark:text-orange-100">1. Token Inefficiency</strong>
              ...
              <div>
                <strong className="block mb-2 text-orange-950 dark:text-orange-100">2. Compounding Latency</strong>
        ...
        <section className="relative scroll-mt-24">
          ...
          <div className="bg-emerald-900 dark:bg-emerald-950 rounded-3xl p-8 md:p-10 shadow-lg mb-10 text-emerald-50 dark:border dark:border-emerald-900">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="w-full md:w-1/3 bg-emerald-950 dark:bg-black/40 p-6 rounded-2xl border border-emerald-800 shadow-inner">
                ...
                <p className="text-sm text-emerald-100/80 leading-relaxed">
                  Rather than loading all tool schemas upfront, the agent uses a <em className="text-emerald-200">Tool Search Tool</em>. It queries to discover relevant libraries/MCP servers, imports them into its generated script, and executes locally.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-[#14171B] p-6 rounded-2xl border border-red-200 dark:border-[#BC4128] dark:border-[#E2694A]/20 shadow-sm relative overflow-hidden">
                ...
                <ol className="space-y-3 text-sm text-slate-600 dark:text-slate-300 mb-4">
                  <li>1. Model calls <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">get_intraday_data(ticker=&quot;AAPL&quot;)</code></li>
                  <li>2. The API returns <strong className="dark:text-white">10,000 rows of JSON</strong>.</li>
  ...
  ... 9,998 more rows ...
                ...
                <div className="bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-300 p-3 rounded-lg text-sm font-semibold flex items-start gap-2 mt-4 border dark:border-red-900/50">
              ...
              <div className="bg-white dark:bg-[#14171B] p-6 rounded-2xl border border-emerald-200 dark:border-[#1D8A70] dark:border-[#3CBF9C]/20 shadow-sm relative overflow-hidden">
                ...
                <ol className="space-y-3 text-sm text-slate-600 dark:text-slate-300 mb-4">
                  ...
                  <li>2. The <em className="dark:text-white">sandbox</em> fetches the data and processes it locally using pandas.</li>
                  <li>3. Only the final <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">print()</code> output is sent back to the LLM.</li>
                </ol>
...
print(top_3.to_json())`} />
                <div className="bg-emerald-100 dark:bg-emerald-900/20 text-emerald-800 dark:text-emerald-300 p-3 rounded-lg text-sm font-semibold flex items-start gap-2 mt-4 border dark:border-emerald-900/50">
        ...
        <section className="relative scroll-mt-24">
          ...
          <div className="bg-white dark:bg-[#14171B] p-8 rounded-3xl shadow-sm border border-slate-200 dark:border-white/10 mb-10">
            ...
            <div className="bg-slate-900 dark:bg-[#0A0D11] rounded-2xl overflow-hidden border border-slate-800 dark:border-white/10">
              <div className="bg-slate-950 dark:bg-black px-6 py-3 border-b border-slate-800 dark:border-white/10 flex items-center gap-3">
              ...
              <div className="p-6 md:p-8 grid md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm">Detailed markdown instructions, constraints, and logic pulled via bash call <em className="text-white">only</em> when a request matches the description.</p>
                </div>
                <div>
          ...
          <div className="space-y-8">
            ...
            <TutorialCard title="The OpenClaw Architecture (Persistent Daemon)" icon={Clock} colorAccent="bg-purple-500" bgColor="bg-purple-50 dark:bg-purple-900/10">
              <p>OpenClaw rejects ephemeral chat sessions, establishing a long-lived Node.js gateway locally. It operates a <strong className="dark:text-white">heartbeat scheduler</strong> (waking every 30 mins to review <code className="bg-white dark:bg-slate-800 px-1 rounded text-xs font-mono">HEARTBEAT.md</code>) to run background tasks.</p>
              <ul className="list-disc pl-5 space-y-1 mt-2 font-medium">
                <li><strong className="dark:text-white">Channel Adapters:</strong> WhatsApp (Baileys), Telegram (gramm Y), CLI.</li>
                <li><strong className="dark:text-white">Session Manager &amp; Queue System:</strong> Serializes multi-step tool invocations.</li>
                <li><strong className="dark:text-white">Agent Runtime:</strong> Dynamically assembles context from <code className="bg-white dark:bg-slate-800 px-1 rounded text-xs font-mono">AGENTS.md</code>, <code className="bg-white dark:bg-slate-800 px-1 rounded text-xs font-mono">SOUL.md</code>.</li>
                <li><strong className="dark:text-white">Control Plane:</strong> WebSocket API on port <code className="bg-white dark:bg-slate-800 px-1 rounded text-xs font-mono">:18789</code> for global state.</li>
              </ul>
            </TutorialCard>

            <TutorialCard title="Claude Code CLI (Terminal Focus)" icon={Terminal} colorAccent="bg-purple-500" bgColor="bg-purple-50 dark:bg-purple-900/10">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-6">
                <div className="bg-white dark:bg-slate-800/50 p-5 rounded-xl border border-purple-100 dark:border-purple-900/50 shadow-sm">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">Claude Code doesn&apos;t just guess an answer; it iteratively searches, reads, modifies, and verifies code. If a test fails, it reads the error and tries again without human prompting.</p>
                  <ul className="space-y-2 text-sm text-slate-700 dark:text-slate-300">
                    <li className="flex gap-2 items-start">
                      <ChevronRight className="w-4 h-4 text-purple-500 shrink-0" />
                      <span><strong className="dark:text-white">Native Tools:</strong> Built-in primitives like <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">Bash</code>, <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">Glob</code>, <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">Grep</code>, <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">FileRead</code>, and <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">FileEdit</code>.</span>
                    </li>
                    <li className="flex gap-2 items-start">
                      <ChevronRight className="w-4 h-4 text-purple-500 shrink-0" />
                      <span><strong className="dark:text-white">Context Injection:</strong> Automatically understands Git state, uncommitted changes, and project structures.</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white dark:bg-slate-800/50 p-5 rounded-xl border border-purple-100 dark:border-purple-900/50 shadow-sm">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">Operates with a strict permission model and highly configurable project-level instructions.</p>
                  <ul className="space-y-2 text-sm text-slate-700 dark:text-slate-300">
                    <li className="flex gap-2 items-start">
                      <ChevronRight className="w-4 h-4 text-purple-500 shrink-0" />
                      <span><strong className="dark:text-white">allowed-tools:</strong> Defined in SKILL.md to limit privileges. A &ldquo;code-reviewer&rdquo; skill can explicitly allow only Read/Grep, denying file modification tools.</span>
                    </li>
                    <li className="flex gap-2 items-start">
                      <ChevronRight className="w-4 h-4 text-purple-500 shrink-0" />
                      <span><strong className="dark:text-white">Slash Commands:</strong> Explicit invocation using commands like <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">/bugfix</code> or <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">/test</code>, which trigger specialized prompts.</span>
                    </li>
                    <li className="flex gap-2 items-start">
                      <ChevronRight className="w-4 h-4 text-purple-500 shrink-0" />
                      <span><strong className="dark:text-white">Human Approval:</strong> Destructive bash commands are trapped and require the user to press &lsquo;Enter&rsquo; before execution.</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="mt-16">
            ...
            {/* Flow diagram */}
            <div className="bg-slate-900 dark:bg-[#0A0D11] rounded-3xl p-8 border border-slate-700 dark:border-white/10 mb-8">
              ...
              <div className="relative">
                ...
                <div className="absolute left-[19px] top-8 bottom-8 w-0.5 bg-slate-700 dark:bg-slate-800 hidden md:block" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-5 items-start">
                    ...
                    <div className="flex-1 bg-slate-800 dark:bg-black/50 rounded-2xl border border-slate-700 dark:border-white/5 p-5 grid md:grid-cols-[1fr_auto_1fr] gap-4 items-start">
                      ...
                      <div className="bg-slate-900/60 dark:bg-slate-900/30 rounded-xl px-4 py-3 text-xs font-mono text-purple-400 self-start border dark:border-white/5">
                  ...
                  <div className="flex gap-5 items-start">
                    ...
                    <div className="flex-1 bg-slate-800 dark:bg-black/50 rounded-2xl border border-slate-700 dark:border-white/5 p-5 grid md:grid-cols-[1fr_auto_1fr] gap-4 items-start">
                      ...
                      <div className="hidden md:block w-px bg-slate-700 dark:bg-slate-800 self-stretch mx-2" />
                      <div className="bg-slate-900/60 dark:bg-slate-900/30 rounded-xl px-4 py-3 text-xs font-mono text-slate-400 self-start border dark:border-white/5">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-[#14171B] rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm p-6">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                  The harness&apos;s skill YAML declares which MCP servers are required (<code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">mcp_servers: [quant-db, alpha-vantage]</code>). When the skill activates, the harness spins up only those servers — not all registered ones. This means a &ldquo;risk-analysis&rdquo; skill never accidentally exposes the trade-execution MCP server to the LLM.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-[#14171B] rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm p-6">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                  Instead of injecting all 50 tool schemas globally, the harness injects only the schemas relevant to the active skill. A &ldquo;portfolio-rebalancer&rdquo; skill exposes <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">get_weights</code> and <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">set_allocation</code>. A &ldquo;news-analyst&rdquo; skill exposes <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">search_filings</code>. Context stays lean regardless of how many tools exist in the registry.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-[#14171B] rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm p-6">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                  The skill&apos;s <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">instructions.md</code> explicitly tells the LLM: <em className="dark:text-white">&ldquo;For any dataset &gt; 1,000 rows, write a Python script and execute it via the sandbox tool. Never paste raw data into your response.&rdquo;</em> The harness enforces this by only granting the <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">sandbox_exec</code> tool — not a raw data-dump tool — in the active allowlist.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-[#14171B] rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm p-6">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">Lifecycle enforcement</p>
                <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                  Hooks are the harness&apos;s immune system. A <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">pre_tool_use</code> hook intercepts every bash call and blocks commands containing <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">DROP TABLE</code> or live API keys. A <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">post_tool_use</code> hook auto-runs <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">ruff</code> on any generated Python. The LLM never bypasses these — they execute at the harness layer, below the model&apos;s awareness.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative scroll-mt-24">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-[#14171B] rounded-2xl shadow-sm border border-slate-200 dark:border-white/10 overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">The Harness reads this file to understand <em className="dark:text-slate-300">when</em> to activate the skill. The <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">triggers</code> array acts as semantic routing hooks.</p>
...
env_vars_required:
  - DATABASE_URL`} />
            ...
            <div className="bg-white dark:bg-[#14171B] rounded-2xl shadow-sm border border-slate-200 dark:border-white/10 overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">This contains the actual system prompt rules. Because it&apos;s isolated, we can be extremely verbose without polluting other tasks.</p>
                <CodeSnippet language="markdown" code={`# Database Architect Directives

You are responsible for database modifications in this repository.

## Constraints
1. ALWAYS use the \`scripts/generate_migration.sh\` script to create new files. Do not create them manually.
2. NEVER use \`DROP TABLE\` unless explicitly approved by the user.
3. Every column must have a comment (e.g. \`COMMENT ON COLUMN users.email IS 'User primary contact';\`).
4. If writing a complex query, run \`EXPLAIN ANALYZE\` using the \`psql_eval\` tool to verify performance before showing it to the user.

## Schema Context
We use UUIDv4 for primary keys, not auto-incrementing integers.`} />
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#14171B] rounded-2xl shadow-sm border border-slate-200 dark:border-white/10 overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">We abstract complex shell logic away from the LLM. Instead of trying to teach the LLM how to format timestamps for filenames, we just give it a script to run.</p>
                <CodeSnippet language="bash" code={`#!/bin/bash
# Usage: ./generate_migration.sh "create_users_table"
...
FILENAME="db/migrations/\${TIMESTAMP}_\${1}.sql"

echo "-- Migration: $1" > "$FILENAME"
echo "-- Created at: $(date)" >> "$FILENAME"
echo "" >> "$FILENAME"

echo "Created empty migration at: $FILENAME"`} />
              </div>
            </div>
          ...
          <div className="space-y-8 mb-10">
            <TutorialCard title="Agentic Quantitative Skills" icon={Calculator} colorAccent="bg-cyan-500">
              <p className="text-lg mb-6">
                Traditional LLMs fail at quantitative finance because text prediction cannot reliably perform complex mathematics. <strong className="dark:text-white">Agentic Quantitative Skills</strong> solve this by forcing the LLM to write, execute, and iterate on Python code natively within a secure sandbox (Programmatic Tool Calling), offloading the math to libraries like <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">pandas</code>, <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">numpy</code>, and <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">scipy</code>.
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-slate-50 dark:bg-black/30 rounded-xl p-5 border border-slate-200 dark:border-white/5">
                  <h4 className="font-bold text-slate-800 dark:text-slate-100 mb-3 flex items-center gap-2">
                    <LineChart className="w-4 h-4 text-cyan-600 dark:text-cyan-400" /> The Execution Pipeline
                  </h4>
                  <ol className="space-y-4 text-sm text-slate-700 dark:text-slate-300 relative border-l border-cyan-200 dark:border-cyan-900/50 ml-2 pl-4">
                    <li className="relative">
                      <div className="absolute -left-[21px] top-1 w-2.5 h-2.5 bg-cyan-500 rounded-full border-2 border-white dark:border-[#14171B]"></div>
                      <strong className="dark:text-white">Data Ingestion:</strong> The agent writes code to fetch 10 years of OHLCV data via an MCP Resource (e.g., EODHD).
                    </li>
                    <li className="relative">
                      <div className="absolute -left-[21px] top-1 w-2.5 h-2.5 bg-cyan-500 rounded-full border-2 border-white dark:border-[#14171B]"></div>
                      <strong className="dark:text-white">Feature Engineering:</strong> It dynamically calculates rolling Z-scores, MACD, and Bollinger Bands using <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">pandas_ta</code>.
                    </li>
                    <li className="relative">
                      <div className="absolute -left-[21px] top-1 w-2.5 h-2.5 bg-cyan-500 rounded-full border-2 border-white dark:border-[#14171B]"></div>
                      <strong className="dark:text-white">Statistical Validation:</strong> Runs ADF (Augmented Dickey-Fuller) tests for cointegration in pairs trading strategies.
                    </li>
                    <li className="relative">
                      <div className="absolute -left-[21px] top-1 w-2.5 h-2.5 bg-cyan-500 rounded-full border-2 border-white dark:border-[#14171B]"></div>
                      <strong className="dark:text-white">Metric Generation:</strong> Calculates Maximum Drawdown, Value at Risk (VaR), and Sharpe ratio.
                    </li>
                  </ol>
                </div>
                <div className="bg-slate-900 dark:bg-[#0A0D11] rounded-xl p-5 border border-slate-800 dark:border-white/5 shadow-inner">
                  <h4 className="font-mono text-cyan-400 text-sm mb-3 border-b border-slate-700 dark:border-white/10 pb-2">skill-quant-analyst/</h4>
                  ...
                  <div className="mt-4 p-2 bg-slate-800 dark:bg-black/50 rounded text-xs text-slate-400 border dark:border-white/5">
            ...
            <TutorialCard title="Multi-Agent Collaboration (FinRobot & LangGraph architectures)" icon={Users} colorAccent="bg-cyan-500">
              <p className="text-lg mb-6">
                Institutional complexity exceeds the capability of a single foundational model, no matter how large the context window. Modern financial AI leverages <strong className="dark:text-white">Multi-Agent Systems (MAS)</strong>, inspired by frameworks like FinRobot, where specialized sub-agents operate under a central orchestrator using shared memory and StateGraphs.
              </p>
              <div className="grid md:grid-cols-4 gap-4 mb-4">
                <div className="bg-cyan-50 dark:bg-cyan-900/10 p-4 rounded-xl border border-cyan-100 dark:border-cyan-900/30 flex flex-col h-full">
                  <div className="w-8 h-8 rounded-full bg-cyan-200 dark:bg-cyan-800 text-cyan-800 dark:text-cyan-200 flex items-center justify-center font-bold mb-3 shadow-sm">1</div>
                  <h5 className="font-bold text-cyan-900 dark:text-cyan-100 mb-2">Supervisor Agent</h5>
                  <p className="text-xs text-cyan-800 dark:text-cyan-300/80 leading-relaxed flex-grow">Receives the user intent (e.g., &ldquo;Analyze semiconductor supply chains&rdquo;). Breaks down the task, creates an execution plan, and routes sub-tasks to specialized agents.</p>
                </div>
                <div className="bg-white dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm flex flex-col h-full">
                  <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 flex items-center justify-center font-bold mb-3 shadow-sm">
                    <BookOpen className="w-4 h-4" />
                  </div>
                  <h5 className="font-bold text-slate-900 dark:text-white mb-2">Data &amp; News Agent</h5>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed flex-grow">Uses RAG and MCP to pull 10-K filings, earnings transcripts, and realtime news. Performs NLP sentiment analysis (FinBERT) to score qualitative market narratives.</p>
                </div>
                <div className="bg-white dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm flex flex-col h-full">
                  <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 flex items-center justify-center font-bold mb-3 shadow-sm">
                    <LineChart className="w-4 h-4" />
                  </div>
                  <h5 className="font-bold text-slate-900 dark:text-white mb-2">Quantitative Agent</h5>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed flex-grow">Receives historical data. Writes programmatic code to generate Discounted Cash Flow (DCF) models, Enterprise Value multiples, and backtests technical strategies.</p>
                </div>
                <div className="bg-white dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm flex flex-col h-full">
                  <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 flex items-center justify-center font-bold mb-3 shadow-sm">
                    <FileBarChart className="w-4 h-4" />
                  </div>
                  <h5 className="font-bold text-slate-900 dark:text-white mb-2">Report Agent</h5>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed flex-grow">Ingests the JSON state emitted by the News and Quant agents. Synthesizes conflicting data points into a cohesive, institutional-grade markdown investment memo.</p>
                </div>
              </div>
              <div className="bg-slate-50 dark:bg-black/30 p-4 rounded-xl border border-slate-100 dark:border-white/5 text-sm text-slate-700 dark:text-slate-300 flex items-start gap-3 mt-6">
                <Network className="w-5 h-5 text-cyan-600 dark:text-cyan-400 shrink-0 mt-0.5" />
                <p><strong className="dark:text-white">State Management:</strong> These agents do not just chat; they pass a strictly typed <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">State</code> object (often via LangGraph). If the Risk Agent flags that the Quant Agent&apos;s portfolio violates a volatility constraint, the state is passed back to the Quant Agent with an error flag, forcing a recalculation <em className="dark:text-white">before</em> the final report is generated.</p>
              </div>
            </TutorialCard>
          </div>
        </section>
          ...
          <div className="bg-[#BC4128]/10 dark:bg-[#E2694A]/10 dark:bg-red-900/10 p-8 rounded-3xl shadow-sm border border-red-100 dark:border-red-900/30">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-red-800 dark:text-red-200/80 text-sm leading-relaxed mb-4">
                ...
                <p className="text-red-800 dark:text-red-200/80 text-sm leading-relaxed">
                  Skills use flags like <code className="bg-white dark:bg-black/40 px-1 rounded text-xs font-mono border dark:border-red-900/50">disable-model-invocation: true</code> to ensure critical files are gated by explicit human triggers.
                </p>
              </div>
              <div>
                <h4 className="font-bold text-red-900 dark:text-red-300 mb-3 text-lg flex items-center gap-2">
                ...
                <p className="text-red-800 dark:text-red-200/80 text-sm leading-relaxed">
                  <strong className="dark:text-red-100">Agent OS Governance</strong> enforces kernel-level deterministic policy and immutable audit logs. High-stakes deployments always require Human-in-the-Loop (HITL) approval.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 mt-32 mb-16 relative">
        <div className="bg-slate-900 dark:bg-[#0A0D11] rounded-[3rem] p-8 md:p-14 shadow-2xl overflow-hidden relative border border-slate-800 dark:border-white/10">
