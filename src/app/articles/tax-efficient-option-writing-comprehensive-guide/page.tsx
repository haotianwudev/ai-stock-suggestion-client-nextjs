            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-xl">
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-red-700">Repurchasing &ldquo;substantially identical&rdquo; securities within 61 days of a loss disallows the deduction. While option rolling is generally safe, aggressive strategies risk IRS challenge.</p>
                </div>
              </div>
            </div>
          </div>
