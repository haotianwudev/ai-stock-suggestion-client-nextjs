        ...
        <main className="max-w-4xl mx-auto py-16 px-6 lg:px-8 space-y-24">
          ...
          <section>
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-900 dark:to-indigo-950 rounded-3xl p-8 md:p-12 text-white shadow-xl relative overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 bg-white dark:bg-[#0A0D14] opacity-10 rounded-full transform translate-x-1/2 -translate-y-1/2"></div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 border-t-4 border-t-rose-500 overflow-hidden flex flex-col h-full">
                <div className="p-6 flex-grow">
                  <div className="flex items-center mb-4">
                    <div className="p-2 bg-[#BC4128]/10 dark:bg-[#E2694A]/10 dark:bg-rose-900/20 rounded-lg text-[#BC4128] dark:text-[#E2694A] dark:text-[#BC4128] dark:text-[#E2694A] mr-3">
                      <LineChart size={24} />
                    </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-950 p-4 border-t border-slate-100 dark:border-slate-800 text-sm text-slate-700 dark:text-slate-300">
                  <span className="font-bold text-[#BC4128] dark:text-[#E2694A] dark:text-[#BC4128] dark:text-[#E2694A]">Signal Threshold:</span> VIX/VXV Ratio &gt; 1.0 to 1.25. Extreme readings pinpoint the violent acceleration of an early bear market phase.
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 border-t-4 border-t-blue-500 overflow-hidden flex flex-col h-full">
                <div className="p-6 flex-grow">
                  <div className="flex items-center mb-4">
                    <div className="p-2 bg-[#A8672E]/10 dark:bg-[#D08F52]/10 dark:bg-blue-900/20 rounded-lg text-[#A8672E] dark:text-[#D08F52] dark:text-[#A8672E] dark:text-[#D08F52] mr-3">
                ...
                <div className="bg-slate-50 dark:bg-slate-950 p-4 border-t border-slate-100 dark:border-slate-800 text-sm text-slate-700 dark:text-slate-300">
                  <span className="font-bold text-[#A8672E] dark:text-[#D08F52] dark:text-[#A8672E] dark:text-[#D08F52]">Signal Threshold:</span> TRIN (Arms Index) &gt; 1.25 paired with a structurally falling A/D Line.
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 border-t-4 border-t-emerald-500 overflow-hidden flex flex-col h-full">
                <div className="p-6 flex-grow">
                  <div className="flex items-center mb-4">
                    <div className="p-2 bg-[#1D8A70]/10 dark:bg-[#3CBF9C]/10 dark:bg-emerald-900/20 rounded-lg text-[#1D8A70] dark:text-[#3CBF9C] dark:text-[#1D8A70] dark:text-[#3CBF9C] mr-3">
                      <CreditCard size={24} />
                    </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-950 p-4 border-t border-slate-100 dark:border-slate-800 text-sm text-slate-700 dark:text-slate-300">
                  <span className="font-bold text-[#1D8A70] dark:text-[#3CBF9C] dark:text-[#1D8A70] dark:text-[#3CBF9C]">Signal Threshold:</span> Sustained High-Yield Option-Adjusted Spread (OAS) Expansion vs U.S. Treasuries.
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="overflow-x-auto bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="text-sm divide-y divide-slate-100 dark:divide-slate-800">
                    <tr className="hover:bg-slate-50 dark:bg-[#14171B] dark:hover:bg-slate-800/30">
                      ...
                      <td className="p-4 text-[#BC4128] dark:text-[#E2694A] dark:text-[#BC4128] dark:text-[#E2694A] font-medium">Unlimited downside risk in gap-down crash.</td>
                    </tr>
                    <tr className="hover:bg-slate-50 dark:bg-[#14171B] dark:hover:bg-slate-800/30">
          ...
          <section>
            <div className="bg-slate-900 dark:bg-slate-950 rounded-3xl p-8 md:p-12 text-white shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl font-bold mb-8 flex items-center text-[#1D8A70] dark:text-[#3CBF9C] font-serif">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-orange-50 dark:from-rose-900/20 dark:to-orange-900/20 border border-orange-200 dark:border-orange-800/50 rounded-3xl p-8 md:p-12 shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center space-x-3 mb-6">
                  <div className="bg-[#BC4128] dark:bg-[#E2694A] text-white p-2 rounded-xl shadow-sm">
                    <AlertTriangle size={24} />
                  </div>
                  <h2 className="text-3xl font-extrabold text-orange-900 dark:text-[#BC4128] dark:text-[#E2694A] font-serif">Actionable Playbook: March 2026</h2>
                </div>
                
                <div className="bg-white dark:bg-[#0A0D14]/60 dark:bg-black/20 p-5 rounded-xl border border-orange-200/50 dark:border-orange-800/30 mb-8 backdrop-blur-sm">
