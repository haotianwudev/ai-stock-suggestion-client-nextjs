          ...
          <div className="space-y-8">
            <div>
              ...
              <ul className="space-y-4">
                {event.opportunities.map((opp: any, idx: number) => (
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                {event.affectedSectors.map((sector: any, i: number) => (
  ...
  return (
    <ArticleFrame slug="2025-financial-market-retrospective-seven-pivotal-events">
      <div className="py-4">
        ...
        {/* Intro Card */}
        <div className="mt-16 mb-24 bg-gray-900 rounded-[2rem] p-10 md:p-14 text-white shadow-2xl relative overflow-hidden group hover:scale-[1.01] transition-transform duration-500">
