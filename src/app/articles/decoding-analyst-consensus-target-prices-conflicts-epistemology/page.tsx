      ...
      <div className="min-h-screen bg-[#FAFAFA] font-sans selection:bg-indigo-100 selection:text-indigo-900">
        ...
        <div className="max-w-5xl mx-auto px-6 relative">
          ...
          <div className="absolute top-4 left-6 z-10">
            <div className="bg-purple-600 text-white px-4 py-2 rounded-lg font-bold text-sm shadow-lg flex items-center gap-2">
              <Brain size={16} />
              Deep Research
            </div>
          </div>
          ...
          {currentArticle?.podcastUrl && (
            <div className="absolute top-4 right-6 z-10">
              <div className="bg-green-600 text-white px-4 py-2 rounded-lg font-bold text-sm shadow-lg flex items-center gap-2">
                <Music size={16} />
                Podcast
              </div>
            </div>
        ...
        <section className="max-w-5xl mx-auto px-6 pt-20 pb-8">
          <div className="rounded-2xl overflow-hidden shadow-2xl border border-slate-200">
            <img 
              src="https://i.imgur.com/8gDViiw.jpeg" 
              alt="Analyst Consensus Infographic" 
        ...
        <main className="max-w-5xl mx-auto px-6 py-16">
          ...
          >
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <Card title="" className="bg-gradient-to-br from-white to-indigo-50/50 border-indigo-100">
              ...
              <Card title="" className="bg-gradient-to-br from-white to-rose-50/50 border-rose-100">
                <div className="flex items-center gap-3 mb-6">
