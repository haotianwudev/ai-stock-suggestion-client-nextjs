      ...
      <div className="bg-gray-50 text-gray-800 min-h-screen font-sans">
        ...
        <div className="container mx-auto p-4 sm:p-6 lg:p-8">
          ...
          <footer className="text-center mt-12 text-gray-500 print-footer">
            <p>Created for easy reference. For more details, check the official Ollama documentation. &copy; 2025 SOPHIE's Daddy Blog (sophie-ai-finance.com). Educational content for informational purposes only.</p>
          </footer>
        </div>
      </div>
    </>
