...
import { ArrowRightCircle, TrendingUp, BarChart2, Zap, Shield, Calculator, Globe, Activity, Layers, Award, RefreshCw, CheckCircle2, ArrowUpRight, TrendingDown } from 'lucide-react';
        ...
        <section>
          ...
          <Card className="bg-white">
            ...
            <BulletList 
              ...
              items={[
                <React.Fragment key="1"><strong className="text-slate-800">Historical Context:</strong> Originally designed in the 1990s as a simple mechanism for broad-market passive equity exposure (e.g., SPY, QQQ).</React.Fragment>,
                <React.Fragment key="2"><strong className="text-slate-800">Modern Evolution:</strong> Has evolved into the primary conduit for institutional liquidity and complex active portfolio management.</React.Fragment>,
                <React.Fragment key="3"><strong className="text-slate-800">Systemic Importance:</strong> Functions not merely as an allocation tool, but as the foundational trading layer for the broader global financial system.</React.Fragment>,
                <React.Fragment key="4"><strong className="text-slate-800">Strategic Uses:</strong> Increasingly utilized to access alternative asset classes, deploy factor-based &ldquo;smart beta&rdquo; strategies, and serve as crucial fixed-income liquidity proxies.</React.Fragment>
              ]} 
            />
          </Card>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-emerald-50 border-emerald-100">
              ...
              <BulletList 
                ...
                items={[
                  <React.Fragment key="1"><strong className="text-emerald-900">Record Global Assets:</strong> The global ETF marketplace surged to a record $21.91 trillion by April 2026, up 10.5% YTD.</React.Fragment>,
                  <React.Fragment key="2"><strong className="text-emerald-900">Massive Inflows:</strong> Witnessed 83 consecutive months of inflows, accumulating $856.38 billion YTD.</React.Fragment>,
                  <React.Fragment key="3"><strong className="text-emerald-900">U.S. Epicenter:</strong> The U.S. remains the core hub, managing $15.69 trillion across 5,283 distinct products.</React.Fragment>
                ]} 
              />
            </Card>
            ...
            <Card className="bg-white border-slate-200">
              ...
              <BulletList 
                ...
                items={[
                  <React.Fragment key="1"><strong className="text-slate-800">High Concentration:</strong> The top three providers (iShares, Vanguard, State Street) command a massive 59% of global market share.</React.Fragment>,
                  <React.Fragment key="2"><strong className="text-slate-800">APAC Expansion:</strong> The Asia-Pacific region demonstrates an aggressive growth trajectory, surpassing $2 trillion in AUM by late 2025.</React.Fragment>,
                  <React.Fragment key="3"><strong className="text-slate-800">Fee Compression:</strong> Asset-weighted expense ratios for index ETFs hit 0.14%, accelerating mutual fund conversions.</React.Fragment>
                ]} 
              />
            </Card>
          </div>
        ...
        <section>
          ...
          <Card className="bg-gradient-to-br from-rose-50 to-white border-rose-100">
            ...
            <BulletList 
              ...
              items={[
                <React.Fragment key="1"><strong className="text-slate-800">The Quant Standard:</strong> Financial institutions utilize Notional Value (Execution Price &times; Total Shares) to accurately measure capital transfers.</React.Fragment>,
                <React.Fragment key="2"><strong className="text-slate-800">Massive Baseline:</strong> ETFs account for roughly 32% of the $1.1 trillion U.S. equities daily notional baseline.</React.Fragment>,
                <React.Fragment key="3"><strong className="text-slate-800">Macro Shock Absorbers:</strong> During periods of distress (e.g., March 2026 macro shocks), genuine single-stock liquidity dries up. Capital rotation shifts heavily to ETFs, pushing their trading to nearly 40% of total U.S. stock market volume.</React.Fragment>
              ]} 
            />
          </Card>
        </section>
              ...
              <ul className="space-y-4 text-slate-600 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-emerald-400 before:to-emerald-100">
                <li className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="ml-4 md:ml-0 md:mr-4 md:group-odd:ml-4 md:group-odd:mr-0 w-[calc(100%-3rem)] md:w-1/2 p-4 bg-slate-50 rounded-lg shadow-sm border border-slate-100">
                    AP buys the underlying &ldquo;creation basket&rdquo; in the open market.
                  </div>
                </li>
                <li className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
        ...
        <section>
          ...
          <div className="space-y-6">
            <Card className="bg-indigo-50 border-indigo-100">
              ...
              />
              <div className="bg-slate-900 rounded-xl p-6 my-6 shadow-md border-l-4 border-indigo-500 text-center">
                <MathBlock math="TE = \sqrt{ \frac{1}{N-1} \sum_{i=1}^N (R_{P,i} - R_{B,i} - E)^2 }" />
                <div className="text-slate-400 text-sm font-medium mt-3 border-t border-slate-800 pt-3">
            ...
            <Card className="bg-violet-50 border-violet-100">
              ...
              />
              <div className="bg-slate-900 rounded-xl p-6 my-6 shadow-md border-l-4 border-indigo-500 text-center">
                <MathBlock math="\Sigma_{LW} = \delta F + (1 - \delta) S" />
                <div className="text-slate-400 text-sm font-medium mt-3 border-t border-slate-800 pt-3">
