...
const SectionHeader: React.FC<SectionHeaderProps> = ({ title, subtitle, icon: Icon, colorClass }) => (
  <div className="mb-8 border-l-4 border-gray-200 pl-6 py-2">
    ...
    <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 tracking-tight">{title}</h2>
...
const Card: React.FC<CardProps> = ({ title, children, className = "", noPadding = false }) => (
  <div className={`bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow duration-300 ${className}`}>
    {title && (
...
const FormulaCard: React.FC<FormulaCardProps> = ({ label, formula, description }) => (
  <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 mb-3 group hover:border-indigo-300 transition-colors">
    <div className="flex justify-between items-center mb-2">
      <div className="text-xs font-bold text-indigo-500 uppercase tracking-widest">{label}</div>
    </div>
    <div className="font-mono text-base md:text-lg text-slate-800 mb-3 overflow-x-auto whitespace-nowrap py-2 px-3 bg-white rounded-lg shadow-inner border border-slate-100">
      {formula}
    </div>
    <p className="text-sm text-slate-600 italic border-l-2 border-indigo-200 pl-3">{description}</p>
  </div>
);
...
const ProcessStep: React.FC<ProcessStepProps> = ({ number, title, desc }) => (
  <div className="relative flex flex-col items-center text-center p-3 min-h-[160px]">
    ...
    <h3 className="font-bold text-gray-900 mb-2 text-sm lg:text-base leading-tight">{title}</h3>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 lg:gap-8">
              ...
              <div className="xl:col-span-7 space-y-3">
                <Card title="Mean-Variance Optimization (MVO)">
                  ...
                  <FormulaCard 
                    ...
                    description={
                      <span>
                        <strong className="text-indigo-600">w:</strong> Weights vector, <strong className="text-indigo-600 ml-2">μ:</strong> Expected returns, <strong className="text-indigo-600 ml-2">Σ:</strong> Covariance matrix, <strong className="text-indigo-600 ml-2">λ:</strong> Risk aversion parameter.<br/>
                  ...
                  <div className="bg-indigo-50 rounded-xl p-3 border border-indigo-100">
                    <h4 className="font-bold text-indigo-900 mb-2">Why it fails in practice</h4>
                    <p className="text-sm text-indigo-800 mb-2">MVO is infamously an "estimation error maximizer". It aggressively allocates to assets with:</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                  <Card title="Benchmark Relative" className="bg-slate-50 border-slate-200">
                    ...
                    <div className="font-mono text-xs bg-white p-2 rounded border border-slate-300 text-slate-600 overflow-x-auto">
                      min (w - w_b)ᵀ Σ (w - w_b)
                    </div>
                  </Card>
                  <Card title="Information Ratio" className="bg-slate-50 border-slate-200">
              ...
              <div className="xl:col-span-5">
                <div className="bg-slate-900 text-white rounded-2xl p-5 lg:p-6 shadow-2xl">
                  <div className="mb-4">
                    <h3 className="text-lg lg:text-xl font-bold mb-2 flex items-center text-white">
                      <Shield className="w-5 h-5 lg:w-6 lg:h-6 mr-3 text-emerald-400 flex-shrink-0" />
                    ...
                    {[
                      ...
                      >
                        <div className="font-bold text-sm mb-1 flex justify-between items-center">
                          ...
                          {activeTab === item.id && <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse flex-shrink-0"></div>}
                        </div>
                        {activeTab === item.id && (
                          <div className="text-xs text-emerald-100 opacity-90 mt-1 leading-relaxed">
                            {item.desc}
                          </div>
                        )}
                      </button>
                  ...
                  <div className="pt-3 border-t border-slate-700">
                    ...
                    <div className="bg-black rounded p-2 font-mono text-xs text-emerald-400 overflow-x-auto">
          ...
          <section className="bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-12 border-y border-gray-200">
            <div className="max-w-6xl mx-auto">
              <div className="flex flex-col lg:flex-row lg:items-center mb-8 gap-4">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Risk Models: Dimensionality Reduction</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-gray-800">Structural Decomposition</h3>
                  ...
                  <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div className="font-mono text-lg lg:text-xl text-center mb-3 text-slate-800">Σ = B Ω Bᵀ + D</div>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-gray-800">The Hierarchy of Models</h3>
                  <div className="relative pl-6 lg:pl-8 border-l-2 border-purple-200 space-y-5">
                    ...
                    <div className="relative">
                      <div className="absolute -left-[33px] lg:-left-[41px] top-1 w-4 h-4 lg:w-5 lg:h-5 rounded-full border-4 border-white bg-indigo-500"></div>
                    ...
                    <div className="relative">
                      <div className="absolute -left-[33px] lg:-left-[41px] top-1 w-4 h-4 lg:w-5 lg:h-5 rounded-full border-4 border-white bg-blue-400"></div>
              ...
              <div className="space-y-4">
                ...
                <Card noPadding className="border-pink-100">
                  <div className="p-4 bg-pink-50 border-b border-pink-100">
                    <h3 className="font-bold text-pink-900 capitalize text-lg">{activeConstraint} Constraints</h3>
                  </div>
                  <div className="p-4">
          ...
          <section className="py-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
              <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                ...
                <h3 className="font-bold text-gray-900 mb-2">Enterprise (Buy)</h3>
              ...
              <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                ...
                <h3 className="font-bold text-gray-900 mb-2">Open Source (Build)</h3>
