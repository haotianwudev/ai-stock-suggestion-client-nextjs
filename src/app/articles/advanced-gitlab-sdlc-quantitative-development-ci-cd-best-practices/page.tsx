      ...
      <div className="max-w-5xl mx-auto space-y-12 text-slate-800 dark:text-slate-200">
        ...
        <section id="terminology">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-3 font-serif">SDLC</h3>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-3 font-serif">Continuous Integration (CI)</h3>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-3 font-serif">Continuous Delivery (CD)</h3>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-3 font-serif">Software Artifacts</h3>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-800 md:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-3 font-serif">Feature Flags</h3>
        ...
        <section id="team-structure">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="rounded-2xl p-8 border-t-8 shadow-sm bg-white dark:bg-gray-900 border-[#A8672E] flex flex-col h-full">
              <h3 className="text-2xl font-black mb-6 text-[#A8672E] font-serif">Quant Researcher</h3>
            ...
            <div className="rounded-2xl p-8 border-t-8 shadow-sm bg-white dark:bg-gray-900 border-[#1D8A70] flex flex-col h-full">
              <h3 className="text-2xl font-black mb-6 text-[#1D8A70] font-serif">Quant Developer</h3>
              <div className="space-y-4 flex-grow text-sm">
            ...
            <div className="rounded-2xl p-8 border-t-8 shadow-sm bg-white dark:bg-gray-900 border-[#A8672E] flex flex-col h-full">
              <h3 className="text-2xl font-black mb-6 text-[#A8672E] font-serif">Quant Trader</h3>
              <div className="space-y-4 flex-grow text-sm">
        ...
        <section id="version-control">
          ...
          <div className="space-y-6 text-lg leading-relaxed">
            ...
            <h3 className="text-2xl font-bold mt-8 mb-4 text-slate-900 dark:text-slate-100 font-serif">Branching Strategies</h3>
        ...
        <section id="jupyter">
          ...
          <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800">
            <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-6 flex items-center gap-2 font-serif">
        ...
        <section id="cicd">
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4 text-slate-900 dark:text-slate-100 font-serif">Optimization Strategies</h3>
