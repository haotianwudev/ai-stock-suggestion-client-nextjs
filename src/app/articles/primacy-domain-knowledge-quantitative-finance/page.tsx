...
export default function PrimacyDomainKnowledgePage() {
  return (
    <ArticleFrame slug="primacy-domain-knowledge-quantitative-finance">
      <div className="pb-24">
        {/* Intro card */}
        <div className="bg-white/80 dark:bg-[#05070A]/80 backdrop-blur-sm p-6 md:p-8 rounded-3xl shadow-xl shadow-indigo-100/50 dark:shadow-indigo-900/20 text-left border border-slate-100 dark:border-slate-800 mb-12 mt-8 min-w-0 transition-colors">
          <p className="text-xl leading-relaxed text-slate-700 dark:text-slate-300 mb-8 font-serif">
            ...
            <strong className="text-indigo-600 dark:text-indigo-400 font-semibold">the belief that data speaks for itself.</strong>
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="py-16">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-serif text-slate-900 dark:text-white tracking-tight">1. The Dichotomy of Algorithmic Engineering and Quantitative Research</h2>
            </div>
              ...
              <table className="min-w-full text-left bg-white dark:bg-[#05070A]">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50 text-sm md:text-base">
                  <tr className="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
                    ...
                    <td className="py-4 px-6 text-slate-800 dark:text-slate-200 bg-slate-50/50 dark:bg-slate-900/20">Alpha generation, statistical arbitrage, portfolio optimization, and predictive modeling.</td>
                  </tr>
                  <tr className="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
                    ...
                    <td className="py-4 px-6 text-slate-800 dark:text-slate-200 bg-slate-50/50 dark:bg-slate-900/20">Financial mathematics, stochastic calculus, econometrics, deep learning, domain expertise (Python, R).</td>
                  </tr>
                  <tr className="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
                    ...
                    <td className="py-4 px-6 text-slate-800 dark:text-slate-200 bg-slate-50/50 dark:bg-slate-900/20">Focuses on understanding macroeconomic drivers, pricing inefficiencies, and asset correlations across time horizons.</td>
                  </tr>
                  <tr className="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
                    ...
                    <td className="py-4 px-6 text-slate-800 dark:text-slate-200 bg-slate-50/50 dark:bg-slate-900/20">Deployed for signal discovery, regime detection, asset pricing theory, and cross-sectional momentum modeling.</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="space-y-4 min-w-0">
              <div className="flex items-start gap-4 p-6 bg-rose-50 dark:bg-rose-950/20 rounded-2xl border border-rose-200 dark:border-rose-900/30 min-w-0">
                <AlertTriangle className="text-rose-600 dark:text-rose-400 mt-0.5 shrink-0 w-5 h-5" />
          ...
          <section className="py-16 border-t border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-serif text-slate-900 dark:text-white tracking-tight">2. Market Microstructure: Feature Extraction Through Expert Intuition</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-10 min-w-0">
              {[
                ...
                <div key={i} className="bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/30 rounded-2xl p-6 min-w-0 shadow-sm transition-transform hover:-translate-y-1">
          ...
          <section className="py-16 border-t border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-serif text-slate-900 dark:text-white tracking-tight">3. Alternative Data &amp; MDH</h2>
            </div>
          ...
          <section className="py-16 border-t border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-serif text-slate-900 dark:text-white tracking-tight">4. Advanced Risk Management &amp; Circuit Breakers</h2>
            </div>
            ...
            <div className="space-y-6 mb-12 min-w-0">
              <div className="bg-white dark:bg-[#05070A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-start gap-4">
                <div className="w-8 h-8 rounded-full bg-rose-100 dark:bg-rose-900/40 text-rose-600 dark:text-rose-400 flex items-center justify-center font-bold shrink-0 mt-0.5">1</div>
                <div className="min-w-0">
              ...
              <div className="bg-white dark:bg-[#05070A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-start gap-4">
                <div className="w-8 h-8 rounded-full bg-rose-100 dark:bg-rose-900/40 text-rose-600 dark:text-rose-400 flex items-center justify-center font-bold shrink-0 mt-0.5">2</div>
                <div className="min-w-0">
              ...
              <div className="bg-white dark:bg-[#05070A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-start gap-4">
                <div className="w-8 h-8 rounded-full bg-rose-100 dark:bg-rose-900/40 text-rose-600 dark:text-rose-400 flex items-center justify-center font-bold shrink-0 mt-0.5">3</div>
                <div className="min-w-0">
          ...
          <section className="py-16 border-t border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-serif text-slate-900 dark:text-white tracking-tight">5. Vertical Domain Models vs. Artificial General Intelligence</h2>
            </div>
          ...
          <section className="py-16 border-t border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-serif text-slate-900 dark:text-white tracking-tight">6. Post-Training Alignment</h2>
            </div>
              ...
              {[
                ...
                <div key={i} className="bg-white dark:bg-[#05070A] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm min-w-0 transition-all hover:shadow-md">
                  <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-3 mb-3 text-lg font-serif">
                    <ArrowRight size={20} className="text-indigo-500 shrink-0" />
                    {item.title}
                  </h4>
            ...
            <div className="bg-indigo-50 dark:bg-indigo-950/20 p-8 rounded-3xl border border-indigo-100 dark:border-indigo-900/30 min-w-0 shadow-sm">
              <ul className="space-y-4 text-sm text-slate-700 dark:text-slate-300">
                ...
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-4 h-4 mt-0.5 text-indigo-500 shrink-0" />
                  <div className="leading-relaxed"><strong className="text-slate-900 dark:text-white font-semibold">The FinDPO Success:</strong> The strictly aligned FinDPO strategy maintained a market-beating <strong className="text-indigo-700 dark:text-indigo-400 font-bold">67% annual return</strong> with a robust <strong className="text-indigo-700 dark:text-indigo-400 font-bold">Sharpe ratio of 2.0</strong>.</div>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-4 h-4 mt-0.5 text-indigo-500 shrink-0" />
          ...
          <section className="py-16 border-t border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-serif text-slate-900 dark:text-white tracking-tight">7. The Convergence of Expertise and Engineering</h2>
            </div>
