...
import { BookOpen, ShieldCheck, AlertTriangle, Users, Scale, Library } from 'lucide-react';
...
export default function AllWeatherStrategyArticle() {
  return (
    <ArticleFrame
      ...
      additionalDisclaimer="Historical performance figures and backtests presented here are for educational purposes and do not guarantee future results."
    >
      <style jsx>{`
        :global(.aw-table) {
          width: 100%;
        ...
        :global(.aw-table tbody tr:nth-child(even)) {
      ...
      <article className="max-w-4xl mx-auto px-4 text-gray-800 prose prose-slate max-w-none prose-p:leading-relaxed prose-p:text-gray-700 prose-headings:text-slate-900 prose-h2:font-semibold prose-h3:font-semibold prose-h2:mt-12 prose-h2:border-b prose-h2:pb-2 prose-ul:marker:text-blue-500 prose-ol:marker:text-gray-500">
        ...
        <section id="executive-summary" className="mb-12">
          ...
          <ul className="list-disc list-outside pl-6 space-y-2 text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <li><strong>The &ldquo;Four Seasons&rdquo; Framework:</strong> A simplified yet powerful model positing that asset prices are driven by shifts in economic growth and inflation relative to market expectations.<sup>[5, 6]</sup></li>
          ...
          <ul className="list-disc list-outside pl-6 space-y-2 text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <li><strong>The Philosophy:</strong> The underlying <em>principles</em>&mdash;risk parity, true diversification, and preparing for the unknown&mdash;are more relevant and crucial than ever.</li>
          </ul>

          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            The strategy &ldquo;works&rdquo; today not as a rigid, inviolable formula, but as a superior intellectual framework for thinking about and managing risk. For the retail investor, it offers timeless lessons on diversification, volatility management, and the behavioral discipline required for long-term success.
          </p>
        </section>
        ...
        <section id="section-1" className="mb-12">
          ...
          <ul className="list-disc list-outside pl-6 space-y-2 text-lg text-gray-700 leading-relaxed mb-4">
            <li><strong>Core Premise:</strong> Major market movements do not arise from what is expected; they are the result of surprises&mdash;events and economic shifts not already priced in.<sup>[3, 12]</sup></li>
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            This creates a 2x2 matrix of four potential economic environments, or &ldquo;seasons,&rdquo; that a portfolio must be prepared to endure <sup>[2, 5]</sup>:
          </p>
          ...
          <ul className="list-disc list-outside pl-6 space-y-2 text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <li><strong>Gold (7.5%):</strong> A dual-role hedge against high <strong>inflation</strong> and as a &ldquo;safe haven&rdquo; asset during extreme uncertainty or currency debasement.<sup>[6, 7]</sup></li>
          </ul>
          ...
          <ul className="list-disc list-outside pl-6 space-y-2 text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <li><strong>Encourages Compounding:</strong> The &ldquo;sleep well at night&rdquo; quality is the mechanism that encourages investors to remain invested, allowing the power of compounding to work uninterrupted.<sup>[1, 2]</sup></li>
          </ul>
            ...
            <table className="aw-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>The real return of cash and nominal bonds is eroded. &ldquo;Real assets&rdquo; that are priced in nominal terms or are contractually linked to inflation tend to outperform.</td>
                </tr>
                <tr>
        ...
        <section id="section-3" className="mb-12">
          ...
          <ul className="list-disc list-outside pl-6 space-y-2 text-lg text-gray-700 leading-relaxed mb-4">
            <li><strong>Mathematical Advantage:</strong> A 50% loss requires a 100% gain to break even. A 15% loss requires only an 18% gain. By avoiding deep losses (&ldquo;volatility drag&rdquo;), the portfolio compounds capital more efficiently from a higher base.</li>
        ...
        <section id="section-4" className="mb-12">
          ...
          <ul className="list-disc list-outside pl-6 space-y-2 text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <li><strong>The &ldquo;Hurricane&rdquo; Scenario:</strong> The 2022 event combined the worst aspects of multiple seasons at once: a &ldquo;rising inflation&rdquo; environment (bad for bonds) and a &ldquo;falling growth&rdquo; environment (bad for stocks) at the exact same time, exposing a limitation in the simplified four-season model.</li>
          </ul>
          ...
          <ul className="list-disc list-outside pl-6 space-y-2 text-lg text-gray-700 leading-relaxed mb-4">
            <li><strong>The Formula:</strong> The rigid, retail-focused allocation &ldquo;works&rdquo; less effectively in the current macroeconomic regime. It faces significant headwinds and is vulnerable to further inflationary shocks.<sup>[24]</sup></li>
            <li><strong>The Philosophy:</strong> The core <em>principles</em>&mdash;the humility of not predicting, the imperative of diversifying across economic drivers, and the discipline of balancing risk&mdash;are more vital and relevant today than ever before. The failure of the 60/40 in 2022 proves this.</li>
          </ul>

          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            <strong>The Verdict:</strong> The All Weather strategy &ldquo;works&rdquo; today not as a dogmatic recipe, but as a superior intellectual framework for constructing a resilient, long-term portfolio.
          </p>
        </section>
        ...
        <section id="section-5" className="mb-12">
          ...
          <ul className="list-disc list-outside pl-6 space-y-2 text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <li><strong>Lesson 2: Risk Management is Paramount.</strong> Shift your focus from chasing returns to managing risk. Understand that equities typically dominate the risk of most &ldquo;balanced&rdquo; portfolios and avoid taking unintended, concentrated bets.<sup>[4, 7]</sup></li>
