  ...
  return (
    <ArticleFrame slug="calendar-spread-architecture-time-decay-options-trading">
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-start p-4 bg-white rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <div>
                  <h3 className="font-bold text-slate-800">Short Leg (Near-Term)</h3>
              ...
              <div className="flex items-start p-4 bg-white rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <div>
                  <h3 className="font-bold text-slate-800">Long Leg (Far-Term)</h3>
                  <p className="text-slate-600 text-sm mt-1">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100 relative overflow-hidden">
            <h3 className="text-lg font-semibold mb-6 text-center text-slate-700">Time Decay Acceleration (Theta)</h3>
            <div className="h-64 relative flex items-end justify-between px-4">
              {/* Axes */}
              <div className="absolute left-0 bottom-0 w-full h-0.5 bg-slate-200"></div>
              <div className="absolute left-0 bottom-0 w-0.5 h-full bg-slate-200"></div>
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white/90 backdrop-blur px-3 py-1 rounded-full shadow-sm border border-emerald-100 text-emerald-700 text-sm font-bold">
                Net Profit Zone
              </div>
            </div>
          </div>
      ...
      <section className="bg-slate-100 py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900">The "Profit Tent" Profile</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-200 h-80 relative flex items-center justify-center">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="bg-indigo-100 p-3 rounded-lg h-fit text-indigo-700">
                  <Anchor size={24}/>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-800">Peak Profit</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-800">Breakeven Width</h3>
                  <p className="text-slate-600 text-sm">
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="border border-slate-200 rounded-xl p-6 bg-white hover:border-indigo-400 transition-colors">
            <div className="text-center mb-4">
              <span className="bg-slate-100 text-slate-600 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide">Neutral</span>
            </div>
            <h3 className="text-xl font-bold text-center text-slate-800 mb-2">The ATM Calendar</h3>
            <p className="text-sm text-slate-500 text-center mb-4">Strike = Current Stock Price</p>
          ...
          <div className="border border-slate-200 rounded-xl p-6 bg-white hover:border-indigo-400 transition-colors">
            <div className="text-center mb-4">
              <span className="bg-emerald-50 text-emerald-600 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide">Bullish</span>
            </div>
            <h3 className="text-xl font-bold text-center text-slate-800 mb-2">OTM Call Calendar</h3>
            <p className="text-sm text-slate-500 text-center mb-4">Strike &gt; Current Price (e.g., Delta 30)</p>
            <ul className="text-sm text-slate-600 space-y-2">
          ...
          <div className="border border-slate-200 rounded-xl p-6 bg-white hover:border-indigo-400 transition-colors">
            <div className="text-center mb-4">
              <span className="bg-rose-50 text-rose-600 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide">Bearish</span>
            </div>
            <h3 className="text-xl font-bold text-center text-slate-800 mb-2">OTM Put Calendar</h3>
            <p className="text-sm text-slate-500 text-center mb-4">Strike &lt; Current Price (e.g., Delta 30)</p>
            <ul className="text-sm text-slate-600 space-y-2">
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto border-t border-slate-200">
        <div className="flex items-center space-x-3 mb-10">
          ...
          <h2 className="text-3xl font-bold text-slate-900">Quantitative Reality</h2>
        </div>
        
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
          <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-200">
            <div className="p-10 bg-rose-50/50">
              <h3 className="text-xl font-bold text-rose-700 mb-2">Unfiltered Strategy</h3>
              <p className="text-slate-600 mb-6 text-sm">Mechanical trading without regime filters.</p>
              <div className="flex items-baseline space-x-2">
                <span className="text-4xl font-black text-rose-600">-0.09%</span>
                <span className="text-slate-500 font-medium">Annual Return</span>
              </div>
            ...
            <div className="p-10 bg-emerald-50/50">
              <h3 className="text-xl font-bold text-emerald-700 mb-2">Contango Filtered</h3>
              <p className="text-slate-600 mb-6 text-sm">Trading only when Back Month IV &gt; Front Month IV.</p>
              <div className="flex items-baseline space-x-2">
                <span className="text-4xl font-black text-emerald-600">+0.58%</span>
                <span className="text-slate-500 font-medium">Annual Return</span>
              </div>
              <p className="mt-4 text-slate-700 text-sm">
          ...
          <div className="bg-slate-50 p-6 border-t border-slate-200 text-center text-slate-500 text-sm">
      ...
      {/* Execution Rules */}
      <section className="bg-indigo-900 text-indigo-50 py-20 overflow-hidden relative">
        {/* Background Elements */}
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-slate-900 mb-8">When It Goes Wrong: Adjustments</h2>
        
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              <TrendingUp className="text-rose-500" />
              <h3 className="font-bold text-lg text-slate-800">Scenario: Stock Rallies Hard</h3>
            </div>
            ...
            <div className="space-y-3">
              <div className="text-sm bg-slate-50 p-3 rounded">
                <span className="font-bold text-indigo-700 block mb-1">Move 1: Do Nothing (Wait)</span>
                If there is still time, wait for a pullback. Calendars are forgiving.
              </div>
              <div className="text-sm bg-slate-50 p-3 rounded">
                <span className="font-bold text-indigo-700 block mb-1">Move 2: Roll Up</span>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-lg text-slate-800">Scenario: IV Crush</h3>
            </div>
            <p className="text-sm text-slate-600 mb-4">
            ...
            <div className="space-y-3">
              <div className="text-sm bg-slate-50 p-3 rounded">
                <span className="font-bold text-indigo-700 block mb-1">The Reality</span>
                It is very hard to adjust a pure Vega loss. This is why we avoid earnings events.
              </div>
              <div className="text-sm bg-slate-50 p-3 rounded">
                <span className="font-bold text-indigo-700 block mb-1">Mitigation</span>
      ...
      {/* Risks & Pitfalls */}
      <section className="py-20 px-6 max-w-5xl mx-auto border-t border-slate-200">
        <h2 className="text-3xl font-bold text-slate-900 mb-10">Critical Risks</h2>
      ...
      <section className="bg-slate-50 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-slate-900 mb-6 text-center">Strategy Comparison</h2>
            ...
            <table className="w-full text-sm text-left text-slate-600 bg-white">
              <thead className="text-xs text-slate-700 uppercase bg-slate-100">
                <tr>
                  ...
                  <th className="px-6 py-3 text-indigo-700">Calendar Spread</th>
              ...
              <tbody>
                <tr className="border-b border-slate-100">
                  <td className="px-6 py-4 font-medium text-slate-900">Primary Driver</td>
                  <td className="px-6 py-4 font-bold text-emerald-600">Time (Theta)</td>
                  <td className="px-6 py-4">Direction (Delta)</td>
                  <td className="px-6 py-4">Neutrality</td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="px-6 py-4 font-medium text-slate-900">Vega Exposure</td>
                  <td className="px-6 py-4 text-indigo-600">Long Vega (Needs Vol Up)</td>
                  <td className="px-6 py-4 text-slate-400">Neutral/Low</td>
                  <td className="px-6 py-4 text-rose-600">Short Vega (Needs Vol Down)</td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="px-6 py-4 font-medium text-slate-900">Profit Zone</td>
                  <td className="px-6 py-4">Narrow "Tent"</td>
                  <td className="px-6 py-4">Directional</td>
                  <td className="px-6 py-4">Wide Plateau</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 font-medium text-slate-900">Best Market</td>
...
const GreekCard = ({ icon, title, value, desc, color }: { icon: React.ReactElement; title: string; value: string; desc: string; color: string }) => (
  <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-slate-600 transition-colors">
    <div className={`flex items-center justify-between mb-4`}>
      ...
      <span className={`text-sm font-bold px-2 py-1 rounded bg-slate-900/50 ${color}`}>
        {value}
      </span>
    </div>
...
const RiskCard = ({ title, desc, badge }: { title: string; desc: string; badge: string }) => (
  <div className="p-6 bg-white rounded-xl border-l-4 border-rose-500 shadow-sm hover:shadow-md transition-shadow">
