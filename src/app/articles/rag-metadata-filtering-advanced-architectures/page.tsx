...
import { ArrowLeft, BookOpen, Code, Database, Filter, GitBranch, Cpu, BarChart, FlaskConical, ShieldCheck, Scale, AlertTriangle, Zap } from 'lucide-react';
...
export default function RAGMetadataFilteringArchitectures() {
  ...
  const currentArticle = articles.find(article => article.slug === 'rag-metadata-filtering-advanced-architectures');
        ...
        <div className="bg-white dark:bg-gray-900 min-h-screen font-sans">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="absolute top-2 left-2">
              <span className="bg-gradient-to-r from-purple-600 to-purple-800 text-white px-3 py-1 rounded-full text-sm font-semibold shadow-lg">
                Deep Research
              </span>
            </div>
            ...
            <header className="text-center mb-20">
              ...
              <p className="text-xl text-gray-500 dark:text-gray-400">
               ...
               <button 
                  ...
                  className="mt-6 px-4 py-2 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200"
                >
            ...
            <Section icon={<BookOpen size={24} />} title="1. Introduction to RAG with Structured Data">
              <SubSection title="1.1. The Evolution from Naive RAG to Advanced Architectures">
                <p>Retrieval-Augmented Generation (RAG) is an AI framework that optimizes a Large Language Model's (LLM) output by dynamically referencing an external knowledge base. This grounds the LLM in verifiable data, mitigating issues like factual inaccuracies and "hallucinations".</p>
              ...
              <SubSection title="1.2. The Core Challenge: Fusing Semantic Search with Structured Filtering">
                <p>LLMs lack knowledge of an organization's private, proprietary, or real-time data. Vector search addresses this by finding semantically similar information. However, it struggles with queries that have logical constraints, like "Find technical specs for product 'Phoenix' from the 'Core Engineering' team in the last quarter."</p>
                <p>The central architectural challenge is to fuse the conceptual understanding of semantic search with the logical precision of structured metadata filtering. The system must answer not only "what" the user is asking but also respect the "who," "when," "where," and "which" constraints.</p>
              </SubSection>
            ...
            <Section icon={<Filter size={24} />} title="3. The Core Retrieval Architecture: Vector Databases and Metadata">
              ...
              <SubSection title="3.2. Storing and Indexing Metadata Payloads">
               ...
               <SubSection title="3.3. Advanced Indexing for Filtering">
                  <p>To perform filtered searches efficiently, advanced vector databases create secondary indexes on the metadata payloads themselves (e.g., Qdrant's "payload index"). This allows the database to quickly identify matching vectors without scanning every payload, dramatically reducing latency and enabling intelligent query planning.</p>
              </SubSection>
              <SubSection title="3.4. Architectural Choices: Built-in vs. Bring-Your-Own (BYO)">
                  <p>Developers face a choice between using a simple, built-in vector store provided by a framework, or a more powerful, standalone "Bring-Your-Own" (BYO) vector database like Pinecone, Weaviate, or Qdrant. While built-in options are easier to manage, BYO databases offer far more advanced and expressive filtering capabilities, which are often necessary for enterprise-grade applications.</p>
              </SubSection>
            ...
            <Section icon={<Cpu size={24} />} title="5. Advanced Retrieval and Query Transformation">
              ...
              <SubSection title="5.3. Post-Retrieval Optimization">
                  <p>After retrieval, the context can be refined before sending it to the LLM to combat the "lost in the middle" problem:</p>
                  <ul>
            ...
            <Section icon={<BarChart size={24} />} title="8. Evaluation, Optimization, and Future Directions">
              ...
              <SubSection title="8.3. Prompt Engineering for Filtered Context">
                <p>The final prompt is crucial for guiding the LLM. Best practices include using clear delimiters, giving strict grounding instructions ("answer only from the context"), and including source metadata to enable citations.</p>
            ...
            {/* Call to Action */}
            <div className="bg-blue-50 dark:bg-blue-950/30 rounded-xl p-8 text-center mt-16">
