...
export default function CounterpartyCreditRiskArticle() {
  const currentArticle = articles.find(article => article.slug === 'infrastructure-counterparty-credit-risk-margin-wcl-excess-shortfall-release');
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-indigo-100 selection:text-indigo-900 text-slate-800">
        ...
        {/* Hero Section */}
        <header className="relative overflow-hidden bg-white border-b border-slate-200 pt-24 pb-32">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-50 via-white to-purple-50 opacity-70"></div>
          
          {/* Deep Research Badge */}
          <div className="absolute top-8 left-8 z-20">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-600/90 backdrop-blur-md border border-purple-400/30 shadow-xl font-bold text-sm text-white">
              Deep Research
            </span>
          </div>

          <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 text-indigo-700 font-semibold text-sm mb-8 tracking-wide">
              <TrendingUp size={16} /> Advanced Margin Architectures
            </div>
            <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight mb-8 leading-tight">
              The Infrastructure of <br className="hidden md:block"/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600">
                Counterparty Credit Risk
              </span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Reconciling risk metrics across Prime Brokerage and UHNW Wealth Management in modern quantitative finance.
            </p>
          </div>
        </header>
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 -mt-16 relative z-20 pb-32">
          {/* Intro Card */}
          ...
          {/* Systemic Imperative Section */}
          <section className="bg-white rounded-3xl p-8 md:p-12 border-l-8 border-indigo-600 shadow-lg shadow-indigo-100/50">
            <div className="flex items-center gap-4 mb-6">
              <Globe size={36} className="text-indigo-600" />
              <h2 className="text-3xl font-bold text-slate-800">The Systemic Imperative: Why It Matters</h2>
            </div>
            <div className="prose prose-lg max-w-none text-slate-600 leading-relaxed">
              <p>
                Accurately calculating these five metrics is an <strong>existential imperative for global financial stability</strong>. 
              </p>
              <ul className="space-y-4 mt-6">
                <li className="flex items-start gap-3">
                  <ChevronRight className="text-indigo-500 shrink-0 mt-1" />
                  <span><strong>Preventing Deleveraging Spirals:</strong> Miscalculating WCL can lead to margin shortfalls exceeding a client&apos;s equity. Forced liquidations into illiquid markets depress prices further, triggering cascading margin calls for others—a classic systemic deleveraging event.</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="text-indigo-500 shrink-0 mt-1" />
                  <span><strong>Balancing Efficiency vs. Catastrophe:</strong> Margins set too high choke market liquidity and economic growth. Margins set too low (over-relying on correlation offsets that break during a crisis) leave clearinghouses dangerously undercapitalized.</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="text-indigo-500 shrink-0 mt-1" />
                  <span><strong>Collateral Velocity:</strong> The rehypothecation of collateral backed by these margin calculations forms the backbone of the shadow banking system. If margins spike, collateral velocity slows, freezing wholesale repo markets and transmitting instability directly to the macroeconomy.</span>
                </li>
              </ul>
              <p className="mt-8 pt-6 border-t border-slate-100 text-lg font-medium text-slate-800">
                Ultimately, these metrics represent the quantitative bedrock of modern credit extension, transforming subjective market anxieties into precise, actionable mathematical thresholds.
              </p>
            </div>
          </section>
        </main>
