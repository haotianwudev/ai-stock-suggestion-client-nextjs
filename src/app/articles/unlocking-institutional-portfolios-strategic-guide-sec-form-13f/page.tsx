      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
        <div className="prose max-w-none">
          ...
          <p className="text-lg text-slate-700 leading-relaxed">
            This disclosure, known as <span className="text-indigo-600 font-semibold">Form 13F</span>, has become an indispensable tool for analysts, journalists, and individual investors seeking to understand the positioning of so-called <span className="text-indigo-600 font-semibold">&ldquo;smart money.&rdquo;</span>
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
        ...
        <div className="mb-6">
          ...
          <ol className="list-decimal list-inside space-y-3 text-slate-700">
            ...
            <li>Look for the <span className="font-semibold text-indigo-600">&ldquo;Information Table&rdquo;</span> link for detailed holdings</li>
          </ol>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
        ...
        <div className="mb-12 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl p-8 border-l-4 border-amber-500">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              <h4 className="font-semibold text-slate-800 mb-2">Core Principle:</h4>
              <p className="text-slate-700 mb-4">&ldquo;Heads I win, tails I don&apos;t lose much.&rdquo;</p>

              <h4 className="font-semibold text-slate-800 mb-2">Strategy:</h4>
              <p className="text-slate-700">Concentrated deep value; <span className="text-indigo-600 font-semibold">&ldquo;cloning&rdquo;</span> successful investors.</p>
            </div>
            <div>
              <h4 className="font-semibold text-slate-800 mb-2">Portfolio Style:</h4>
