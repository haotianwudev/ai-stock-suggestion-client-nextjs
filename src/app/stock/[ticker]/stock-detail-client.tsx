        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between">
          ...
          <div className="mt-2 md:mt-0 max-w-md">
            <div className="p-3 bg-muted/50 rounded-md text-sm text-muted-foreground">
              <p><strong>Disclaimer:</strong> This analysis is for educational purposes only, intended for common investors and people new to finance. Not financial advice. All suggestions are generated by AI models.</p>
            </div>
          </div>
        </div>
      </div>
