  ...
  function calculatePriceChange(prices: any[]): React.ReactNode {
    ...
    <div className="grid gap-4 md:gap-6">
      <div className="flex flex-col space-y-2">
        <div className="flex flex-col space-y-3 md:flex-row md:items-start md:justify-between md:space-y-0">
          <div className="min-w-0">
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight break-words">{stockData.company.name} ({stockData.company.ticker})</h1>
          ...
          <div className="w-full md:max-w-md flex-shrink-0">
            <div className="p-3 bg-muted/50 rounded-md text-xs md:text-sm text-muted-foreground">
      ...
      <div className="grid gap-4 md:gap-6 grid-cols-1 xl:grid-cols-7">
        <StockCompanyInfo company={stockData.company} prices={stockData.prices} financialMetrics={stockData.financialMetricsLatest} className="xl:col-span-2" />
      ...
      {loadingAgents && (
        <div className="flex justify-center items-center h-24 md:h-32">
          <p className="text-sm md:text-base">Loading AI agent analysis...</p>
        </div>
      )}
      ...
      <div className="grid gap-4 md:gap-6">
        <Card id="technical-analysis">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg md:text-xl">Technical Analysis</CardTitle>
      ...
      <div className="grid gap-4 md:gap-6">
        <Card id="sentiment-analysis">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg md:text-xl">Market Sentiment Analysis</CardTitle>
            <CardDescription className="text-sm">
      ...
      <div className="grid gap-4 md:gap-6" id="fundamental-analysis">
        <StockFundamentalsAnalysis fundamentals={fundamentals || mockFundamentals} />
      </div>

      <div className="grid gap-4 md:gap-6" id="valuation-analysis">
